...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "SharpSeekSpy_1":
			dialog.text = "Он известен и среди ловцов жемчуга, "+ GetSexPhrase("друг мой","девушка") +". Это настоящий бич для нас!\nТакое ощущение, что ему просто делать нечего, только за нашими тартанами гоняться! И узнаёт же как-то, подлец, кто где промысел ведёт.";
		...
		case "SharpSeekSpy_8over":
			dialog.text = "Странно. Вы приходите ко мне, заводите речи о Шарпе, а потом отказываетесь от работы. Всё это подозрительно\nБоюсь, я не могу дать вам уйти "+ GetSexPhrase("живым","живой") +" отсюда.";
			link.l1 = "Что?!..";
		...
		case "SharpSeekSpy_10":
			...
			link.l1 = "Я наш"+ GetSexPhrase("ёл","ла") +" человека из ваших, кто сливал Шарпу информацию о ваших тартанах. Это Эмилио Гарсиа.";
		...
		case "SharpSeekSpy_13":
			dialog.text = "Тогда извольте получить. Всё это отныне ваше.";
		...
		break;
		case "Kuali_Poiski_4":
			dialog.text = "Так баба их, наверняка ты видел"+GetSexPhrase("","а")+" её, раз был"+GetSexPhrase("","а")+" там. В перьях вся, в побрякушках. Жена всем молодым мужчинам, пока те не находят себе достойную ровесницу. Такие вот чудные традиции, ничего не поделать.";
			link.l1 = "Проститутка что-ли?";
			link.l1.go = "Kuali_Poiski_5";
		break;
		case "Kuali_Poiski_5":
			dialog.text = "Не, не. Жена, ни дать ни взять. К ней на хромой козе не подъедешь. Так вот мы и думали, Перес врал, что её того-этого, а после стал струпьями покрываться как чумной и гнить заживо. Мужья её порчу наслали, не иначе. Мы его и выгнали. Чёрт знает, вдруг зараза на всех перекинется, и к халупе его больше не подходили.";
