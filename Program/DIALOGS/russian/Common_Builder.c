void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Hi1":
			dialog.text = "Гутен так, "+GetSexPhrase("герр капитан","фройлен")+" " + sName + "! Вы не поверите, что со мной случилось!";
