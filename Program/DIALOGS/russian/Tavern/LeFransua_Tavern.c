    ...
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			if(CheckAttribute(pchar, "questTemp.Headhunter"))
			{
				...
				{
					link.l1 = "Добрый день, " + npchar.name + ". Я приш"+ GetSexPhrase("ёл","ла") +", как мы и договаривались. Раздобыли какую-нибудь полезную информацию?";
		...
		case "barmen_history_1":
			dialog.text = "Эх, судар"+ GetSexPhrase("ь","ыня") +", если бы всё было так просто. Моргану сейчас нет никакого дела, что творится в нашем Богом забытом поселении. Его внимание пытались привлечь и не раз, но результата – никакого\nПоэтому притесняемые негодяями достойные люди решили действовать самостоятельно. Они ищут человека, пирата, не имеющего известности в Береговом Братстве, и готовы ему достойно заплатить.";
		...
		case "barmen_history_5":
			dialog.text = "Великолепно! Я очень рад, что вы согласились. Кроме означенного вознаграждения за всю работу, мне положено выдавать вам некое вознаграждение за каждого отдельного члена банды, чтобы хотя бы частично компенсировать ваши накладные расходы\nНегодяи редко собираются вместе, да и напасть на них в таком случае было бы слишком рискованно. Потому вы будете выслеживать их по одному.";
		...
		case "barmen_history_7":
			...
			link.l1 = "Что же, пока мне всё ясно. Можете и дальше не называть имена ваших этих 'достойных людей', но мои будущие жертвы меня куда более интересуют.";
			link.l1.go = "Givetaskhunt_1";
		break;

		case "Givetaskhunt_1":
			SelectCarlosCity();
			dialog.text = "Ну, тогда приступим. Первый, кого вам необходимо выследить – Карлос Кассир, он наёмник, и, насколько мне известно, обретается сейчас в " + pchar.questTemp.Headhunter.Cityname + ". Готов поставить свою таверну против дырявой шляпы: вы легко сможете найти этого мерзавца или в таверне, или в борделе - сейчас он, должно быть, спускает награбленные денежки на пойло и девок. Он убил человека, отказавшегося ему платить, здесь в поселении, и это, к слову, стало последней каплей\nКогда встретитесь с ним - постарайтесь обставить всё так, чтобы это выглядело как дуэль - вы ведь не хотите проблем с властями, не так ли? Ради спасения своей шкуры Кассир пойдёт на что угодно – но сыграйте на его гордости, оскорбите и заставьте принять вызов, и не раскрывайте своих намерений – спугнёте раз, потом уже не сыщешь\nКлинком он владеет знатно, но помните – что бы вы ни предприняли, не ждите от него честной игры, это наёмник, а не дворянин.";
		...
		case "Endtaskhunt_4_4":
			dialog.text = "Я располагаю сведениями относительно некоего Мико Пистольеро – это мулат-индеец, правая рука Джа. Точной информации собрать не удалось, но последний раз его видели на западном берегу Мэйна. Предполагаю, что сейчас он находится в одном из поселений ловцов жемчуга\nЭто всё, что мне известно. Возможно, вам удастся узнать больше от самого Пистольеро, когда его отыщете. Джа Престон, как обычно, неуловим.";
