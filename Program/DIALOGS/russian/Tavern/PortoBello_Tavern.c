...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
            ...
            {
                link.l1 = "Тебе ни о чём не говорит имя Мария Карлэ?";
		...
		case "Mushket_stid":
			dialog.text = "Вот это да!.. Aх-ха-ха! Зачем это тебе понадобился мой лучший друг, знаменитый разбойник Альберто Зиверт?!";
		...
		case "Mushket_stid_nomoney":
			dialog.text = "Ну что ж - видно не судьба тебе достать 'Стрелу'. Подожду, пока моим бывшим приятелем заинтересуется кто-то посолиднее...";
			link.l1 = "Да перестань, я достану тебе деньги. До встречи!";
			link.l1.go = "exit";
		...
		case "Mushket_stid_paymoney":
			...
			dialog.text = "О-о, у меня появил"+ GetSexPhrase("ся щедрый приятель","ась щедрая приятельница") +"! Я даже стал подумывать - не продешевил ли я! Ну, да ладно - чего не сделаешь ради бескорыстной дружбы... Теперь слушай: он на днях отправился из Санты-Каталины в залив Москитос, это рядом с Порто Белло\nУ тебя есть шанс его перехватить, если будешь лететь быстрее ветра, хе-хе... Если нет, то придётся потом искать само"+ GetSexPhrase("му","й") +". Я и рад буду тебе помочь, в знак нашей дружбы, но он мне свои маршруты не докладывает.";
...
void SetMushketCapitainInWorld()
{
	...
	Log_TestInfo("Кэп с мушкетом вышел из: " + sld.cityShore + " и направился в: " + sld.quest.targetShore);
