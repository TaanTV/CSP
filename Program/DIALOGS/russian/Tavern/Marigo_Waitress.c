    ...
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			if(CheckAttribute(pchar, "Whisper.FindDesouzaHolWaitress"))
			{
				...
				link.l1 = "Твой начальник, "+GetCharacterFullName("Marigo_tavernkeeper")+", сказал мне, что к тебе подходили подозрительные типы с клеймом в форме распятия на руке. Я их ищу. Можешь подробней рассказать о чём они спрашивали?";
