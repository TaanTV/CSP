...
//*************************** ГПК, Мастер Ключей ***************************
		...
		break;
		case "TizerFind_3":
			dialog.text = "Не знаю, никому не сказал. Просто в один день я его у себя в таверне не увидел - и всё. Могу больше сказать - искали его коллеги, так сказать, бродяги, то есть. Не знаю, нашли или нет...";
		...
		case "EscapeSlaveVillemstad_T1":
			dialog.text = "Да уж, такого никогда не бывало... Больше тысячи рабов участвовали в бунте. Две плантации сожгли дотла, а хозяев убили почти всех поголовно. Комендант опасался, что они на город пойдут - ввёл военное положение. А всё началось с истории любви двух невольников - Таманго и Изауры...";
