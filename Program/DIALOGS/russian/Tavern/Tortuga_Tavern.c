...
//============================ Голл. линейка, квест №7. узнаем о ожидающем ГГ челе =======================
        ...
        break;
  	 	case "Step_H7_3":
			...
			link.l1 = "И ты вообще ничего не знаешь о нём?";
...
//============================ Голл. линейка, квест №8. узнаем о Лоране де Графе =======================
        ...
        break;
  	 	case "Step_H8_3":
			...
			link.l1 = "Он мне нужен срочно по очень важному делу. "+ GetSexPhrase("Искал","Искала") +" его в Шарп-Тауне, теперь ищу здесь. Я "+ GetSexPhrase("сам голландец","сама голландка") +", как и Лоран...";
