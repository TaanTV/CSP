...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		break;
		case "PL_Q7_5":
			dialog.text = "Я же говорю, что знаю, как узнать. Значит, слушай внимательно. Ричард - человек педантичный, он все записывает в свой судовой журнал. Тебе нужно получить его, вот и всё.";
