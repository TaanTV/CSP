...
//************************************* Диалоги по голл.линейке *******************************
		...
		case "EscapeSlave_Villemstad_P1":
				...
				link.l1 = "Я действую по указаниям Питера Стевезанта, генерал-губернатора. Есть основания полагать, что к исчезновению корабля причастны беглые рабы. Поэтому я прошу вас оказать мне всё возможное содействие в розысках.";
