	...
	switch(Dialog.CurrentNode)
	{
		...
		case "PoorHeadMan_4":
			dialog.text = "Была одна история в Виллемстаде, на Кюрасао, которая, по моему мнению, имеет некоторое сходство с тем, что произошло с тобой. В общем, у нас был один товарищ по несчастию, который решил обосноваться у голландцев, на Кюрасао. Звали его Тизер Дэн.\n"+
				"Так вот, прожил он там около месяца, а по прошествии этого времени попался на глаза генерал-губернатору Петеру Стэвезанту. С тех пор начались у Тизера проблемы то с солдатами в городе, то с комендантом... В итоге выгнали его из Виллемстада, и больше о нём ничего не известно.";
		...
		case "PoorHeadMan_6":
			...
			link.l1 = "Хм, звучит всё это несколько надуманно...";
			link.l1.go = "PoorHeadMan_7";
		break;
		case "PoorHeadMan_7":
			dialog.text = "Возможно, но это всё, что я знаю и могу предположить. Других ненавистников нищих, столь же богатых и влиятельных, я не знаю. Так что если ты хочешь что-то узнать об этом деле, то, мне кажется, искать нужно в резиденции Виллемстада.";
		...
		break;
		case "PoorHeadMan_9":
			dialog.text = "Ну, я сказал всё, что хотел. Спасибо за то, что "+ GetSexPhrase("выслушал","выслушала") +". Если найдёшь что-нибудь стоящее внимания - сразу обращайся ко мне, будем думать... И спасибо за то, что не "+ GetSexPhrase("причинил","причинила") +" нам вреда.";
		...
		case "FoundLetter_1":
			...
			link.l1 = "Там какой-то остров упоминается. И предметы роскоши. И всё это почему-то на бродягах зациклено. Расскажи-ка мне, приятель, в чём тут дело.";
		...
		case "FoundLetter_5":
			...
			link.l1 = "А с чего вообще слухи-то пошли? С чего всё началось?";
			link.l1.go = "FoundLetter_6";
		break;
		case "FoundLetter_6":
			dialog.text = "Так с Тизера Дэна и началось. Он немного не в себе был - пережил несколько кораблекрушений. Ему все наши говорили - не лезь в Кюрасао, а он всё одно решил там жить... В общем, он утверждал, что жил на этом Острове несколько месяцев, вот и наболтал сказок.";
		...
		case "GoLSC_2":
			...
			link.l1 = "Есть и очень плохая новость - Тизер Дэн мёртв.";
			link.l1.go = "GoLSC_3";
		break;
		case "GoLSC_3":
