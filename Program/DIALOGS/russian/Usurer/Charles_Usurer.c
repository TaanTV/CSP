...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
            ...
            {
                link.l5 = "Я приш"+ GetSexPhrase("ёл","ла") +" по поручению Аззи. У вас для меня должно быть кое-что приготовлено.";
		...
		break;
		case "Step_Az_3":
			dialog.text = ""+ GetSexPhrase("Сэр","Мисс") +", советую вам не проявлять излишнего любопытства. С Аззи это - опасно для жизни. Если у вас всё, то позвольте мне заняться своими делами...";
