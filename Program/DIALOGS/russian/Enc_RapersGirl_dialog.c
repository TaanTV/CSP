void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			Link.l1 = LinkRandPhrase("Что происходит?", "В чём дело?", "Что случилось?");
...
//			chrDisableReloadToLocation = true;
		...
		case "Node_240_1":
			...
			{
				link.l1 = "Слушай, я ничего там не наш"+ GetSexPhrase("ёл","ла") +". Ты уверена, что оставляла саквояж в комнате свиданий?";
				link.l1.go = "Node_242";
			}
		break;
