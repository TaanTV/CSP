...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Duelist_1_13":
			...
			link.l1 = "Всё ясно. Я вижу, что дуэль нельзя предотвратить. И поэтому предлагаю вам свои услуги фехтовальщика.";
		...
		case "Wife_2":
			...
			link.l1 = "Понимаю. Вы хотите, чтобы я помирил"+ GetSexPhrase("","а") +" вашего мужа с соседом?";
			link.l1.go = "Wife_3";
		break;
