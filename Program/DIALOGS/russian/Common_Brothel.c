...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			{
				dialog.text = "Ты взял"+ GetSexPhrase("","а") +" деньги, но пожертвования не сделал"+ GetSexPhrase("","а") +"! Мерзав"+ GetSexPhrase("ец","ка") +", одним словом. Я не буду тебя обслуживать в моём заведении. Пош"+ GetSexPhrase("ёл","ла") +" вон!";
			...
			link.l3.go = "ForCrew";
			link.l4 = "Тебя что-то беспокоит, "+npchar.name+"?";
			link.l4.go = "works";
			link.l5 = "У меня есть вопрос.";
			...
			{
				link.l6 = "Послушай, " + npchar.name + ", я ищу кольцо губернатора. Он тут кутил у тебя намедни, и потерял его.";
			...
			{
				link.l7 = "Что-то неважно я себя чувствую. Кажется, третья трубка была лишней.";
				link.l7.go = "tubeheal";
			}
		...
		break;
		case "toChurch_3":
			dialog.text = "Отлично! Заскочи потом ко мне, расскажешь, как всё прошло...";
			link.l1 = "Хорошо.";
			link.l1.go = "exit";
		...
		case "ResultChurch_1":
			...
			link.l1 = "Да не за что."+ GetSexPhrase(" Ради тебя, " + npchar.name + ", я готов на всё...","") +"";
			link.l1.go = "exit";
		...
		break;
        case "HorseQuest_1":
			dialog.text = "Недавно один мой клиент был очень пьян. Так вот, болтал он что-то про клад на побережье Мэйна, обещал озолотить...";
...
//********************************* Диалоги девки из борделя ФФ **********************************
		...
		case "works":
			...
			//<<-- квест пожертвования в церковь
			dialog.text = "У меня всё хорошо. Спасибо за заботу.";
			link.l9 = "Раз всё хорошо, то я пойду по своим делам.";
			link.l9.go = "exit";
