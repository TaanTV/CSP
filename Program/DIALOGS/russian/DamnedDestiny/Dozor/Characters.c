...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Grot_Agent_Killers_1":
			...
			dialog.text = "Гебельс: Да выкинь ты эту штуковину, Кригер, она и гроша ломаного не стоит.";
			link.l1 = "";
		...
		case "Spanch_Bob_3":
			dialog.text = "И правильно решил" + GetSexPhrase("","а") +"! Помнится, я тоже в эту игру играл, славные были деньки. Давненько это было. Да только всё время не везло нашей команде. То мачта сломается, то на мель сядем, то ещё какая-нибудь пакость приключится.";
		...
		case "Justin_Butt_5":
			dialog.text = "Да! По твоему лицу видать, что ты впервые слышишь об этом. Что же, раз уж ты победил" + GetSexPhrase("","а") +" меня в честном бою, расскажу тебе. Понимаешь, ты не " + GetSexPhrase("один","одна") +" в этой игре, помимо тебя и меня есть ещё три капитана, которые играют в Дозор.\nЭтот старик, организатор игры, предложил сыграть в эту игру всем капитанам, которые бросали якорь в Шарп-Тауне, пока он был там. И пять из них согласились.";
			link.l1 = "И в числе прочих согласившихся был ты?";
			link.l1.go = "Justin_Butt_6";
		break;

		case "Justin_Butt_6":
			dialog.text = "Верно. Только вот старик не стал говорить, что помимо меня будет играть кто-то ещё. Но я проследил за ним и выяснил это сам, после чего убил его и стал охотиться за остальными капитанами.";
			link.l1 = "И что с ними произошло?";
			link.l1.go = "Justin_Butt_7";
		break;

		case "Justin_Butt_7":
			dialog.text = "Я устранил всех конкурентов, кроме тебя. Один корабль я утопил, как только тот отчалил от Бермуд, второй нагнал у Пуэрто-Рико, третьего уничтожил близ Кюрасао. Вот только с тобой были проблемы.\nДо Мэйна я абсолютно точно знал, что ты впереди меня, но никак не мог выяснить сколько же времени я тебе проигрываю. На Мэйне же мне удалось выяснить, что уступаю тебе лишь пару дней. Я быстро разгадал загадку и на всех парусах помчался на Мартинику.";
		...
		case "Justin_Butt_9":
			...
			link.l1 = "А Мэйн? Откуда ты узнал, что я опережаю тебя на два дня?";
			link.l1.go = "Justin_Butt_10";
		break;

		case "Justin_Butt_10":
			dialog.text = "На Мэйне тоже был агент, только у него была другая миссия. По логике игры дозорные должны были найти Мекахром в сундуке, на разбитом корабле. Я тоже его там нашёл, но при этом знал, что, так как есть другие игроки, то Мекахромов должно быть несколько.\nЯ обыскал окрестности и нашёл агента. Он рассказал мне, что должен был следить за нами и подкладывать новый Мекахром, после того как очередной дозорный его заберёт";
		...
		case "Justin_Butt_12":
			dialog.text = "Да, а зачем было оставлять его в живых? Остались живы только агенты на Тортуге и Кюрасао. Их сложно было убрать незаметно. Рыбака с пляжа Фахардо я прикончил, пьяницу с мыса Недоступный тоже. Про агента из залива Гибели ты уже знаешь – его постигла та же участь. Агент с Ламантена оказался самым недоверчивым. Ума не приложу, как он меня раскусил, но за ним пришлось погоняться.";
