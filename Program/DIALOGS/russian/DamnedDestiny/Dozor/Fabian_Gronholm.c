...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "11":
			...
			link.l1.go = "12";
			link.l2 = "Впервые слышу. Можно поподробнее? Что это за игра такая?";
			link.l2.go = "13";
		break;
		...
		case "16":
			dialog.text = "Эхма, да чего там уметь-то? Наливай, да пей сам"+ GetSexPhrase("","а") +" уж чай разберёшься, коли загадки взял"+ GetSexPhrase("ся","ась") +" разгадывать.";
		...
		case "17":
			dialog.text = "Ну, если дойдёшь до конца игры, будут у тебя и деньги, и слава, и ценные вещи, будь уверен"+ GetSexPhrase("","а") +"! Ну что, соглас"+ GetSexPhrase("ен","на") +"?";
			link.l1 = "Пожалуй, соглас"+ GetSexPhrase("ен","на") +". Только вот ещё вопрос какой...";
			link.l1.go = "18";
		break;

		case "18":
			dialog.text = "Э, обожди, "+ GetSexPhrase("мил человек","добрая леди") +", обожди. Я над этой игрой два года трудился, и хочу достойной оплаты за свой труд...";
			link.l1 = "Оплаты?! И сколько же я долж"+ GetSexPhrase("ен","на") +" буду заплатить?";
			link.l1.go = "19";
		break;

		case "19":
			dialog.text = "Э, ты не кричи так, не кричи. Я же толкую тебе о чём? О том, что я два года готовил эту игру! Искал агентов по всему архипелагу, придумывал загадки, то да сё.";
