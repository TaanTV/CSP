    ...
    switch (Dialog.CurrentNode)
	{
        	...
        	switch (pchar.questTemp.State)   // что делаем в данный момент
            {
                ...
                case "":           // Квест №1, доставка главы янсенистов мистера Аарона.
                    dialog.text = "Ну что же, у меня есть для вас весьма важное для города задание. Полагаю, оно будет вам по зубам.\n"+
                                  ...
                                  "Это крупный негоциант, мой старый знакомый и большой друг. Направляйтесь в Мариго и привезите его ко мне, местная община янсенистов очень нуждается в нём.";
                    link.l1 = "Позвольте вас спросить, а кто такие янсенисты?";
                    link.l1.go = "Step_1_1";
                break;
                case "SeekChumakeiro_GoToVillemstad":
                    dialog.text = "Ну что же, Аарон уже мне всё рассказал. Хорошая работа, "+ GetSexPhrase("минхер","госпожа") +". Заходите ко мне через некоторое время, мне кажется, что я буду пользоваться вашими услугами и впредь.";
                    link.l1 = "Хорошо, минхер.";
                    link.l1.go = "exit";
        ...
        case "Step_5_8":
            ...
            else
            {
                ...
                link.l1 = "Нет, минхер, я честно пытал"+ GetSexPhrase("ся","ась") +" выполнить свои обязанности! Это всё, что я смог привезти...";
            }
            link.l1.go = "Step_5_6";
            for (i=1; i<=3; i++)
            {
        ...
        break;
        case "Step_7_2":
            dialog.text = "Великолепно! Я доволен, что всё так удачно разрешилось.";
        ...
        case "Step_9_5":
            ...
            link.l1 = "Хорошо, минхер, я сделаю всё, что нужно.";
            link.l1.go = "exit";
        break;
        case "Step_9_6":
        ...
        break;
        case "Step_11_4":
            dialog.text = " Да, похоже, что другого мне просто не остаётся.";
		...
		case "TizerFind_4":
			...
			link.l1 = "Абсолютно. Мне довелось узнать от жителей вашего города о тех байках, которые Тизер рассказывал прилюдно. Очень интересно, знаете ли... Я, конечно, понимаю, что всё это враки, но какие занимательные! Идеальный материал для книги.";
