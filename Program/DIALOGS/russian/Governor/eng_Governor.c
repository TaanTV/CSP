...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
		...
		case "work_1":  // работа на благо короны - линейка нации
			...
			switch (pchar.questTemp.State)   // что делаем в данный момент
            {
                case "empty":   // Нет взятых квестов
                    ...
                    else
                    {
						switch(pchar.questTemp.CurQuestNumber)   // Взятие квестов начиная со второго
                        {
                            ...
                            break;
                            case "10":
                                dialog.text = "Правительство Испании снарядило против ямайских корсаров эскадру из семи линейных кораблей под командованием адмиралов де Бустоса и дель Кампо-и-Эспиноса. Они уже подошли к Ямайке. Момент выбран как нельзя лучше, вы сами видели, что на рейде Порт Рояля, кроме вас, нет больше корсаров, все с Морганом в очередной охоте на испанцев. Вы должны отбить нападение. В ваше распоряжение переходят корабли охранения, это всё, чем я могу вам помочь. Вперёд, и да поможет нам Господь!";
                ...
                case "OccupyMein_GoOn":
                    dialog.text = "Вы ещё не захватили ни Куманы, ни Каракаса. Все побережье Мэйна до сих пор во власти испанцев...";
                    ...
                    {
                        dialog.text = "Кумана и Каракас захвачены! Теперь это побережье Мэйна принадлежит Англии!";
        ...
        case "Step_4_0":
            dialog.text = "Для того, чтобы облегчить выполнение поручения, я даю вам лицензию Голландской Вест-Индской компании сроком на 15 дней, которая позволит вам спокойно войти в город. Приступайте немедленно.";
            link.l1 = "Хорошо, сэр.";
            link.l1.go = "exit";
        ...
        case "Step_5_3":
            dialog.text = ""+ GetSexPhrase("Что ж, понимаю... По всему видать, где-то стонет девица в предвкушении вашего появления... Ха-ха","Что ж, понимаю") +".\n"+
                          ""+ GetSexPhrase("Друг мой, я искренне желаю вам провести время хорошо, с такой же полезной нагрузкой, так сказать... Талантливый человек талантлив во всём","" + pchar.name + ", я искренне желаю вам хорошо провести время") +".\n"+
        ...
        case "Step_6_3":
            dialog.text = "Что за манеры? В чём дело?";
        ...
        case "Step_7_1":
            ...
            link.l1.go = "Step_7_3";
            link.l2 = "Сэр, мне не очень понятна суть поручения. Клады корсаров - это их личное дело. Я здесь ни при чём...";
            link.l2.go = "Step_7_2";
        break;
        ...
        case "Step_7_3":
            dialog.text = "По моим оценкам золота во всех семи кладах 2100 слитков! Доставьте мне всё ЭТО...";
        ...
        case "Step_9_5":
			...
			ChangeCharacterNationReputation(pchar, sti(NPChar.nation), 1);
			//слухи
			AddSimpleRumour("Капитан, всё только о том и говорят, что вы привезли в Порт Рояль пленного испанского губернатора! Вы "+ GetSexPhrase("настоящий герой","настоящая героиня") +", капитан...", ENGLAND, 5, 1);
        break;
		...
		case "SF_HuberDialogueBeginning":
    			dialog.text = "Да, " + GetAddress_Form(pchar) + ", я ждал вас. У меня к вам дело.";
    			link.l1 = "Почему именно ко мне?";
    			link.l1.go = "SF_HuberDialogueExplanation";
		break;
		
		case "SF_HuberDialogueExplanation":
    			dialog.text = "Всё просто. Вы потопили десятки кораблей, при этом не висите на виселице, не прячетесь в пиратских норах, а вот так свободно причаливаете в главном порту Карибского моря. Лучше вас мне никого не найти.";
    			link.l1 = "Дело связано с рейдерством в море?";
    			link.l1.go = "SF_HuberDialogueBingo";
		break;
		
		case "SF_HuberDialogueBingo":
    			dialog.text = "Именно! И очень выгодным для вас.";
    			link.l1 = "Изложите суть дела.";
    			link.l1.go = "SF_HuberDialogueDealDitails";
		break;
		
		case "SF_HuberDialogueDealDitails":
    			dialog.text = "Да, у вас хватка настоящего морского волка. А суть дела очень простая. Наше королевское высочество сует свой нос куда не надо! Самые прибыльные направления они взяли под свой контроль, пристроив своих людей из Лондона. А этим, по праву, должен заниматься я!";
    			link.l1 = "Чем конкретно я могу вам помочь?";
    			link.l1.go = "SF_HuberDialogueBarbadosSilver";
		break;
		
		case "SF_HuberDialogueBarbadosSilver":
    			dialog.text = "На Барбадосе находятся гигантские залежи серебра и, разумеется, ведётся его добыча. Даже плантацию там держат только для того, чтобы сокрыть масштаб работ, ну и повышенную смерть рабов.";
    			link.l1 = "Очень интересно...";
    			link.l1.go = "SF_HuberDialogueSilverLogistic";
		break;
		
		case "SF_HuberDialogueSilverLogistic":
    			dialog.text = "Все грузы с английских колоний на Карибах поступают сначала в Порт-Рояль, а затем уходят в Европу. А на Барбадосе находится самый ценный актив Англии в Карибском море...";
    			link.l1 = "Начинаю понимать. Вы хотите, чтобы я перехватил" + GetSexPhrase("","а") +  " именно этот груз, с Барбадоса.";
    			link.l1.go = "SF_HuberDialogueSilverIsMine";
		break;
		
		case "SF_HuberDialogueSilverIsMine":
    			dialog.text = "Вы всё верно понимаете. Я не раз говорил, что не нуждаюсь в помощи метрополии, но не доверяют, видите ли.";
    			link.l1 = "И вам нужно сделать так, чтобы гости из-за океана доверие потеряли, а вы стали исключительной фигурой, способной правильно и безопасно организовать логистику.";
    			link.l1.go = "SF_HuberDialogueCloserToTheDeal";
		break;
		
		case "SF_HuberDialogueCloserToTheDeal":
    			dialog.text = "Короче. Между Барбадосом и Ямайкой курсирует 'Серебряный конвой'. Мне нужно, чтобы он пропал в пути, без остатка. Вся добыча вам. Кроме того, если дело выгорит, и все английские грузы буду курировать я, то на ваш депозит в банке Порт-Рояля будет ежемесячно падать миллион пиастров. По рукам?";
    			link.l1 = "По рукам. Когда конвой выходит из порта Бриджтауна?";
    			link.l1.go = "SF_HuberDialogueDealAgreed";
			link.l2 = "Нет. Большие эскадры не мой профиль.";
    			link.l2.go = "SF_HuberDialogueNoDeal";
		break;
		
		case "SF_HuberDialogueDealAgreed":
    			dialog.text = "А вот тут не всё так просто. Ни из какого порта конвой не выходит. По одному кораблю они собираются в открытом море в эскадру, а затем движутся на Ямайку. Иноземцы умеют конспирироваться. Кроме того, у них власть и ни у кого из подданных Англии, даже у моих приближённых, в этом деле, просить помощи мне не следует.";
    			link.l1 = "То есть наткнуться на него можно только случайно? Как же я смогу гарантировать результат?";
		...
		case "SF_HuberDialogueDealHelper":
    			dialog.text = "Не беспокойтесь. С результатом я вас не тороплю - конвой курсирует регулярно. В этом деле вам поможет мой старый приятель - глава пиратского поселения Ле Франсуа. У него есть глаза на всём пути следования конвоя.";
    			link.l1 = "Понял" + GetSexPhrase("","а") + ". Но у вас есть хоть какая-то информация о кораблях и размере эскадры.";
    			link.l1.go = "SF_HuberDialogueDealMoreDitals";
		break;
		
		case "SF_HuberDialogueDealMoreDitals":
    			dialog.text = "Очень мало. Поэтому я вас не ограничиваю в сроках. Специалисты из-за океана тщательно конспирируются. Могу сказать только, что супротив испанцам, английские эскадры обязательно содержат быстрые и манёвренные корабли.";
    			link.l1 = "Всё понятно. Ждите хороших новостей. До свидания.";
    			link.l1.go = "exit";	
		break;
		
		case "SF_HuberDialogueNoDeal":
    			dialog.text = "Вот как?.. Я в вас ошибался. Очень жаль. Этого разговора не было. До свидания.";
    			link.l1 = "Я понимаю. До свидания.";
    			link.l1.go = "exit";
			pchar.questTemp.silverfleet = "over";
		break;
		
		case "SF_HuberDialogueThinking":
    			dialog.text = "В самом деле? Я думал вы амбициознее... Может ещё подумаете?";
 			link.l2 = "Да, наверное, поспешил"  + GetSexPhrase("","а") + " с отказом. Извините за беспокойство.";
    			link.l2.go = "exit";
			link.l1 = "Я тоже так думал" + GetSexPhrase("","а") + ". Решение принято. До свидания, сэр.";
		...
		case "SF_HuberDialogueFail":
			dialog.text = "Спасибо за то, что пытались. Разумеется, никаких денег я вам не должен. До свидания, "  + pchar.name + ".";
    			link.l1 = "Я понимаю, сэр. До свидания.";
			link.l1.go = "SF_HuberDialogueQuestCancel";
		break;

		case "SF_HuberDialogueTheEnd":
			dialog.text = "Да, вы великолепны. Я бы и не обратился к вам если бы знал, какое сопротивление они окажут. Но вы оказались выше моих ожиданий, гораздо выше. И знаете что? Королевских прихвостней здесь уже нет. Я думаю, что в Лондоне их ждёт не просто разжалование...";
    			link.l1 = "Как насчёт награды?";
		...
		case "SF_HuberDialogueTheEndReward":
			dialog.text = "Я уже дал распоряжение в банк - можете забирать свои деньги. Будьте уверены, каждый месяц вам будет начисляться ровно миллион. До свидания, " + pchar.name + ".";
    			link.l1 = "Приятно было иметь с вами дело, сэр. До свидания.";
		...
		case "SF_HuberDialogueFirstSilverFleetDeath":
			dialog.text = "Не спешите, "  + GetAddress_Form(pchar) + " " + pchar.name + ". Мы договаривались о награде, в случае если дело выгорит, если иноземцы выплюнут кусок моего пирога и уедут восвояси. Я изложил свой план и он устроил вас.";
			link.l1 = "Не морочьте мне голову. Я разбил" + GetSexPhrase("","а") +  " конвой под чистую. Что не так?";
			link.l1.go = "SF_HuberDialogueFirstSilverFleetProblem";
		break;

		case "SF_HuberDialogueFirstSilverFleetProblem":
			dialog.text = "Всё так. Вы великолепно справились, но они оказались крепче, чем я предполагал. Решено было усилить конвой. Дело сдвинулось в сторону победы, нашей с вами победы. Но это не конец.";
			link.l1 = "Этот-то конвой был не лёгкой прогулкой... Ладно, не бросать же, раз уже ввязал" + GetSexPhrase("ся","ась") + ".";
			link.l1.go = "SF_HuberDialogueFirstSilverFleetContinue";
		break;

		case "SF_HuberDialogueFirstSilverFleetContinue":
			dialog.text = "Значит сотрудничаем дальше. Все вводные те же. Буду ждать новостей.";
			link.l1 = "Вы их получите.";
			link.l1.go = "exit";
		...
		case "SF_HuberDialogueSecondSilverFleetDeath":
			dialog.text = "Да, " + pchar.name + ", я слышал о ваших подвигах. И да, это опять не всё. Но совершенно точно третий удар должен стать последним.";
			link.l1 = "Почему вы так уверены?";
			link.l1.go = "SF_HuberDialogueSecondSilverFleetProblem";
		break;

		case "SF_HuberDialogueSecondSilverFleetProblem":
			dialog.text = "Ещё после первого нападения на конвой, Корона направила сюда экспериментальный корабль 'Серебряный сёрфер', построенный на Чатемской верфи. Что это за чудо – сам не знаю. Говорят, со стороны ничем не отличается от других кораблей своего класса, но это настоящий броневик! Его строили как раз для перевозки ценных грузов на Карибах, в одиночку! \nПо заверению создателей, он настолько крепок, что может держать удар от целой группы кораблей, прежде чем доберётся до безопасного порта, а огневая мощь достаточна, чтобы отбить желание врага приближаться на абордажное расстояние. \nТак вот если вы и с этими справитесь, то от прихвостней английской Короны здесь и следа не останется. Правда, конечно, в одиночку они его не пустят...";
			link.l1 = "Плевать. Главное, что на этом я покончу с этим делом.";
			link.l1.go = "SF_HuberDialogueSecondSilverFleetSmallDetail";
		break;

		case "SF_HuberDialogueSecondSilverFleetSmallDetail":
			dialog.text = "Маленькая деталь... Они как-то прознали, кто на них нападает и натравили охотников за головами. Будьте осторожны, не хотелось бы, чтобы они прознали и про мою голову в этом деле. В моих силах лишь предотвратить их нападки на вас в колониях Англии - там вы будете в безопасности.";
			if (CheckAttribute(PChar, "questTemp.silverfleet.lefransuamayorspeak"))
			{
				link.l1 = "Они в сговоре с пиратами - вот как они прознали! Даже ваш приятель в Ле Франсуа со скрипом делится информацией. Ладно, это всё лирика. Прорвёмся!";
				DeleteAttribute(PChar, "questTemp.silverfleet.lefransuamayorspeak");
			}
			else link.l1 = "Они в сговоре с пиратами - вот как они прознали! Ладно, это всё лирика. Прорвёмся!";
			link.l1.go = "SF_HuberDialogueSecondSilverFleetPartingWords";
		break;

		case "SF_HuberDialogueSecondSilverFleetPartingWords":
			dialog.text = "Семь футов под килем, " + pchar.name + "! Вас ждёт, возможно, самый сложный морской бой в жизни. Разозлили вы их не на шутку. Если дадите слабину, то уйти вам уже не дадут.";
			link.l1 = "Я не из тех, кто даёт слабину. И за вашу голову можете не переживать - я из тех, кто идёт на дно вместе со своим кораблём, а не в трюм вражеского корабля.";
			link.l1.go = "SF_HuberDialogueSecondSilverFleetLetsGo";
		break;

		case "SF_HuberDialogueSecondSilverFleetLetsGo":
			dialog.text = "За нашу с вами победу, " + pchar.name + ". До встречи!";
			link.l1 = "До встречи, сэр.";
			link.l1.go = "exit";
