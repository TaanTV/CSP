    ...
    switch (Dialog.CurrentNode)
	{
        ...
        case "Step_3_2":
            dialog.text = "Да, это так. Настоящая головная боль для нас.\n"+
                          "Так вот, я намерен избавиться от этой мигрени сам и избавить от неё наших колонистов. Я хочу, чтобы вы захватили этого пресловутого Рока Бразильца. И что очень важно - доставили его живым.";
        ...
        case "Step_3_9":
            dialog.text = "Конечно, не мораль же ему монсеньор де Соуза читал! Рок Бразилец получил ровно то, чего заслуживал.\n"+
                          "Он не раз пытал испанских граждан ради спрятанных ими денег, ну а теперь под пытками Святой Инквизиции Рок выдал местонахождение собственного клада. Он разделил и спрятал его в нескольких местах на Кубе, Эспаньоле и в окрестностях Белиза\n"+
        ...
        break;
        case "Step_3_15":
            dialog.text = "Бесспорно. Пятая часть найденных пиастров Бразильца - ваша. И не носите мне всё это в отдельности, приходите сразу, когда наберёте требуемую сумму - 500 тысяч.";
        ...
        case "Step_4_4":
            ...
            link.l1 = "Прошу прощения, дон Франсиско. Странно всё это... Вы знаете, это не мой профиль, я не сыщик. Пусть этим занимается комендатура.";
            link.l1.go = "Step_4_5";
        break;
        case "Step_4_5":
            ...
            link.l1 = "Хорошо, сеньор генерал-губернатор. Я сделаю всё, что смогу.";
            link.l1.go = "exit";
        ...
        case "Step_4_6":
            ...
            link.l1 = "Сложно предположить... Но вот что я наш"+ GetSexPhrase("ёл","ла") +" на месте преступления - недописанное письмо...";
            link.l1.go = "Step_4_7";
        break;
        case "Step_4_7":
        ...
        break;
        case "Step_4_8":
            dialog.text = "Вручаю вам лицензию Французской Вест-Индской компании, сроком действия на 20 дней. Данный документ позволит вам беспрепятственно передвигаться по Тортуге. И надеюсь, вы догадаетесь поднять французский флаг на судне...";
        ...
        case "Step_4_9":
            dialog.text = "Одни предположения... Хм, этого мало, чтобы сделать твёрдые выводы.\n"+
                          ...
                          "Впрочем, вы можете заходить ко мне на приём переодически, возможно, что-нибудь незначительное и подвернётся...";
            link.l1 = "Хорошо, сеньор генерал-губернатор...";
            link.l1.go = "exit";
            pchar.questTemp.State = "empty";
            SaveCurrentQuestDateParam("questTemp");
        ...
        case "Step_4_13":
			...
			ChangeCharacterReputation(pchar, 2);
			//слухи
			AddSimpleRumour("Вы знаете, наш генерал-губернатор поручил капитану " + GetMainCharacterNameDat() + " расследование убийства коменданта де Лейва. Капитан наш"+ GetSexPhrase("ёл","ла") +" убийцу, им оказался какой-то француз. Но отомстить не сумел"+ GetSexPhrase("","а") +".", SPAIN, 5, 1);
        break;
        case "Step_4_14":
        ...
        break;
        case "Step_6_2":
            dialog.text = "Ни в коей мере. Единственное, о чём я хочу вас попросить - не устраивайте открытую бойню на Тортуге, мне дороги храбрые и исполнительные офицеры.";
            link.l1 = "Дон Франсиско, я постараюсь выжить при любых обстоятельствах.";
            link.l1.go = "Step_6_3";
        break;
        case "Step_6_3":
            dialog.text = "И ещё один момент. Я вручаю вам лицензию Французской Вест-Индской компании сроком на 20 дней. Вы должны предъявить эту бумагу начальнику порта и вас никто ни в чём не заподозрит.\n"+
...
//********************** Квест №8, Отбить нападение на Куману. ************************
        case "Step_8_1":
            dialog.text = "К сожалению, только в общих чертах. Мне донесли, что в составе их эскадры есть даже линейный корабль первого класса, что совершенно нехарактерно для пиратов. Сомневаться не приходится, что данное нападение спонсируют власти Тортуги...";
...
//********************** Квест №10, Защита Маракайбо ************************
        ...
        break;
		case "Step_10_2":
            dialog.text = "Данная проблема явилась результатом несогласованных действий. Меры приняты, такого более не повторится.";
...
//********************** Квест №12, Захват Порт-о-Принса ************************
		...
		case "Step_12_6":
			...
			//слухи
			AddSimpleRumour("Капитан, говорят, что вы сумели захватить Порт-о-Принс! Неужели, теперь весь остров наш?! Великолепно!!", SPAIN, 5, 1);
		break;
