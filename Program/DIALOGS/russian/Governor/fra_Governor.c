...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	switch (Dialog.CurrentNode)
	{
		...
		case "work_1":  // работа на благо короны - линейка нации
        	...
        	switch (pchar.questTemp.State)   // что делаем в данный момент
            {
                ...
                case "Fr4SoleiRoyal_backTortuga":
                    dialog.text = "Судар"+ GetSexPhrase("ь","ыня") +", доложите о выполнении задания.";
                    link.l1 = "Всё в порядке, месье, хоть и не без проблем. Я отразил"+ GetSexPhrase("","а") +" нападение испанской эскадры под командованием того самого Хуана Галено, французской эскадры близ Доминики я не наш"+ GetSexPhrase("ёл","ла") +", поэтому пришлось доставить 'Солей Руаяль' в Бас-Тер.";
                ...
                case "Fr9GuardPP_DieHard":
                    dialog.text = "Судар"+ GetSexPhrase("ь","ыня") +", вы не сумели защитить Порт-о-Принс! В чём дело?!";
        ...
        case "Step_H7_5":
            ...
            link.l1 = "Месье, написанная вами депеша похищена. Меня ударили по голове, и я пролежал"+ GetSexPhrase("","а") +" без сознания всё это время!";
        ...
        break;
        case "Step_1_3":
            dialog.text = "Хм, всё это прекрасно, но вот незадача - сам Легран пропал. Он должен был перед отъездом из Форт де Франса отписать мне, но письма нет, да и сам он как в воду канул. Что вы думаете об этом?";
            link.l1 = "Я не в курсе, месье...";
            link.l1.go = "Step_1_4";
        break;
        case "Step_1_4":
            dialog.text = "Странно всё это... Вот что, судар"+ GetSexPhrase("ь","ыня") +", я не желаю больше иметь с вами дело. Более того, если я когда-нибудь узнаю, что это вы убили Леграна - мне сложно описать словами, что с вами будет.\n"+
				          "Я вас не задерживаю!";
        ...
        break;
        case "Step_2_5":
            dialog.text = "М-да, странно всё это... Ну да ладно. На данный момент у меня нет для вас работы, так что заглядывайте ко мне в резиденцию время от времени, возможно, что-нибудь подвернётся.";
			link.l1 = "Хорошо, месье генерал-губернатор.";
            link.l1.go = "exit";
        ...
        case "Step_2_7":
			...
			link.l1 = "Думали, что я лазутчи"+ GetSexPhrase("к","ца") +" бандитов, промышляющих грабежом голландских судов близ Кюрасао. В общем, в итоге я наш"+ GetSexPhrase("ёл","ла") +" эту банду и покончил"+ GetSexPhrase("","а") +" с ними. Это оказались испанские каперы, как вам это?!";
            link.l1.go = "Step_2_8";
        break;
        case "Step_2_8":
        ...
        case "Step_3_4":
            dialog.text = "Значит, вы берётесь за это дело? Отлично! Дама, о которой я говорю, - супруга дона Хосе Рамиреса де Лейва, коменданта Гаваны. Вам надлежит проникнуть в город и найти способ вывести её оттуда.\n"+
						  "Для того, чтобы вы могли сделать это успешно, я даю вам Испанскую торговую лицензию Эскориала сроком на 15 дней, с ней вам будет разрешено заходить в испанские порты и посещать испанские города. И позаботьтесь о том, чтобы на вашем корабле развевался дружественный Испании флаг.\n"+
		...
		case "Step_9_5":
			...
			link.l1 = "И это после всего, что я сделал"+ GetSexPhrase("","а") +" для Франции?! Прощайте, сударь, мне и само"+ GetSexPhrase("му","й") +" всё это уже изрядно надоело...";
            link.l1.go = "exit";
			pchar.questTemp.State = "QuestLineBreake";
			bWorldAlivePause   = false; // Конец линейки
			CloseQuestHeader("Fra_Line_9_GuardPortPax");
        ...
        break;
		case "Step_11_2":
            dialog.text = "Санта-Каталина, что на Мэйне. Этот город контролирует жемчужные промыслы на западном берегу Нового Света. Французское правительство полагает, что добыча жемчуга будет нам сейчас очень кстати...";
