...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "ClimeUsurer_1":
			...
			{
				link.l1 = "Как-то всё это неожиданно... Я же не знал"+ GetSexPhrase("","а") +", что так быстро надо будет рассчитаться.";
		...
		case "Samil_4":
			dialog.text = "Что-ж, не будем о грустном. Ты очень стойкий человек и заслуживаешь награды. Думаю, это оружие предыдущего визитёра тебе пригодится. А лично от меня, возьми эту накидку ягуара.";
			link.l1 = "Благодарю тебя, Юм Самиль.";
			link.l1.go = "Samil_5";
			RemoveCharacterEquip(npchar, BLADE_ITEM_TYPE);
			log_info("Вы получили дары от Юм Самиля");
