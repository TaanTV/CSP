...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		//------------------------ Мешитли ------------------------
		case "AztecFT":
			dialog.text = "О-о, белый человек снова к нам пришёл? "+ GetSexPhrase("","Да ещё и женщина? ") +"Я видел, как ты "+ GetSexPhrase("шёл","шла") +" по дамбе.";
		...
		break;
		case "AztecFT_5":
			dialog.text = "Как обычно - кровь пленённых тобой воинов. Приводи их сюда, а потом иди с ними в жертвенный храм. Ты долж"+ GetSexPhrase("ен","на") +" вырезать сердце воина, пока он ещё жив, и кровью окропить жертвенный камень Миктлантекутли.";
		...
		case "AztecFT2_4":
			...
			link.l1 = "И это всё, что ты можешь сказать?";
