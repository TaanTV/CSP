...
void ProcessDialogEvent()
{
	...
	{
		case "First time":
			dialog.text = "О-о-о, ещё один белый пожаловал. "+ GetSexPhrase("","Да ещё и женщина. ") +"С чем ты приш"+ GetSexPhrase("ёл","ла") +" к Теночтитлану?";
			link.l1 = "Посмотреть что к чему. "+ GetSexPhrase("Такой я человек","Такая уж я") +" - хочу все знать.";
			link.l1.go = "FT_1";
			if (pchar.questTemp.Teno == "takeFire")
			{
				dialog.text = "Здраствуй, "+ GetSexPhrase("белый человек","белая скво") +". Зачем ты приш"+ GetSexPhrase("ёл","ла") +" в Теночтитлан?";
		...
		break;
		case "Fire_3":
			dialog.text = "Да, воскрешённые Миктлантекутли ацтекские воины. Тебе придётся сражаться с ними. Внутрь храмов ты не сможешь взять помощников, так что всё придётся делать только тебе.";
		...
		break;
		case "Fire_6":
			dialog.text = "Это всё, что я могу. На всё, что я делаю, есть свои причины, поверь мне.";
		...
		break;
		case "Fire_7":
			dialog.text = "Я буду ждать, "+ GetSexPhrase("белый капитан","прекрасная скво") +". Это единственное, что мне остаётся...";
		...
		case "AfterGTemple":
			if (CheckCharacterItem(pchar, "SkullAztec")) //череп найден
			{
				...
				{
					link.l1 = "Не так быстро, приятель! Ты обещал мне какое-то мощное оружие. Я так ничего и не "+GetSexPhrase("нашёл","нашла")+".";
			...
			else
			{
				...
				link.l1 = "Не наш"+ GetSexPhrase("ёл","ла") +".";
				link.l1.go = "NotSkull";
			}
		break;
		//с собой нет черепа
		...
		case "Skull_6":
			...
			link.l1 = "У меня есть нефритовый череп, а он даёт власть над мёртвыми. Значит, и над тобой. Полагаю, что это всё меняет.";
			link.l1.go = "Skull_7";
		break;
		case "Skull_7":
