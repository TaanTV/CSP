...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "ATpr_F2":
			...
			link.l1 = "Капитан Гудли? Так я тебя и ищу. Меня послал Джекмен, так как тебе нужна какая-то помощь.";
			link.l1.go = "ATpr_F3";
		break;
		case "ATpr_F3":
		...
		case "FriendLinney_2":
			...
			link.l1 = "Понятно. Может, всё-таки продал? Хотя, странно всё это...";
