...
//>>>>>>>>>>>>========= Разброс диалогов по персонажам =====================
			...
			if (pchar.questTemp.State == "MorrisWillams_SeekHusband" && npchar.id == "Gillian Atterbury") // англ.линейка квест №6, разговор с Джиллиан Эттербери после дачи задания
            {
    			...
    			link.l1 = "Пока нет, но я этим занимаюсь. Я сделаю всё, чтобы отыскать его.";
    			link.l1.go = "exit";
            }
...
//*********************************** Диалоги Джиллиан Эттербери *************************************
		case "Step_E6_25":
			dialog.text = "В чём дело, "+ GetSexPhrase("сэр","мисс") +"?";
...
//************************************** Диалоги мужа Джиллиан ***********************************
		...
		break;
 		...
 		case "Step_E6_33":
			...
			link.l1 = "Всё это мне известно, рассказывай с того момента, как ты ушёл за город ночью. Что ты раскопал о ростовщике?";
...
//************************************** Диалоги спасшегося буканьера ***********************************
		...
		break;
   		...
   		case "Step_E8_4":
			dialog.text = "Все забрали испанцы. Мэнсфилд мёртв.";
