void ProcessDialogEvent()
{
	...
	break;
	case "PeaceDial_2":
		dialog.text = "Сейчас он находится в порту " + XI_ConvertString("Colony" + Pchar.Luke.City + "Gen") + ". Скорее всего он где-то прячется, ищи тщательнее, и будь осторож" + GetSexPhrase("ен","на") + ", он очень хитёр.";
		link.l1 = "";
