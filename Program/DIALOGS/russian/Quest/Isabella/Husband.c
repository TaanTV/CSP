...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "Step_1":
			dialog.text = "Всё это хорошо, но впредь изволь просить разрешения навестить её, как это делается в приличных домах.";
		...
		case "TalkInCave_4":
			...
			link.l1 = "Пожалуй, пропущу тебя вперёд... Да, и ещё - мне очень нравится твоя жена, Сальватор. Можно, после твоей смерти она не будет ходить в трауре? Мы торопимся обвенчаться...";
