...
void ProcessDialogEvent()
{
	...
	case "CitizenNotBlade":
		...
		case "SalvatorNews_2":
			dialog.text = "Понятно...";
			link.l1 = "Слушай, ты сам ничего о нём не слышал?";
		...
		break;
		case "SalvatorNews_5":
			dialog.text = "Потому, что Сальватор туда направился. Это последнее, что я о нём слышал буквально пару дней назад.";
