...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Rosita_4":
			...
			link.l1 = "Отнюдь, сеньора, мне всё это известно. Скажите, а Сальватор Олеварес не появлялся у вас?";
			link.l1.go = "Rosita_5";
		break;
		case "Rosita_5":
			dialog.text = "Нет, его здесь не было, он бесследно исчез. А почему вы спрашиваете о нём, капитан?";
			link.l1 = "Полагаю, лучше будет, если сама Изабелла всё вам расскажет. Я убедился, что ваш дом для Изабеллы безопасен и сейчас отправлю её к вам. Берегите её, сеньора, ей здорово досталось за последнее время...";
			link.l1.go = "Rosita_6";
		break;
		case "Rosita_6":
		...
		case "SavedIsabella_3":
			dialog.text = "Мерзавец! Нужно обо всём доложить губернатору, чтобы он немедленно арестовал Сальватора!";
		...
		case "AmbushInChurch_1":
			dialog.text = "К сожалению, веселье оплачено, кэп, и отменить всё может только заказчик...";
		...
		break;
		case "KnowPirates_1":
			dialog.text = "Хм, понятно... Значит вы, капитан, совершенно ни при чём?";
