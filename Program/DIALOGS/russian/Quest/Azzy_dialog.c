	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Step_4":
        	dialog.text = "Это почему ты так решил"+ GetSexPhrase("","а") +"? А-а-а, из-за того, что он дважды осуществил подмену тел?\n"+
                          ...
                          "А Лейф - мелкий мошенник, нахватался индейских оккультных ритуалов и сумел вызвать меня. И что самое печальное - ему удалось меня обмануть, хотя я сам во всём виноват...";
		...
		case "Step_9":
    		...
    		link.l1 = "О-о-о, так тебя зовут Аззи?! Очень приятно познакомиться.";
    		link.l1.go = "Step_10";
		break;
		...
		case "ToKillEnemy":
            ...
            link.l1 = HeroStringReactionRepeat("Не очень понял"+ GetSexPhrase("","а") +"... А при чём здесь понимание?", "Да, точно, с этим все. Давай обсудим остальное.", "Извини, не хотел"+ GetSexPhrase("","а") +" тебя выводить из себя. Давай продолжим.", "Как прощай?!", npchar, Dialog.CurrentNode);
		...
		case "Step_19":
        	dialog.text = "Почему же, смогу. Хоть весь ближайший город пущу под нож, стоит тебе только пожелать. Только одно условие - за эту услугу я возьму твою бессмертную душу.\n"+
						  ...
						  "Но раз уж ты так"+ GetSexPhrase("ой","ая") +" кровожадн"+ GetSexPhrase("ый","ая") +" могу тебе отдать эту проклятую саблю, она поможет тебе убивать твоих врагов.\n"+
                          "Соглас"+ GetSexPhrase("ен","на") +"?";
			log_info("Вы получили саблю Ирис");
			TakeNItems(pchar,"blade013",1);			  
    		link.l1 = "Ладно, давай сюда свою саблю. Душу я вообще продавать не собираюсь. Поговорим лучше о других желаниях.";
    		link.l1.go = "Wishes";
		break;
		...
		case "Step_26":
    		...
    		link.l1 = "То есть, окружающие не будут воспринимать меня как губернатора? А зачем мне тогда всё это?";
    		link.l1.go = "Step_27";
		break;
		...
		case "Step_28":
        	dialog.text = "Как альтернативу возьми этот браслет. Носи его на руке и все будут любить тебя, глядишь сам"+ GetSexPhrase("","а") +" в губернаторы пробьёшься, хе-хе.";
			log_info("Вы получили Клеврет");
			TakeNItems(pchar,"talisman17",1);
    		link.l1 = "Хоть что-то. Давай посмотрим, что ты ещё можешь мне предложить.";
    		link.l1.go = "Wishes";
		break;
		...
		case "Step_31":
        	dialog.text = "А чего ты хотел"+ GetSexPhrase("","а") +"? Мы все живём по законам мироздания, просто вы законов этих не знаете.\n"+
                          "В общем, так: хочешь неуязвимости - я скажу, что ты долж"+ GetSexPhrase("ен","на") +" сделать, чтобы всё это работало.";
		...
		case "Step_37":
        	dialog.text = "Ну вот и всё. Текст контракта занесён тебе в судовой журнал, ознакомься на досуге.\n"+
		...
		case "Step_43":
        	dialog.text = "И это правильно, так как небезопасно для тебя.\n"+
                          ...
                          "А вообще, советую тебе посетить верфь в Шарп-Тауне, заправляет там Мастер, он местные парусники доводит до ума.";
		...
		case "ClimeUsurer_4":
			...
			link.l1 = "Аззи, если бы я знал"+ GetSexPhrase("","а") +", то ни за какие коврижки на это не пош"+ GetSexPhrase("ёл","ла") +"! Клянусь тебе...";
