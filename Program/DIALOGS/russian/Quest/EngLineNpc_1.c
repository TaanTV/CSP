...
//>>>>>>>>>>>>========= Разброс диалогов по персонажам =====================
            ...
            if (pchar.questTemp.State == "MorrisWillams_GoToMorrisBegin" && npchar.id == "Morris_Willams")
            {
    			...
    			link.l1 = "Приш"+ GetSexPhrase("ёл","ла") +" посмотреть на удачливого капера. Говорят, ты взял три испанских галеона!";
            ...
            {
                dialog.text = "Ты захватил"+ GetSexPhrase("","а") +" мой индиго?";
                link.l1 = "У берегов Сан-Хуна я захватил"+ GetSexPhrase("","а") +" тот самый испанский пинас. Только в трюмах не оказалось ни индиго, ни серебра, ни красного дерева. Я обыскал"+ GetSexPhrase("","а") +" весь корабль, но ничего ценного не наш"+ GetSexPhrase("ёл","ла") +", извини.";
                link.l1.go = "Step_E6_11";
            }
...
//**************************************** Диалоги Морриса Уильямса **************************************
        ...
        case "Step_E6_10":
            ...
            link.l2 = "Полагаю, испанцы продали его по дороге. В каюте капитана я наш"+ GetSexPhrase("ёл","ла") +" сто сорок тысяч монет! Это твои деньги, теперь ты можешь рассчитаться с долгами.";
        ...
        case "Step_E6_14":
            dialog.text = "Вещица - это кираса, второй такой на Карибах, полагаю, нет. Об стальном слушай дальше... \n"+
                          "Два с половиной года назад мой фрегат бурей вынесло на рифы на севере Мэйна, в залив Гибели. Из этой переделки живыми вышла только половина моей команды. Остальные так и остались лежать на берегу.\n"+
        ...
        case "Step_E6_11":
            dialog.text = "Да пош"+ GetSexPhrase("ёл","ла") +" ты со своими извинениями. Мне грозит тюрьма, а ты извинения просишь...";
        ...
        case "Step_E6_22":
			dialog.text = "Репутация милосердного пирата может быстро сделать меня богатым. Это я уже понял, хотя о спартанцах ничего такого не знал.\n"+
                          "Ладно, говори, зачем приш"+ GetSexPhrase("ёл","ла") +"?";
...
//**************************************** Диалоги Томаса Линча **************************************
        ...
        case "Step_E12_3":
            dialog.text = "Он больше не является губернатором Ямайки. Вы должны знать, что терпение правительства лопнуло.\n"+
                          ...
                          "Вместо того, чтобы следовать полученным указаниям, Мэдифорд потворствовал пиратству, а последний его 'фокус' - захват и разграбление побережья Мэйна - вызвал беспрецедентный скандал в Европе! Королева Испании Анна Австрийская трое суток пребывала в форменной истерике.";
