void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			{
				dialog.text = "Приш"+ GetSexPhrase("ёл","ла") +" наконец. А я уж думал, испугаешься. За тобой никого нет? Дело-то серьезное.";
			...
			{
				dialog.text = "Приш"+ GetSexPhrase("ёл","ла") +" наконец. Только я твоего корабля не вижу, "+ GetSexPhrase("приятель","подруга") +". Куда ты собрал"+ GetSexPhrase("ся","ась") +" товар грузить?";
		...
		case "pirateStartQuest_Smuggler3_1":
			dialog.text = "Хех, хорошо сказано. Ну, а теперь выкладывай, сколько тебе заплатил " + pchar.questTemp.pirateStartQuest.Name + ", чтоб ты его рабов наш"+ GetSexPhrase("ёл","ла") +".";
		...
		case "pirateStartQuest_Smuggler3_6":
			dialog.text = "Вот и хорошо, что всё так вышло. Место здесь укромное, о лучшей могилке тебе и не мечталось, поди. А " + pchar.questTemp.pirateStartQuest.Name + " пусть подыскивает соглядатаев попроворнее.";
