...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		//На Антигуа, идём в таверну и начинаем донимать нпс паролем «Рыбалка удалась». Ответы в духе: «Пойди проспись!», «Закусывать надо!», «Что? О чём вы?».
		...
		case "BS_F3_7":	//Агент
			...
			link.l1 = "Организуйте мне встречу с вашим начальством. Срочно. Рыбка может совсем из рук выскользнуть, если вы понимаете, о чём я!";
			link.l1.go = "BS_F3_8";
		break;
		...
		case "BS_F3_21":	//Максин. Вариант с секасом.
			dialog.text = "Знаешь, мы через столько прошли уже вместе, а так и не познакомились поближе. Может, отложим на вечер все дела и проведём его за бутылкой хорошего вина?";
			link.l1 = "Заманчивое предложение! Только от вина меня воротит, если понимаешь о чём я. Как насчёт рома";
			link.l1.go = "BS_F3_22";
		break;
