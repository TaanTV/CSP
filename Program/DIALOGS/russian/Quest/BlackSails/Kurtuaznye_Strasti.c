...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "BS_KS_22_1":	//Максин
            ...
            link.l1 = "Нам всё известно о твоих злоключениях. Перейду к делу. Мне нужно то, что ты пыталась продать старпому Вейна. Скажи мне, где прячутся эти проклятые пираты и я выпущу им кишки, если это тебя утешит.";
			link.l1.go = "BS_KS_23";
		break;
