...
//>>>>>>>>>>>>========= Разброс диалогов по персонажам =====================
            ...
            if (pchar.questTemp.State == "SeekBible_SeekMoney")
            {
                ...
                {
                    link.l1 = "Да, наш"+ GetSexPhrase("ёл","ла") +". И готов"+ GetSexPhrase("","а") +" их выложить тебе...";
...
//********************************* Диалоги кэпа, который увёз де Барраса из Тортуги **********************************
		...
		break;
  		case "Step_H7_2":
			dialog.text = "Галеон 'Изабелла', ушёл курсом на Мэйн к Санта-Каталине. Антонио говорил мне, что ему обязательно и срочно нужно именно туда.";
