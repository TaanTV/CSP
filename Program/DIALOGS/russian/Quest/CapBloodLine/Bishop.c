	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
            ...
            if (npchar.id == "Pitt")
            {
     			if (bBettaTestMode)
                {
			        link.l0 = "Бета Тест - пропустить и начать игру.";
			        link.l0.go = "Finish";
                }
                ...
                if (Pchar.questTemp.CapBloodLine.stat == "Begining")
                {
                    ...
                    Pchar.questTemp.CapBloodLine.iTime = -1;
           			if (bBettaTestMode)
                    {
				        link.l3 = "Бета Тест - Ко второму квесту.";
    		...
    		if (npchar.id == "Quest_Smuggler")
    		{
                ...
                link.l1 = "Меня могут запороть до смерти и без этого... Хотя вы правы - мне пора." ;
                link.l1.go = "Exit";
    		}
		...
		case "CGStep_2":
        	dialog.text = "Ах, так я ещё должен заботиться о здоровье мятежников! Чёрт побери! Вы думаете, что мы будем его лечить? Вдоль всей дороги от Вестона до Бриджуотера расставлены виселицы, и он подойдёт для любой из них. Полковник Кирк научит этих дураков-протестантов кое-чему такому, о чём будут помнить их дети, внуки и правнуки!";
        ...
        case "WStep_11":
        	...
        	link.l1 = "Доброе, доктор Вакер. Что ж, я собрал людей и всё необходимое. Жду только обещанных денег.";
			npchar.LifeDay = 0;
            link.l1.go = "WStep_12";
        ...
        case "PStep_11":
        	...
        	link.l1 = "Успокойся, Питт, Хагторп всё мне рассказал. Ты, наверное, полагал, будто мы обойдёмся без штурмана, если дал этой  скотине Бишопу повод чуть не убить тебя?";
            link.l1.go = "PStep_12";
...
//            SetCharacterGoods(Pchar,GOOD_RUM,40);//600);
		...
		case "VLStep_0_3":
        	...
        	link.l1 = "Питт расскажет тебе все подробности. Надеюсь ты сейчас не отрубишься от опъянения и не пропустишь всё веселье.";
            link.l1.go = "exit";
            NextDiag.TempNode = "VLStep_1";
        ...
        case "HTStep_5":
            ...
            dialog.text = "Таверна, бордель... он где-то там, дьявол! Веселится и пьёт, играет в карты! На его руке МОЁ обручальное кольцо, дома его ждёт МОЯ жена! Принеси мне кольцо... вместе с пальцем.";
        ...
        case "HTStep_20":
            ...
            dialog.text = "А как же наш план побега? Нэттал сбежал, шлюп теперь не достать...";
        ...
        case "HTStep_24":
            ...
            dialog.text = "Ты был прав, Питер. Всё вышло, как ты и сказал, мы овладели этим прекрасным кораблём почти без потерь.";
        	link.l1 = "Да, Хагторп, но боюсь, всё только начинается. Мне кажется, ты отличный моряк. Пойдёшь ко мне офицером?";
        ...
        case "HTStep_25":
            ...
            dialog.text = "Питер, ты добрый и отзывчивый человек, слово 'честь' для тебя не пустой звук, ты прекрасный врач, талантливый капитан и отличный лидер. Если понадобится, я отдам за тебя жизнь.";
        ...
        case "DKStep_6":
            ...
            dialog.text = "Если честно, я даже не знаю что делать... Я хотел оставить море, осесть на суше, найти достойную жену и зажить спокойной жизнью. Теперь в Англию возврата нет, с Испанией и Голландией та же ситуация. Остаётся только Франция, но там нет ничего, что держало бы меня, никого, кто помог бы выжить в этом жестоком мире.\nНа плантациях же я успел подружиться с тобой, Питтом и другими невольниками. Я пойду к тебе на службу, но когда придёт время, и я всё же решусь поселиться на берегу, не держи меня.";
        ...
        case "OGLStep_0":
            ...
            dialog.text = "Ты о чём, дьявол тебя разбери?";
        ...
        case "OGLStep_1":
        	...
        	link.l1 = "Мне известно обо всём этом. Но мне также известно, что кое-кто очень хочет нам помочь. Так хочет, что даже предоставит средства на шлюп.";
        ...
        case "OGLStep_12":
            ...
            dialog.text = "В течение пятнадцати лет я был лучшим канониром на всём флоте его величества!";
