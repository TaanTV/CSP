...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
        		...
        		switch (rand(5))
					{
						...
						case 4: ///////////////////////////////////////////
							dialog.text = "Если тебе хочется поболтать, то найди себе кого-нибудь другого, а лучше возвращайся на плантации.";
							link.l1 = "Непременно.";
							link.l1.go = "exit";
						break;
		...
		case "STBStep_0":
        	dialog.text = "А ну, немедленно сдай всё оружие! Следует сообщить полковнику Бишопу, чтобы он всыпал тебе как следует...";
        ...
        case "SLQStep_1":
            ...
            dialog.text = "Доктор, в моём положении следовать вашему совету затруднительно. Денег у меня нет, но есть кое-что, что может сильно вам пригодиться. Так, что если вам всё-таки удастся раздобыть что-нибудь для меня, то я в долгу не останусь.";
    ...
    case "MSStep_2":
        ...
        dialog.text = "Все? О чём ты?! Пошёл прочь, треклятый авантюрист!";
    	link.l1 = "...";
        link.l1.go = "exit";
    ...
    case "MSStep_8":
    	...
    	link.l1 = "''Синко Льягас'' пришвартовался - они пришли на нём.";
        link.l1.go = "MSStep_9";
    ...
    case "MSStep_11":
        ...
        dialog.text = "Точно, я уверен, что видел их раньше. Ладно, ты хорошо поработал, парень. И всё же... кто они?";
    	link.l1 = "Испанцы.";
    ...
    case "FStep_3":
        ...
        dialog.snd = "Voice\HADI\HADI028";
        dialog.text = "А что тебе не нравится? Дьявол, да я лучший рыбак на всём архипелаге!";
    ...
    case "QSTStep_2":
        ...
        dialog.text = "О чём ты говоришь? Я не знаю никакого ростовщика!.. Я... проклятье!";
