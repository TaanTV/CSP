...
//<<<<<<<<<<<<======== Разброс диалогов по персонажам ======================
		...
		case "Step_6":
        	dialog.text = "Да, ушёл один. Дело в том, что Кайман - место сбора и других кораблей с испанских колоний в Южной Америке. Представляете, в глубине материка наши исследователи нашли заброшенный индейский храм. Сейчас там работает королевская археологическая экcпедиция. Как только они закончат работы, эскадра отправится в Старый Свет, в Испанию\n" + "Это всё, что я знаю.";
