...
// ============================================================================
	switch(Dialog.CurrentNode)
	{
		...
		case "I_know_you_good":
			...
			{
				link.l1 = "Генри, я приш"+ GetSexPhrase("ёл","ла") +", как мы и договаривались.";
				link.l1.go = "PL_Q8_1";
			}
		break;
		...
		//********************* Английская линейка *********************
 		...
 		case "hot_business":            // начало диалога по третьему квесту англ.линейки
			dialog.text = "Ага, наш"+ GetSexPhrase("ёл","ла") +"-таки время заглянуть?";
			link.l1 = "Добрый день, Генри. Я приш"+ GetSexPhrase("ёл","ла") +" узнать о 'горячем деле для настоящего корсара'. Время пришло?";
			link.l1.go = "Step_3_1";
  		break;
	 	...
	 	case "Step_3_1":
            ...
            {
    			dialog.text = "Время уже ушло. Ты что думал"+ GetSexPhrase("","а") +", я буду ждать тебя вечно? Хех... Я хотел предложить тебе поход на Куману, но ты мотал"+ GetSexPhrase("ся","ась") +" где-то всё это время. Мы справились без тебя.";
    			link.l1 = "Эх, как жаль...";
    			link.l1.go = "exit";
        ...
        break;
	 	...
	 	case "sale_gold_all":
			dialog.text = "Ты продаёшь мне всё? Великолепно! Выгодная сделка для нас обоих. Прощай.";
			link.l1 = "Бывай, Морган. Ещё увидимся.";
			link.l1.go = "out_fort";
        ...
        break;
 	 	case "Step_H3_5":
            ...
            if (CheckAttribute(pchar, "questTemp.Talks.Tavern")) sTemp = sTemp + " Пьер Пикардиец снял комнату в таверне Тортуги на год вперёд.";
		...
		case "PL_Q2_away_1":
			dialog.text = "А-а, " + GetFullName(PChar) + ", приветствую тебя. Ну, рассказывай, был"+ GetSexPhrase("","а") +" на Мартинике? Лоу наш"+ GetSexPhrase("ёл","ла") +"?";
		...
		case "PL_Q2_awaywait":
			...
			link.l1.go = "exit";
			link.l2 = "Знаешь, Морган, надоело мне всё это. Не наш"+ GetSexPhrase("ёл","ла") +" я Лоу, и искать уже нет никаких сил...";
		...
		case "PL_Q4_goodWork_4":
			dialog.text = "Не забывай заглядывать ко мне. Может ещё что-нибудь подвернётся.";
		...
		case "PL_Q5_begin":
			dialog.text = "Так, приш"+ GetSexPhrase("ёл","ла") +" наконец. У меня к тебе, " + PChar.Name + ", есть довольно неприятный разговор.";
		...
		case "PL_Q7_begin_4":
			...
			link.l1 = "Понял"+ GetSexPhrase("","а") +". Пош"+ GetSexPhrase("ёл","ла") +" собираться.";
			link.l1.go = "exit";
		...
		case "PL_Q7_LaVegaLate":
			...
			link.l1 = "Ты знаешь, я не наш"+ GetSexPhrase("ёл","ла") +" Стива Линнея в Ла Веге.";
		...
		break;
		case "PL_Q8_4":
			dialog.text = "Когда приходит 'пора' - это решать мне, а твоя задача - неукоснительно выполнять то, о чём я тебя прошу.";
		...
		case "PL_Q8_ready":
			...
			{
				dialog.text = "Ага, вот и ты приш"+ GetSexPhrase("ёл","ла") +"! Это хорошо, так как время пришло. Я так понимаю, что ты готов"+ GetSexPhrase("","а") +"?";
		...
		case "PL_Q8_ExTPanama_8_Soukins":
			dialog.text = "Это я понял! Итак, на этом и остановимся. Ты можешь возвращаться к своему кораблю, в Панаму тебе хода нет. За то, что ты подвёл"+ GetSexPhrase("","а") +" меня, исключаю тебя из Берегового Братства. Пош"+ GetSexPhrase("ёл","ла") +" вон!";
		...
		case "PL_Q8_Panama1":
			dialog.text = "Ты наш"+ GetSexPhrase("ёл","ла") +" губернатора?";
			link.l1 = "Да. Наш"+ GetSexPhrase("ёл","ла") +" и допросил"+ GetSexPhrase("","а") +".";
		...
		case "PL_Q8_Panama2_4":
			dialog.text = "Ты свою добычу уже сдал"+ GetSexPhrase("","а") +", так что я претензий к тебе не имею - можешь быть свобод"+ GetSexPhrase("ен","на") +" от планируемого мной мероприятия. Но для тебя на это время есть работа\n"+
				"Отправляйся опять в форт Панамы. Там за фортом, с внешней стороны стены есть сундук. В нём должно быть ещё золото Эскориала! Это рассказал покойный губернатор Панамы.";
		...
		case "PL_Q8_afterPanama":
			...
			link.l1 = "Я, собственной персоной. Вот, приш"+ GetSexPhrase("ёл","ла") +" взглянуть тебе в глаза.";
...
// ======================== блок нод angry ===============>>>>>>>>>>>>>>>
		case "AngryRepeat_1":
            dialog.text = RandPhraseSimple("Пош"+ GetSexPhrase("ёл","ла") +" вон отсюда!", "Вон из моего кабинета!");
			link.l1 = "Ай...";
