...
//			PChar.quest.PDM_CL_Antonio_Ubit.win_condition = "PDM_CL_Antonio_Ubit";
		...
		case "LambriniPGG_1_8":
			dialog.text = "Ты вела дела с преступником, а значит ты с ним заодно! Мы отведём вас в тюрьму под фортом Маракайбо, а затем вашу судьбу решит суд.";
			link.l1 = "";
		...
		case "LambriniPGG_2_4":
			...
			link.l1 = "Ну и на кой мне нужен запертый сундук?";
