...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Next_9":
			...
			link.l1 = "У меня есть идея, мистер. Если вы работали на верфи, то должны знать толк в корабельном деле. Я нанимаю вас в качестве плотника, и вы выберетесь с этого острова, который вам так не нравится.";
			link.l1.go = "Next_6";
            link.l2 = "Э, полегче, полегче. Не больно-то и хотелось с тобой разговаривать. Всего доброго.";
			link.l2.go = "exit";
			NextDiag.TempNode = "Next_9";
		break;
