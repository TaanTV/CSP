...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Finish_1":
			if (pchar.name == "Джессика")
			{
				dialog.text = "Мы сейчас в порту " + XI_ConvertString("Colony" + pchar.HeroParam.ToCityId) + ". Нужно как-то начинать новую жизнь без всех этих Масок и Белтропов, будь они неладны... То есть, пусть земля им будет пухом, я хотел сказать... А мы уж вас не подведём, капитан. Ваша команда останется с вами до конца.";
