...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "ansewer_1":
			dialog.text = "Это Город Потерянных Кораблей, "+ GetSexPhrase("приятель","" + pchar.name + "") +". Если попал"+ GetSexPhrase("","а") +" сюда, то забудь обо всём, чем жил"+ GetSexPhrase("","а") +" раньше. Отсюда не вырвешься, к сожалению...";
			link.l1 = "Дьявол!!";
