...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			{
				dialog.text = LinkRandPhrase("Где-то преступление?", "В чём дело, в Городе беспорядки?", "Что-то случилось?");
		...
		case "ansewer_2":
			dialog.text = LinkRandPhrase("А зачем? Нас и здесь неплохо кормят...",
				...
				"Ты знаешь, здесь есть всё, что я хотел получить от жизни. Зачем мне искать лучшей доли?");
			link.l1 = RandPhraseSimple("Понятно.", "Ясно...");
			link.l1.go = "exit";
		...
		case "SeekCrew_2":
			...
			link.l1 = "Да, это было бы неплохо. Знаешь, дружище, когда всё это закончиться, я хочу взять тебя офицером к себе на корабль. Ежемесячное жалование гарантирую.";
			link.l1.go = "SeekCrew_3";
		break;
		case "SeekCrew_3":
			dialog.text = "Интересное предложение. Пожалуй, соглашусь. Ну, а пока нужно постараться сделать так, чтобы 'всё это' закончилось благополучно для нас.";
