	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (npchar.quest.meeting == "0")
			{
				...
				{
					dialog.text = "А-а-а, вот и ты. Это хорошо, что ты сам"+ GetSexPhrase("","а") +" приш"+ GetSexPhrase("ёл","ла") +" ко мне. Не люблю, когда от меня бегают, да ещё в такой шторм...";
		...
		case "FT_1":
			...
			link.l1 = "Ха, а ведь слышал"+ GetSexPhrase("","а") +" о тебе! Ты тот самый пиратский капитан, что вышел за призом на 'Ужасе Мэйна' и пропал. Так вот куда ты задевался!";
			link.l1.go = "FT_1_1";
		break;
		case "FT_1_1":
		...
		break;
		case "FT_6":
			dialog.text = "Нет, этого не может быть. Путь отсюда заказан... Ну, продолжим. Итак, с правами всё, теперь о твоих обязанностях. Первое: ты не можешь покушаться на жизнь граждан Города. Если ты убьёшь кого-то, то тебя убью я. Это ясно?";
			link.l1 = "Хм, ясно...";
			link.l1.go = "FT_7";
		break;
		case "FT_7":
		...
		case "FT_10":
			...
			{
				dialog.text = "Вот "+ GetSexPhrase("чудак-человек","чудачка") +"! Твоего согласия не требуется, мы просто забираем, и всё... Но у меня есть и хорошая новость. Тебе, как полноправно"+ GetSexPhrase("му","й") +" граждан"+ GetSexPhrase("ину","ке") +" Города, полагается 1/50 часть!";
			...
			else
			{
				...
				link.l1 = "Мне всё это очень сильно не нравится!";
				link.l1.go = "FT_12";
				pchar.money = 0;
			}
		break;
		case "FT_11":
			dialog.text = "Именно! Ну вот, ты начинаешь понимать... Вообще-то, тебе всё одно это барахло тут ни к чему, а нам всем приятно будет...";
			link.l1 = "Мне всё это очень сильно не нравится!";
			link.l1.go = "FT_12";
		break;
		case "FT_12":
			dialog.text = "Не ты перв"+ GetSexPhrase("ый","ая") +", "+ GetSexPhrase("приятель","подруга") +", кому это не нравится. Но только, уж поверь мне, всё это в твоих интересах. Чем быстрей ты избавишься от всего того, что тебя связывает с большим миром, тем быстрей ты вольёшься в нашу размеренную жизнь.\nА так можешь сойти с ума, такое бывает. И, скажу я тебе, с такими мы не церемонимся - груз на шею, и на дно!";
			link.l1 = "Да уж, справедливость так и прёт...";
			link.l1.go = "FT_13";
		break;
		case "FT_13":
		...
		case "NarvalRing_1":
			dialog.text = "Говори.";
			link.l1 = "Я тут недавно забр"+ GetSexPhrase("ёл","ела") +" в каюту корвета 'Протектор', и совершенно случайно наш"+ GetSexPhrase("ёл","ла") +" там интересный предмет...";
		...
		break;
		case "NarvalRing_3":
			dialog.text = "Хо-хо, да это же амулет 'нарвала'! Так, где ты его наш"+ GetSexPhrase("ёл","ла") +", говоришь?";
		...
		case "NarvalRing_12":
			...
			link.l1 = "Хорошо, Чад, всё сделаю в лучшем виде.";
		...
		case "DestrNarval_1":
			...
			else
			{
				...
				{
					link.l1 = "Да всё нормально. Все живы и здоровы, возвращаю их тебе в целости и сохранности.";
		...
		case "Interception_1":
			...
			link.l1 = "Хе-хе... Ты знаешь, а ведь всё случилось само собой. Я, так сказать, только показал на них пальцем "+ NPCharSexPhrase(sld, "этому идиоту","этой наглой девке") +"...";
		...
		case "Interception_12":
			dialog.text = "Полагаю, всё будет нормально.";
		...
		case "CasperDead_2":
			...
			link.l1 = "Ну, ты мне это не поручал, но и не запрещал. Так что я, с твоего разрешения, пош"+ GetSexPhrase("ёл","ла") +" искать улики. Ну, и заш"+ GetSexPhrase("ел","ла") +" на 'Сан Габриэль'.";
		...
		break;
		case "CasperDead_7":
			dialog.text = "Н-да... Кого-нибудь наш"+ GetSexPhrase("ёл","ла") +" на 'Сан Габриэле'? Кроме 'касперов', конечно.";
		...
		break;
		case "CasperDead_10":
			dialog.text = "Заткнись, "+ GetSexPhrase("полудурок","наглая девчонка") +"!\nТы ещё жив"+ GetSexPhrase("","а") +" только потому, что я хочу закончить эту череду убийств. Кто бы ни был в этом виноват, я не хочу вести дальнейших расследований. Допустим, что во всём виноваты 'касперы', и на этом поставим точку. Тебе ясно?";
			link.l1 = "Да, адмирал.";
		...
		case "CasperDead_12":
			...
			link.l1 = "Адмирал, я знаю Закон. Право на жизнь для граждан - это всё очень правильно.";
		...
		break;
		case "SeekGoods_3":
			dialog.text = "Всё оружие и порох с вновь поступающих кораблей я изымаю. Всё находится у меня на складе в резиденции.";
