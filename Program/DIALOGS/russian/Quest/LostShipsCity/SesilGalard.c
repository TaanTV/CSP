...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "AfterFight_3":
			dialog.text = "Я живу здесь уже около десяти лет. Когда меня вынесло к острову, на нём жили только пять человек, и Хилла Брюннера среди них не было.";
		...
		break;
		case "AfterFight_5":
			dialog.text = "Хм, ну надо же... Вы знаете, с тех пор, как его изолировали, вы второй человек, которому я рассказываю о нём. Первым был Тизер Дэн.";
