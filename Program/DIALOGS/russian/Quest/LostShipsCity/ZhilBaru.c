...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SeekCitizen_Choice_1":
			...
			else
			{
				...
				if (sld.sex == "man")
				{
					...
					Link.l2 = "Нет, не о нём. Даваите ещё раз назову.";
		...
		case "ELTHusb_SF_4":
			...
			link.l1 = "А при чём тут Тейлор?";
			link.l1.go = "ELTHusb_SF_5";
		break;
		case "ELTHusb_SF_5":
			dialog.text = "Да ни при чём, собственно. Просто мы с ним выпивали в тот день в таверне и как раз об этом говорили. Ну, а когда мы с Тейлором пошли домой, я повёл его на 'Сан Августин' и предложил ему высказать недовольство адмиралу прямо в глаза. Он так и сделал.";
