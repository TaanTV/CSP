...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "SeekGoods_4":
			dialog.text = "Извини, но скидки не предусмотрены. В нагрузку подкину тебе парусины и досок за пять тысяч золотых. Итого, если ты желаешь всё это приобрести, то готовь 40 тысяч.";
		...
		case "SeekGoods_5":
			dialog.text = "Отлично, "+ GetSexPhrase("дружище","" + pchar.name + "") +". Куда тебе всё это сгрузить?";
			link.l1 = "Слушай, отправь всё это на 'Сан Габриэль'. 'Касперов' там уже нет, если ты не в курсе...";
			link.l1.go = "SeekGoods_6";
		break;
		case "SeekGoods_6":
			dialog.text = "Я в курсе. Всё сделаю.";
