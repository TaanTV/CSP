...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "FT_7":
			dialog.text = "Прости, "+ GetSexPhrase("дружище","" + pchar.name + "") +", никак невозможно. Могу только намекнуть, что всё надо кое-куда сложить перед встречей с Чадом... Это всё.";
