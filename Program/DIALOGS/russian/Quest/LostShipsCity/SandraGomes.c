...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "ansewer_4":
			dialog.text = "Нет, что вы, очень редко. Вы знаете, когда у нас штормит, то многие мужчины чуть ли не пачкают панталоны, а мне всё нипочём. Штормов я не боюсь!";
		...
		case "ansewer_1":
			...
			link.l1 = "Неужели всё так печально? Я единственн"+ GetSexPhrase("ый","ая") +", кто спасся, мне повезло. Судя по всему, и вы тоже в категории счастливчиков.";
			link.l1.go = "ansewer_1_1";
			NextDiag.(NodePrevName).l1 = true;
		break;
		case "ansewer_1_1":
			dialog.text = "С этой стороны, канечно, так оно и есть. Но если бы вы знали, как всё это надоело! Ничего нового, только крушения и смерть вокруг нас. Живём в кольце несчастий, как это тягостно!..";
			link.l1 = "Ну, это да...";
			link.l1.go = "int_quests";
		break;
		case "ansewer_2":
		...
		break;
		case "SeekCrew_1":
			dialog.text = "Вы нарушили Закон, и ведёте себя так, как будто всё нормально.";
			link.l1 = "Я спасаю свою жизнь, у меня нет иного выбора. Если вы присоединитесь ко мне, то также спасётесь.";
		...
		break;
		case "SeekCrew_3":
			dialog.text = "А вы знаете, я верю вам. К тому же, мне надоело здесь всё до смерти. Так что я с вами, капитан.";
