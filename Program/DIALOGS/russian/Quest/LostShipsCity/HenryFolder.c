...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "ansewer_1_1":
			dialog.text = "Конечно, нет. Никто о нём ничего не знает на Большой земле. Слухи разве что ходят у нищих об Острове Справедливости... Но кто это серьёзно воспримет?";
			link.l1 = "Это точно.";
			link.l1.go = "int_quests";
		break;
		case "ansewer_2":
		...
		break;
		case "SeekCrew_2":
			dialog.text = "Нет, не надоело. Здесь есть всё, что нужно для жизни. И приобретается всё это без усилий.";
