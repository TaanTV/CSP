...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "ansewer_1":
			dialog.text = "Как, вы ещё не знаете? Это Город Потерянных Кораблей. А мы здесь все - потерянные люди... Ах, до чего же всё это надоело!";
			link.l1 = "Понимаю...";
		...
		break;
		case "ansewer_2_1":
			dialog.text = "Имеются, но я не считала. Вы знаете, здесь совершенно всё равно, какой вы нации. Это ровным счётом ни о чём не говорит и ни на что не влияет.";
			link.l1 = "Понятно...";
			link.l1.go = "int_quests";
		break;
		case "ansewer_2":
