...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (npchar.quest.meeting == "0")
			{
				...
				if (CheckAttribute(loadedLocation, "storm"))
				{
					...
					link.l1 = "Очень приятно. А я - капитан " + GetFullName(pchar) + ". Вернее, бывш"+ GetSexPhrase("ий","ая") +" капитан. А всё из-за этого дьявольского шторма!";
					link.l1.go = "FS_1";
				}
				else
				{
		...
		case "ansewer_3":
			...
			link.l1 = "Понятно... Послушайте, а имя или кличка Механик вам ни о чём не говорит?";
