...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Casper_1_1":
			...
			link.l1 = "Армо, что ли, ожидаешь? Так я за неё.";
		...
		case "Casper_12":
			...
			link.l1 = "А ты не Армо ждёшь, дружище? Так её не будет, я за неё.";
		...
		case "Casper_3":
			dialog.text = ""+ GetSexPhrase("Дружище","Дорогуша") +", ты бы "+ GetSexPhrase("шёл","шла") +" отсюда...";
			link.l1 = "А что такое?";
		...
		case "Casper_3_2":
			...
			link.l1 = "Армо не будет, я вместо неё.";
			link.l1.go = "fightQuest";
		break;

		case "Casper_32":
			dialog.text = ""+ GetSexPhrase("Дружище","Дорогуша") +", я прошу тебя, не нарывайся на грубость.";
			link.l1 = "Грубость? Хе-хе, ладно, хватит. Армо не придёт, я за неё.";
		...
		break;
		case "FackYou_4":
			dialog.text = "Что, думаешь, я совсем глупый? Ещё вчера мне всё стало ясно, хотя это были только подозрения. И сейчас я не один.";
