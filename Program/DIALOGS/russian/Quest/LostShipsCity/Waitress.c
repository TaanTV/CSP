...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "ansewer_3":
			...
			link.l1 = "Это да, но всё же... мрачновато как-то.";
		...
		case "NB_3":
			...
			link.l1 = "Армо, я прошу тебя, соберись и расскажи мне, как всё было.";
			link.l1.go = "NB_4";
		break;
		case "NB_4":
		...
		break;
		case "NB_5":
			dialog.text = "Да, у него был раскроен череп. Ох, я не могу это вспоминать без слёз...";
		...
		case "AboutCasper_2":
			...
			link.l1 = "Да, уверен"+ GetSexPhrase("","а") +". Я пош"+ GetSexPhrase("ёл","ла") +" к адмиралу, задавал"+ GetSexPhrase("","а") +" ему вопросы относительно расследования убийства Хилла, хотел"+ GetSexPhrase("","а") +" помочь. В итоге, мне было сказано, чтобы я не лез"+ GetSexPhrase("","ла") +" в это дело. Прямо и откровенно.";
			link.l1.go = "AboutCasper_3";
		break;
		case "AboutCasper_3":
			dialog.text = "А при чём тут 'касперы'?";
		...
		break;
		case "askMoney_2":
			dialog.text = "Сто тысяч - это всё, что я могу предложить.";
			link.l1 = "Отлично!";
		...
		case "SeekCrew_1":
			if (npchar.name == "Армо")
			{
				...
				link.l1 = "Да при чём тут твой Томас?! Оставаясь здесь, ты рискуешь жизнью.";
