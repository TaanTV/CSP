...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "FT_2":
			dialog.text = "Очень много всего, "+ GetSexPhrase("месье","мадемуазель") +", очень много. И всё сразу, представьте себе! Сперва рабы подняли восстание, а в самый разгар подавления нас атаковали охотники за головами, потому что у нас на борту находился один... человек, который был им нужен.\n"+
		...
		case "SeekCitizen_Choice_1":
			...
			else
			{
				...
				if (sld.sex == "man")
				{
					dialog.text = GetFullName(sld) + ", вы о нём говорите?";
		...
		case "int_quests":
			...
			{
				link.l5 = "Слушай, а на чём эти корабли держатся в шторм?";
		...
		break;
		case "ansewer_2_1":
			dialog.text = "Да так, в общих чертах. Я думаю, что под Городом находятся рифы, которые и удерживают все эти корабли. Сначала зацепился один, за него другой, а потом всё это и наросло.";
		...
		break;
		case "Tizer_3":
			dialog.text = "Тизеру Дэну? Хо!.. Ты меня изрядно удивил"+ GetSexPhrase("","а") +", "+ GetSexPhrase("приятель","красавица") +". Тизер Дэн мёртв.";
