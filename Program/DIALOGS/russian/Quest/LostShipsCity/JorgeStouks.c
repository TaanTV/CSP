...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "FT_4":
			...
			link.l1 = "С удовольствием и благодарностью выслушаю всё, что вы скажете.";
			link.l1.go = "FT_5";
		break;
		case "FT_5":
		...
		break;
		case "FT_9":
			dialog.text = "Завтра к вечеру точно всё успокоится. Шторм уже пошёл на убыль.";
		...
		break;
		case "FT_12":
			dialog.text = "Конечно, нет! Это запрещено Законом!.. Вы знаете, я бы не хотел углубляться в эти темы, это не моё дело. Идите к адмиралу, он вам всё расскажет.";
		...
		break;
		case "ansewer_5":
			dialog.text = "Здесь есть всё, что есть в обычном городе - церковь, таверна, магазин. Есть человек, ссужающий деньги. Но я скажу я вам - наиглупейшее это занятие здесь.";
			link.l1 = "Почему?";
