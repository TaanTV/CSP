...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "TakeBombs":
            ...
            {
				link.l1 = "Да, всё у меня. Извольте получить.";
		...
		break;
		case "TakeBombs_1":
			dialog.text = "На 'Сан Габриэль'... Ну хорошо, красав"+ GetSexPhrase("чик","ица") +". За ваше старание я это организую. Попрошу своего избранника, он всё сделает.";
