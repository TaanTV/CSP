...
//********************************* Расследование убийства. Квест №4 **********************************
		...
		break;
 		case "Step_S4_2":
			...
			link.l1 = "Меня зовут " + GetFullName(pchar) + ". Я приш"+ GetSexPhrase("ёл","ла") +" узнать у вас, кто такая донна Анна, которую вы доставили месье д'Ожерону? ";
		...
		break;
 		case "Step_S4_7":
			dialog.text = "Ага, вот теперь мне всё ясно, и я спокойно могу отправлять вас на тот свет. К оружию, сеньор"+ GetSexPhrase("","ита") +"!";
