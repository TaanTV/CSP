...
void ProcessDialogEvent()
{
	...
	switch (Dialog.CurrentNode)
    {
		...
		//--------------
        case "Fight_1":
            dialog.text = "А-а-а, приш"+ GetSexPhrase("ёл","ла") +" всё-таки...";
            link.l1 = "Да, приш"+ GetSexPhrase("ёл","ла") +". Говори скорей, что там у тебя за дело жизни и смерти?";
        ...
        case "Step2_2":
            ...
            link.l1 = "Давайте пройдем в таверну, там за кружечкой всё и обсудим.";
            link.l1.go = "Step2_3";
        break;
        case "Step2_3":
			if (npchar.city == "SentJons" || npchar.city == "FortFrance") sStr = "под";
        ...
        case "Fight_2":
            ...
            link.l1 = "Да, как видишь, я приш"+ GetSexPhrase("ёл","ла") +". Что у тебя ко мне, говори быстрей!";
            link.l1.go = "SecondFight_1";
			PChar.quest.Birglars_Time.over = "yes";
        break;
        case "SecondFight_1":
            dialog.text = "Выкладывай всё, что у тебя есть, и рассказывай, какой у тебя корабль, что за товар в трюмах...";
        ...
        break;
        case "Step3_6":
            dialog.text = "Я уже не боюсь... Я ведь тоже убивал капитанов, мне приходилось это делать... А-а-а-а, страх пожирал мою душу!!!\nНо теперь всё кончилось, я больше не боюсь. И мне надо спешить! Нужно предупредить Августа, чтобы он не прогревал желчный пузырь, а наоборот, делал холодный компресс. Тогда желчь выйдет...";
            link.l1 = "Чего?!";
            link.l1.go = "Step3_7";
        break;
        case "Step3_7":
        ...
        break;
        case "Step3_8":
            dialog.text = "Ну, а ты ищи их. Тебе нужно добраться до Остина раньше, чем они узнают, что это ты убил"+ GetSexPhrase("","а") +" двоих. Будь осторож"+ GetSexPhrase("ен","на") +" и хит"+ GetSexPhrase("ёр","ра") +", не спугни их, иначе они исчезнут!";
            link.l1 = "Остин?..";
            link.l1.go = "Step3_9";
        ...
        case "Fight4_2":
            ...
            link.l1 = "Чтобы это понять, особого ума не надо. Ты ведь третий по счёту, кто пытается меня таким вот образом ограбить. Так что колись, кто вы такие и кто такой Остин?";
            link.l1.go = "Fight4_3";
        break;
        case "Fight4_3":
        ...
        case "Fifth time":
			...
			link.l2 = "Простите, но у меня сейчас дела. До свидания.";
			link.l2.go = "exit";
        break;
        case "Step5_1":
        ...
        break;
        case "Step5_2":
            dialog.text = "Нет, что вы! У меня есть малогабаритный, но весьма дорогостоящий товар. Это как раз то, о чём мечтают торговые капитаны - минимум места на судне и максимум выгоды.";
        ...
        break;
        case "Step5_7":
            dialog.text = "Ну, вот и договорились. Я буду ждать вас там до полуночи, если вы не придёте - всё отменяется.";
        ...
        break;
        case "Fight5_5":
            dialog.text = "Всё-таки я попытаюсь!";
        ...
        case "Step6_2":
            ...
            link.l1 = "Всё как всегда... Ну, хорошо.";
            link.l1.go = "Step_overAll";
        ...
        break;
        case "Fight6_3":
            dialog.text = "Он живёт в одном из поселений ловцов жемчуга, на западной стороне Мэйна.";
        ...
        case "Final_fight":
            ...
            link.l1 = "Добрый день, Остин. Решил"+ GetSexPhrase("","а") +" посмотреть на тебя лично, так сказать. А то одни приветы передают, и всё в подземельях...";
            link.l1.go = "StepF1_1";
        break;
        case "StepF1_1":
        ...
        break;
        case "StepF1_5":
            dialog.text = "Это то же самое, "+ GetSexPhrase("приятель","подруга") +"! Обман, убийство, овладение имуществом жертвы. Всё сходится, "+ GetSexPhrase("морской брат","морская сестра") +".\nТак что отвечу на твой вопрос в начале нашей беседы - а ничего не происходит сверхординарного, всё как шло, так и идёт своим чередом.";
            link.l1 = "Гладко стелешь...";
            link.l1.go = "StepF1_6";
        break;
        case "StepF1_6":
            dialog.text = "Хм, может и так... Говори, зачем приш"+ GetSexPhrase("ёл","ла") +", морск"+ GetSexPhrase("ой брат","ая сестра") +".";
        ...
        break;
        case "StepF1_7":
            dialog.text = "Обострять приш"+ GetSexPhrase("ёл","ла") +"?";
