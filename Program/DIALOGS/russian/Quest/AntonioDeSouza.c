...
void ProcessDialogEvent()
{
    ...
    switch (Dialog.CurrentNode)
    {
        case "First time":
			...
			link.l1.go = "exit";
//>>>>>>>>>>>>========= Разброс диалогов =====================
			if (CheckAttribute(pchar, "questTemp.PDM_ONV_OhotaNaVedmu"))	//Квест "Охота на ведьму"
			{
...
//********************************* Задания Инквизиции. Квест №2 **********************************
		...
		break;
 		case "Step_S2_19":
			...
			link.l1 = "Так вот, монсеньор, я наш"+ GetSexPhrase("ёл","ла") +" эту книгу. Вот она.";
...
//********************************* Квест "Охота на ведьму" **********************************		
		case "Inqizitor_2":
			...
			PlaySound("Interface\new_level.wav");
			Log_info("Инквизитор благословил вас.");
...
//**************************** сдаём зачарованный Дес-Мойнес ********************************
		...
		case "MCIncq_1":
			dialog.text = "Говори.";
			link.l1 = "Это городок Дес-Мойнес, что находится в лагуне Маракайбо. Нужно срочно сжечь там всё до тла!";
			link.l1.go = "MCIncq_2";
		break;
		case "MCIncq_2":
		...
		break;
		case "MCIncq_3":
			dialog.text = "А чтобы ты и в дальнейшем "+ GetSexPhrase("старался","старалась") +" как следует, прими в награду за труды 50 тысяч пиастров.";
