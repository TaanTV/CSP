...
//>>>>>>>>>>>>========= Разброс диалогов по персонажам =====================
            ...
            if (npchar.id == "Alan_MacLine" && pchar.questTemp.State == "WormEnglPlans_SaveOfficer")
            {
    			...
    			link.l1 = "Я приш"+ GetSexPhrase("ёл","ла") +" освободить вас!";
            ...
            {
    			dialog.text = "С нетерпением ожидаю вашего доклада о поисках.";
    			link.l1 = "Минхер, мне удалось выяснить, кто продавал искомую христианскую книгу. Этого флибустьера зовут Лоран де Граф. Вернее, звали, так как он погиб. Когда я добрал"+ GetSexPhrase("ся","ась") +" до него у берегов Картахены, он вёл бой с очень мощной испанской эскадрой. Мне не удалось спасти его фрегат, сам Лоран утонул вместе с кораблём. Боюсь, что это всё, книгу найти теперь просто невозможно.";
    			link.l1.go = "Step_H8_12";
            }
            if (npchar.id == "Chumakeiro" && pchar.questTemp.State == "SeekBible_DeGrafDieHard")
            {
    			dialog.text = "С нетерпением ожидаю вашего доклада о поисках.";
    			link.l1 = "Минхер, мне удалось выяснить, кто продавал искомую христианскую книгу. Этого флибустьера зовут Лоран де Граф. Когда я наш"+ GetSexPhrase("ёл","ла") +" его близ Картахены, он вёл бой с очень мощной испанской эскадрой. Я не смог"+ GetSexPhrase("","ла") +" ничем помочь де Графу, силы были слишком неравны. Мне пришлось покинуть поле боя.";
    			link.l1.go = "Step_H8_12";
            }
            ...
            if (npchar.id == "Chumakeiro" && pchar.questTemp.State == "SeekBible_WeWon")
            {
    			...
    			link.l1.go = "Step_H8_12";
    			link.l2 = "Все ищу, дерусь, топлю испанцев... Но книгу не наш"+ GetSexPhrase("ёл","ла") +" пока... Однако продолжу поиски...";
    			link.l2.go = "exit";
			}
...
. Но давайте по порядку.\n"+
		...
		break;
        case "Step_H8_8":
			dialog.text = "До меня дошли слухи, что один из английских каперов в Шарп-Тауне намеревался продать старую христианскую книгу, написанную на неизвестном ему языке.";
		...
		break;
        case "Step_H8_16":
			dialog.text = "Бренное существование человечества на этой земле - трагедия людей. Но скоро всё придёт в норму, к тому, с чего началось...";
			link.l1 = "Вы это серьёзно? Проклятье, испортили мне всё настроение от получения такой значительной суммы. Ну да ладно... Вы, пожалуй, ожидайте развязки своей трагедии, а я займусь более прозаичными вещами - суетой сует. С такой суммой в кармане эта моя личная трагедия существования доставит мне очень много приятных минут.";
