	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
            ...
            if (pchar.questTemp.Ascold == "Ascold_MummyFoundItems")
            {
                ...
                {
                	link.l1 = "Их нет у меня, я их не наш"+ GetSexPhrase("ёл","ла") +"...";
            		link.l1.go = "Step_30";
                }
            }
        ...
        case "Step_19":
    		...
    		link.l1 = "Здорово! Ну, я пош"+ GetSexPhrase("ёл","ла") +"?";
    		link.l1.go = "Step_20";
		break;
        ...
        case "Step_27":
        	dialog.text = "За это не волнуйся, я тебе его верну в целости. Твоё тело мне не нужно, оно мне не нравится.\n"+
                          "Все, ты можешь идти.";
    		link.l1 = "Хорошо, всё это я принесу тебе. А ты пока будь очень осторожен.";
    		link.l1.go = "Step_28";
		break;
