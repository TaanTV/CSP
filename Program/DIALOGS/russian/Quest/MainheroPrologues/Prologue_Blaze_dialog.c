void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			link.l1 = "Какого..!? О чём ты? Я тебя в первый раз вижу, как я могла что-то у тебя украсть?";
			link.l1.go = "2";
...
//at pirate meeting
		...
		case "22":
			dialog.text = "Вы сомневаетесь в Беатрис, в том, что её мечты реальны. Я скажу вам - если в этой комнате и есть кто-то, кто способен воплощать мечты, то это она. Вы колеблетесь. Я могу вас понять - такие решения нелегко даются. Но подумайте вот о чем: шанс изменить мир - чертовски редкая штука. Очень немногие вообще когда-либо получают такой шанс, и никто, никогда не получает его дважды. Всё это, здесь и сейчас - это наш шанс. Что с ним делать - решать вам и только вам. Но я знаю одно - я не упущу свой шанс даже за все золото мира! Я сделал свой выбор, теперь ваш черёд!";
			link.l1 = "...";
			link.l1.go = "Exit";
		break;
