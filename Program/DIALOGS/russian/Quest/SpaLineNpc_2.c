...
//*************************** Квест №2, диалоги с Франциско на выходе из Инквизиии ***************************
		...
		break;
 		case "Step_S2_17":
			dialog.text = "Это вряд ли. Так вот, недавно мы вышли на след похитителя, он объявился в Шарп-Тауне. Попытки выкупить у него реликвию не принесли результата, тогда мы наняли матросов из таверны. Вор оказался на удивление силён и даже ранил нескольких человек, после чего бросился бежать. Матросы следовали за ним по пятам и нагнали у верфи. Но там он как сквозь землю провалился.";
			link.l1 = "Как это?";
