void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Quest_Whisper_10":
			dialog.text = "Это долгая история. Но могу тебе сказать, что инквизиция не просто орден, который борется с еретиками. На самом деле они не гнушаются участвовать в политике, да и в целом уже давно погрязли в коррупции и лжи. В их власти обвинить любого человека в ереси, сжечь, а имущество отобрать в пользу собственной казны, чем они не пренебрегают пользоваться. Однажды они сделали нечто подобное и со мной, но мне удалось сбежать в последний момент. С тех пор инквизиция за мной охотится.";
		...
		case "Quest_Whisper_Incq_3":
			dialog.text = "Можешь оставить всё себе, в конце концов, ты сделал" + GetSexPhrase("","а") + " всю работу. И добычу от разграбления города тоже. Я пришла сюда, чтоб избавиться от старого назойливого врага и забрать свой дробовик, а не ради этой горстки кровавых монет.";
