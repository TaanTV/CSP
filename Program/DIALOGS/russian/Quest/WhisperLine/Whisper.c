void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "chard_check_journal":
			...
			dialog.Text = "Посмотрим... Здесь тоже всё зашифровано. Мне понадобится время. Несколько часов. Можешь пока погулять.";
		...
		case "chard_discuss_quest_4":
			dialog.Text = "Ну как же, мастер-корабел, лучший во всём архипелаге. У него в Шарп-Тауне своя верфь есть. Можешь показать ему свой корабль. Хоть 'Пёс' и хорош, я уверен, Алексус найдёт способы, как его можно улучшить. Тогда ты без проблем расправишься с любой эскадрой.";
			Link.l2 = "Ладно, я подумаю. Где вообще искать этого англичанина?";
			Link.l2.go = "chard_discuss_quest_5";
		break;
		...
		break;
		case "ADS":
			dialog.text = "Правда? Говори тогда, кто ты? Такой цвет глаз и волос не каждый день увидишь, знаешь ли. И что за пистоль у тебя изъял Эрнан Эстебан?";
		...
		break;
		case "CS_good_1":
			dialog.text = "Только будь осторожна на выходе отсюда. Мои датчики показывают, что ты уничтожила не всех ботов. Я не смогу отключить их удалённо, так что тебе придётся разбираться с ними самостоятельно.";
			link.l1 = "Ага, прощай.";
			link.l1.go = "ExitSC";
		break;
		...
		case "CapitolCaptured":
            ...
            Link.l1 = "Мы? Что-то не припомню, чтобы видел"+GetSexPhrase("","а")+" тебя среди сражавшихся.";
