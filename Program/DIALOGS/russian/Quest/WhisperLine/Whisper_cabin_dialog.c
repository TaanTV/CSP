	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			if (npchar.id == "W_ChinamanGuard")
			{
				...
				{
					Lai_SetPlayerType(pchar);
					dialog.text = "Не то место ты выбрал для лучшей жизни. Здесь ситуация ненамного лучше, разве что женщины у нас доступнее. Э-э-э... конечно же я не вас конкретно имел в виду, капитан.";
		...
		case "BS_21_WhisperIsHere":
			dialog.text = "";
			Link.l1 = "Ты как нельзя вовремя! Не знаю, о чём я только думаю, когда лезу в каюты драться с капитанами в одиночку.";
