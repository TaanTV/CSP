...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Tichingitu":
			...
			link.l1 = "Тебя зовут Тичингиту? Хм. Послушай, воин, я приш"+ GetSexPhrase("ёл","ла") +" не для того, чтобы пялить на тебя глаза, а чтобы спросить: зачем ты полез в дом к этому мужику?";
