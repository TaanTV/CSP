void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "LPGoodSide_3":
			dialog.text = "Они же люди обидчивые, из-под земли достанут. Пока у меня получается прятаться, но я не уверен, что так будет вечно. Полагаю, что даже на другом острове они меня достанут.";
		...
		case "LPGoodSide_4":
			...
			AddQuestUserData("Rimalie", "sSex", GetSexPhrase("","а"));
		break;
