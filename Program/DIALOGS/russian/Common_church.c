...
void ProcessDialogEvent()
{
	...
	//================================================================================================================
		...
		case "prihod":
			...
			{
				dialog.text = "О, "+ GetSexPhrase("сын мой","дочь моя") +", совершено ужасное кощунство, позорнейшее из преступлений! Обокрасть церковь!!! Да это всё равно, что запустить свои грязные лапы прямо в карман Господу!";
				link.l1 = "И как же это случилось?";
				link.l1.go = "GenQuest_Church_2_Start_3";
			...
			{
                dialog.text = "Мне не совсем удобно об этом говорить, но у меня нет другого выхода. В жизни нет случайных вещей. И на всём лежит воля Всевышнего. Может быть, ты и есть то оружие Господне, которое необходимо нам для истребления нечисти, оскверняющей нашу землю.";
		...
		case "healthAdd_2":
			...
			link.l1 = "А вы не могли бы помолиться за меня?";
