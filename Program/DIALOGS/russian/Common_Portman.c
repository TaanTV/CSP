...
//			if(rand(1) == 0) PChar.GenQuest.ChurchQuest_1.CapWaitOnTavern = true;
		...
		case "node_4":
			...
			if (npchar.quest == "SeekShip_success") //украденный корабль взят на абордаж
			{
				...
				if (bOk)
				{
					link.l1 = "Да, я наш"+ GetSexPhrase("ёл","ла") +" его, стоит в порту на рейде. Можете забирать.";
		...
		case "BurntShip7":
			...
			link.l1 = "Да, дело непростое. А сколько у меня есть времени?";
		...
		case "PortmanQuest_3":
			...
			link.l1 = "Ясно. Ну, я пош"+ GetSexPhrase("ёл","ла") +"...";
			link.l1.go = "exit";
