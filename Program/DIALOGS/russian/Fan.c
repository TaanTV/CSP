	...
	switch(Dialog.CurrentNode)
	{
		...
		case "CoolStory":
			...
			switch (rand(20))
			{
				...
				break;
				case 6:
					coolstory = "Слишком много кораблей в паке. Хрен с ними с плохими моделями. Многие можно заменить. Но многие корабли просто ненужны. Они просто банально ни о чём. Зачем в игру нужно добавлять 10 видов шлюпов ненужных, когда будет три нормальных и адекватно сбалансированных?";
				...
				break;
				case 10:
					coolstory = "Всё это дичь все эти перекрасы, которым уже десятки лет. Без новых моделей ничего не будет.";
