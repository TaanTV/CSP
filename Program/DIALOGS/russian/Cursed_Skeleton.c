...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "meeting_6":
			dialog.text = "Мой собственный старпом! Я считал его своим лучшим другом, а он меня предал, ещё и команду подговорил. Всё из-за этого проклятого черепа, будь он не ладен.";
