...
// <-- Вызов персонажей by xxxZohanxxx
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "WhisperTownbattle_1":
				...
				Link.l1 = "Мне жаль что всё так вышло, приятель. Надеюсь, ты не в обиде.";
		...
		case "First time":
			...
			if (CheckAttribute(pchar, "questTemp.Whisper.Entered_Dungeon"))
			{
				...
				if (bBettaTestMode)
                {
			        link.l1 = "Бета Тест - пропустить и начать игру.";
...
// <-- Вызов персонажей by xxxZohanxxx
            ...
            {
				Link.lfixbag = "Помолиться Богу. (исправить баги)";
...
// <-- Вызов персонажей by xxxZohanxxx
		...
		case "fixbag":
			dialog.text = "Какой баг исправим?";
			/*if (!CheckAttribute(pchar, "molitva.bagPP"))
			{
				link.l1 = "Исправить баг с высадкой в Пуэрто-Принсипе.";
				link.l1.go = "fixbagPP";
			}

			if (!CheckAttribute(pchar, "molitva.bagDMU"))
			{
				link.l2 = "Добавить ростовщика в Дэс-Мойнес.";
				link.l2.go = "fixbagDMU";
			}*/

			link.l99 = "Закончить молитву.";
			link.l99.go = "exit";
		break

		case "fixbagPP":
			dialog.text = "Баг исправлен.";
			link.l1 = "Аминь!";
			link.l1.go = "exit";
		...
		break;
		case "fixbagDMU":
			dialog.text = "Добавлен ростовщик в Дес-Мойнес.";
			link.l1 = "Аминь!";
			link.l1.go = "exit";
