...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	switch (Dialog.CurrentNode)
	{
        ...
        break;
 	 	case "Step_H3_2":
			dialog.text = ""+ GetSexPhrase("Милый мой","Милая моя") +", мне ли не знать?! Не было ещё дня с момента его возвращения, когда он не появлялся у меня. И каждый день берёт новую девку, хоть за такое непостоянство я и увеличиваю тарифы вдвое. Так что, если хочешь его застать, то просто подожди.";
		...
		break;
        case "Endurance":
			dialog.text =  "Выносливость, хорошо. Ну что ж, готовим сверхпрочные связки - и будем менять. Полагаю, откладывать нет смысла, приступаем прямо сейчас.";
			Link.l1 = "Приступаем к чему?";
			Link.l1.go = "Step_10";
