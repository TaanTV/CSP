            ...
            if (pchar.questTemp.State == "Inquisition_toCuracao" || pchar.questTemp.State == "Inquisition_afterFrancisco")// квест №2 голл. линейки.
            {
                ...
                else
                {
                    if (CheckPassengerInCharacter(pchar, "JacowDeFonseka"))
                    {
            			...
            			link.l1 = "Ну что же, прекрасно. Могу вас поздравить, что всё так удачно разрешилось.";
...
//*************************** Квест №2 испанки, задание Инквизиции ***************************
	    ...
	    AddQuestUserData("Spa_Line_2_Inquisition", "sSex", GetSexPhrase("ся","ась"));
 		...
 		case "Step_S2_8":
    		dialog.text = "И что?";
    		link.l1 = "Хм, так я сумел"+GetSexPhrase("","а")+" это сделать. Евангелие у меня.";
 		...
 		break;
 		case "Step_S2_12":
    		dialog.text = "Идите, "+GetSexPhrase("друг мой","подруга моя")+". Прощайте, вся наша община вам благодарна по гроб жизни! Ах, я представляю себе, что сейчас начнётся, когда все узнают, что пропавший артефакт Самуэля Коханэ найден...";
		...
		case "Dozor_6":
			...
			link.l1 = "Я готов"+ GetSexPhrase("","а") +" ответить на загадку прямо сейчас.";
			link.l1.go = "Dozor_8";
			link.l2 = "Мне нужно время подумать над загадкой. Но я обязательно вернусь к тебе и дам правильный ответ.";
			link.l2.go = "exit";
			PChar.Dozor = "11";
		...
		case "Dozor_9":
			...
			if(sString == "мария галанте" || sString == "остров мария галанте")
			{
