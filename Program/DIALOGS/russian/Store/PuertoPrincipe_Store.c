...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	switch (Dialog.CurrentNode)
	{
		...
		break;
		case "BlueBird_6":
			dialog.text = "Уверен. Только никто меня не слушает, все думают, что это говорит обида на него за потерянное дело в Шарп-Тауне. Оно, конечно, не без этого, но не до такой же степени!\nА потом я вообще перестал что-то говорить - намекнули добрые люди, чтобы я поутих...";
		...
		break;
		case "BlueBird_9":
			dialog.text = "Ну вот, значит ход моих рассуждений верен... Ты знаешь, в Шарп-Тауне есть подземный ход, ведёт из верфи прямо в бухту. В общем, ищи, "+ GetSexPhrase("приятель","подруга") +", да прибудет с тобой сила!";
