...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			if(PChar.MysteriousIsland == "10" && PChar.MysteriousIsland.FindForser.Citizen == false)	// Квест "Загадочный остров"
			{
				link.l1 = "Послушайте, известно ли вам что-нибудь о неком капитане Дэви Форсере?";
...
//******************** Квест "Загадочный остров" ******************		
		case "MysteriousIsland_1":
			...
			dialog.text = "Хм... Нет, не припоминаю такого.";
			link.l1 = "Жаль.";
			link.l1.go = "exit";
		break;
	}
