	...
	switch(Dialog.CurrentNode)
	{
		...
		//********************* Английская линейка *********************
 		...
 		case "No_Mansfield_first_time":
			dialog.text = "Добрый день, меня зовут Алистер Гуд. После гибели Мэнсфилда я выбран главой буканьеров.";
        ...
        break;
 		...
 		case "Step_H3_3":
  		...
  		break;
 		case "Step_H3_4":
			dialog.text = "Всё дело в том, что я не знаю ничего о планах Мэдифорда по этой войне. У меня с ним дела другого порядка, политика здесь ни при чём.";
