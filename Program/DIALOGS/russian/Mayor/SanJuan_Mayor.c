...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		break;
		case "Romantic_3":
			dialog.text = "Это мне известно. По приезду из Белиза от своей кузины Фернандес, Изабелла была у меня на приёме и рассказала обо всём этом. Так вы и есть её спаситель?";
		...
		break;
		case "Romantic_5":
			dialog.text = "Бесспорно, капитан, так оно и есть. Ну что же, теперь мне всё достаточно ясно. Полагаю, мы проведём обряд освещения церкви за общественный счет.";
