...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "PL_Q8_deck_1":
			dialog.text = "Ну вот, опять ты. О чём я и говорю!";
		...
		break;
		case "PL_Q8_deck_3":
			dialog.text = "Слушай, "+ GetSexPhrase("шёл","шла") +" бы ты отсюда... Мне с тобой не о чем говорить. Все решится в Панаме, пусть каждый там и покажет, на что он способен.";
		...
		case "PL_Q8_deck_4":
			...
			link.l1 = "Ну ладно, я пош"+ GetSexPhrase("ёл","ла") +". Не хочешь разговаривать - как хочешь...";
			link.l1.go = "exit";
