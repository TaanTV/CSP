	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (npchar.quest.meeting == "0")
			{
				...
				{
					dialog.text = "Greetings"+ GetSexPhrase("new citizen", "new citizen") +" Cities! We are very glad to see you. I'm sorry, I forgot to introduce myself. My name is " + GetFullName(npchar) + ", I live here.";
					link.l1 = "I noticed that.. Well, I -" + GetFullName(pchar) + ".";
					link.l1.go = "FS_1";
				}
				else
				{
		...
		//вопросы
		case "int_quests":
			dialog.text = "I'm listening to you carefully, "+ GetSexPhrase("buddy", "dear") +".";
		...
		break;
		case "ansewer_1":
			dialog.text = "This is the City of Abandoned Ships, "+ GetSexPhrase("buddy", "girlfriend") +". If you got here, then forget about everything you've lived with earlier. You can't get out of here, unfortunately...";
			link.l1 = "The Devil!!";
			link.l1.go = "exit";
