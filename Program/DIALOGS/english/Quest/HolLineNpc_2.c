...
//>>>>>>>>>>>>========= Разброс диалогов по персонажам =====================
            ...
            {
    			dialog.text = "You won! I give up...";
    			link.l1 = "I want to know where the hell is Antonio?! Answer me!!!";
    			link.l1.go = "Step_H7_1";
            }
            if (npchar.id == "LoranDeGraf")// Лоран де Граф, квест №8
            {
    			dialog.text = ""+ GetSexPhrase("Sir", "Miss") +", now is not the time to talk! There is a fight going on.";
    			link.l1 = "Yes, yes, I know...";
    			link.l1.go = "exit";
            }
			if (pchar.questTemp.State == "SeekBible_WeWon" && npchar.id == "LoranDeGraf")// Лоран де Граф, квест №8
            {
    			dialog.text = "I am extremely grateful to you for your help, "+ GetSexPhrase("sir", "miss") +". You arrived just in time. Let me introduce myself, my name is Laurent de Graaf.";
    			link.l1 = "I know, I was just looking for you. First in Bermudes, then in Tortuga.";
    			link.l1.go = "Step_H8_10";
            }
            if (pchar.questTemp.State == "SeekBible_IHaveMap")
            {
    			dialog.text = "It seems to me that our transaction is completed, "+ GetSexPhrase("sir", "miss") +".";
    			link.l1 = "Correct, completed.";
    			link.l1.go = "exit";
            }
            if (pchar.questTemp.State == "SeekBible_SeekMoney")
            {
    			dialog.text = "Have you found the money, sir"+ GetSexPhrase("sir", "miss") +"?";
                if (sti(pchar.money) >= 235000)
                {
                    link.l1 = "Yes, have. And ready to give them to you...";
        			link.l1.go = "Step_H8_13";
                }
                else
                {
                    link.l1 = "Not yet, I'm on the search...";
        			link.l1.go = "exit";
                }
            }
        break;
...
//********************************* Диалоги кэпа, который увёз де Барраса из Тортуги **********************************
 		case "Step_H7_1":
			dialog.text = "Antonio de Barras? I dropped him off on the way here on a Spanish war galleon.";
			link.l1 = "The Devil! What was the name of this galleon and where did it go?";
			link.l1.go = "Step_H7_2";
		break;
  		case "Step_H7_2":
			dialog.text = "Galleon Isabella, headed for Main to Santa Catalina. Antonio told me that he absolutely and urgently needed to go there.";
			link.l1 = "Ah, damn! Listen, you're a pirate, why the hell are you messing with the Spaniards?!";
			link.l1.go = "Step_H7_3";
		break;
  		case "Step_H7_3":
			dialog.text = "None of your damn business, carramba..\n"+
                          "Hey, you guys are just in time! Get out "+ GetSexPhrase("this dude, I'm tired of it", "this bastard, I'm tired of it") +"he told me...";
			link.l1 = "Argh...";
		...
		case "Step_H8_10":
			dialog.text = "Who are you and how can I help?";
			link.l1 = "My name is " + GetFullName(pchar) + ", I wanted to buy the book that you offered for sale in the Jackman society from you.";
			link.l1.go = "Step_H8_11";
    	break;
		case "Step_H8_11":
			dialog.text = "Ah-ah, that's how? Well, that can be arranged. I could not sell the book and, in fact, hid it in a safe place. The deal is, you pay me 235000 piastres, and I give you a map of where the book is.";
			link.l1 = "Isn't that a lot - 235 thousand?";
			link.l1.go = "Step_H8_12";
    	break;
		case "Step_H8_12":
			dialog.text = "No. The fact is that there is something else in that cache. So this is the price for everything, for the whole treasure.";
            if (sti(pchar.money) >= 235000)
            {
                link.l1 = "Agreed, sir. Here's your money!";
    			link.l1.go = "Step_H8_13";
    			AddMoneyToCharacter(pchar, -235000);
            }
            else
            {
                link.l1 = "I don't have enough money right now. I'll have to look you up later.";
    			link.l1.go = "Step_H8_15";
            }
    	break;
		case "Step_H8_13":
			dialog.text = "Please get a map. Look, I'm glad I finally managed to sell this useless thing for me. But please tell me, why do you need it?";
			link.l1 = "I'm acting on behalf of the Dutch authorities, so I don't have to speculate much.";
			link.l1.go = "Step_H8_14";
            GiveItem2Character(pchar, "LegransMap");
    	break;
		case "Step_H8_14":
			dialog.text = "Ah, got it. Well, a good deal for both of us.";
			link.l1 = "That's right. I am grateful to you, Laurent de Graaf. I hope to see you again.";
			link.l1.go = "exit";
        ...
        break;
		case "Step_H8_15":
			dialog.text = "Fine, "+ GetSexPhrase("sir", "miss") +". You can find me at the Tortuga tavern.";
			link.l1 = "Okay, I'll be with you soon, wait.";
			link.l1.go = "exit";
