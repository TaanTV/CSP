...
//grotto - dialog 2
		...
		case "5":
			...
			dialog.text = "You're a tough devil. Why did you stop? Let's get this over with!";
		...
		case "7":
			...
			link.l1 = "He is the one. At your service, dearest sister. It's a pity that we happened to meet thanks to such a stupid coincidence, but I'm glad to see you anyway.";
			link.l1.go = "8";
			link.l2 = "Your brother. I'm afraid I'm going to have to kill you now-I have no desire to share my treasures with anyone but me, and, again, me. It's time to end our family meeting.";
		...
		case "9":
			...
			link.l1 = "Libertania, you say... A big dream, that's for sure. I wonder if he is getting closer to her incarnation? Besides raising a hefty pile of money, of course.";
			link.l1.go = "10";
		...
		case "10":
			dialog.text = "He didn't just get close, he almost did, but his enemies made sure people forgot. 20 years ago, he assembled a powerful fleet to take over the colonies, but one of his men betrayed all his plans to the enemy. His father's fleet was intercepted by the combined forces of England, France and Holland, and destroyed in heavy fighting.\nOur father died in that battle, and the colonial Powers went to great lengths to make him look like a simple pirate who was justly punished. But he seems to have foreseen it, and arranged for you and I to grow up safe, far from each other, and inherit his treasure and his dreams when we grow up and his affairs are safely forgotten.";
		...
		case "11":
			...
			link.l1 = "Libertania... It sounds great, even if it's impossible madness. I'm with you, sister!";
...
//after advisor quest done
		...
		case "18":
			dialog.text = "How nice of you, Blaze. I didn't think you cared much about that...";
...
//at pirate meeting - autodialog 2
		...
		case "21":
			dialog.text = "Great you here. I'm not a great speaker, and I'm not going to torture you with long speeches\n As you probably know, my father, Nicholas Sharp, tried 20 years ago to create Liberty on these islands - a new, free state. Free from the greedy exploiters of the Old World, free from their petty wars, the whole point of which is to get a king a little glory and gold. As you again may know, his father was defeated - one of his associates betrayed him, and as a result his fleet was destroyed\n But what you probably don't know is how damn close Dad was to success. As close as I am to realizing his dream, I have made every effort not to repeat his mistakes, but I cannot do it alone. I need you - free men with your ships to fight those who dare to command you, to impose their laws and their wars\n I'm not asking you to die under the fire of their forts - no, what I need from you is far less dangerous, but equally important to victory. I need you to disrupt their trade, drown their convoys, attack their patrols. I need you to become privateers of freedom. I ask a lot, but the reward, the freedom you can have is truly invaluable. So I ask you - follow me into the beautiful new world that we will create!";
			link.l1 = "...";
			link.l1.go = "Exit";
		break;
...
//after pirate meeting
		...
		case "25":
			dialog.text = "Well, well, Blaze. You really did it! Congratulations!";
			link.l1 = "We did it, Beatrice, we did it. If it wasn't for your great speech, they wouldn't have followed me.";
			link.l1.go = "26";
		break;

		case "26":
			dialog.text = "Well, if you insist. So... What do you propose to do now, dear stepbrother?";
		...
		case "27":
			...
			link.l1 = "Ha, that's right, madam! In my cabin or yours?";
			link.l1.go = "28";
		break;
