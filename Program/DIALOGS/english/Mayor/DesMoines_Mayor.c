...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{
		case "quests":
			dialog.text = NPCStringReactionRepeat(RandPhraseSimple("What did you want? Ask away.", "I'm listening to you, what's the question?"), "For the second time in a day, you're trying to ask a question...", "For the third time in a day, you're trying to ask a question again...",
