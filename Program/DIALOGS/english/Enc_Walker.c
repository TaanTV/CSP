// диалог из ПКМ
#include "DIALOGS\english\Enc_Walker.h"
...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			if (NPChar.sex != "man")
			{
                dialog.text = RandPhraseSimple("My husband forbids talking to "+ GetSexPhrase("strangers", "outsiders") +"!",
                         "I have nothing to talk about with you.");
				Link.l1 = "Well, you don't need to.";
				Link.l1.go = "exit";
                break;
			}
			link.l10 = LinkRandPhrase ("Tell me, what kind of stories are in use in the tavern here?",
									"Better tell me, is there anything new in these parts?",
									"Tell me better, buddy, how is life on land?");
		...
		case "torg":
            if (CheckAttribute(Pchar, "questTemp.CapBloodLine") && Pchar.questTemp.CapBloodLine == true)//homo закрыл баг по линейке.
            {
                dialog.Text = "Wait, aren't you a plantation slave by any chance?";
		...
		case "new question":
            dialog.text = NPCharRepPhrase(npchar,
		                PCharRepPhrase(LinkRandPhrase("Oh, yes, I'm glad to see you like a rum, ask what you want.", "Do you like to chat, Captain? Well, me too... Especially over a mug of rum.", "Yes, " + PChar.name + "?"),
		                ...
		                PCharRepPhrase(LinkRandPhrase("What did you want to know "+ GetAddress_Form(NPChar) + "?", "I'm listening to you, Captain.", "I have to go, so ask me soon, Captain."),
                                        LinkRandPhrase("I'm always glad to a pleasant companion, " + GetAddress_Form(NPChar) + " " + Pchar.name + ". Speak up.",
			...
			link.l5 = PCharRepPhrase(RandPhraseSimple("You heard me, I'm going.", "No, nothing - just went out for a walk."),
                                        RandPhraseSimple("Okay, nothing. Good luck!", "Just taking a walk. Goodbye."));
			link.l5.go = "exit";
		break;
