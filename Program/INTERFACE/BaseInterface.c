...
{
	questTextFileName[0] = "PROGRAM\questbook\"+ LanguageGetLanguage()+ "\QuestBook0_Info.txt";
	questTextFileName[1] = "PROGRAM\questbook\"+ LanguageGetLanguage()+ "\QuestBook1_Generic.txt";
	questTextFileName[2] = "PROGRAM\questbook\"+ LanguageGetLanguage()+ "\QuestBook2_Lines.txt";
	questTextFileName[3] = "PROGRAM\questbook\"+ LanguageGetLanguage()+ "\QuestBook3_Changelog.txt";
	questTextFileName[4] = "PROGRAM\questbook\"+ LanguageGetLanguage()+ "\QuestBook4.txt";
...
void InitInterfaceTables()
{
	...
	Interfaces[ITEMS_EXCHANGE].SectionName = "interface\items_exchange.c";
    Interfaces[ITEMS_EXCHANGE].IniFile = "RESOURCE\INI\INTERFACES\items_exchange.ini";
}
