...
void InitInterface(string iniName)
{
	...
	SetNewPicture("INFO_PICTURE", "loading\jonny_load\battle\battle_"+rand(5)+".dds");
...
void CalculateInfoData()
{
	...
	{
		totalInfo = GetConvertStrWithReplace("Variable_LeaveBattle_1", "Interface.txt", "#space#", " ");
		sEnd = GetConvertStrWithReplace("Variable_LeaveBattle_2", "Interface.txt", "#space#", " ")
	}
	if (GetAttributesNum(rootItems) > 1)
	{
		totalInfo = GetConvertStrWithReplace("Variable_LeaveBattle_3", "Interface.txt", "#space#", " ");
		sEnd = GetConvertStrWithReplace("Variable_LeaveBattle_4", "Interface.txt", "#space#", " ")
	}
