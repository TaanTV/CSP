...
void UpgradeMainInterface()
{
	...
	CreateString(true,"OnChar",GetConvertStrWithReplace("Variable_ColonyBuilding_1", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 160,44,SCRIPT_ALIGN_CENTER,1.5);
	CreateString(true,"Good",GetConvertStrWithReplace("Variable_ColonyBuilding_2", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 390,44,SCRIPT_ALIGN_CENTER,1.5);
	CreateString(true,"Need",GetConvertStrWithReplace("Variable_ColonyBuilding_3", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 625,44,SCRIPT_ALIGN_CENTER,1.5);
	...
	CreateString(true,"BlocksString",GetConvertStrWithReplace("Variable_ColonyBuilding_4", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 150,90,SCRIPT_ALIGN_CENTER,1.2);
	CreateString(true,"BuilderBlocksString",GetConvertStrWithReplace("Variable_ColonyBuilding_5", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 630,90,SCRIPT_ALIGN_CENTER,1.2);
	...
	CreateString(true,"PlanksString",GetConvertStrWithReplace("Variable_ColonyBuilding_6", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 150,175,SCRIPT_ALIGN_CENTER,1.2);
	CreateString(true,"BuilderPlanksString",GetConvertStrWithReplace("Variable_ColonyBuilding_7", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 630,175,SCRIPT_ALIGN_CENTER,1.2);
	...
	CreateString(true,"MahoganyString",GetConvertStrWithReplace("Variable_ColonyBuilding_8", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 150,255,SCRIPT_ALIGN_CENTER,1.2);
	CreateString(true,"BuilderMahoganyString",GetConvertStrWithReplace("Variable_ColonyBuilding_9", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 630,255,SCRIPT_ALIGN_CENTER,1.2);
	...
	CreateString(true,"EbonyString",GetConvertStrWithReplace("Variable_ColonyBuilding_10", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 150,340,SCRIPT_ALIGN_CENTER,1.2);
	CreateString(true,"BuilderEbonyString",GetConvertStrWithReplace("Variable_ColonyBuilding_11", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 630,340,SCRIPT_ALIGN_CENTER,1.2);
	...
	CreateString(true,"SlavesString",GetConvertStrWithReplace("Variable_ColonyBuilding_12", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 150,425,SCRIPT_ALIGN_CENTER,1.2);
	CreateString(true,"BuilderSlavesString",GetConvertStrWithReplace("Variable_ColonyBuilding_13", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 630,425,SCRIPT_ALIGN_CENTER,1.2);
	...
	CreateString(true,"FoodString",GetConvertStrWithReplace("Variable_ColonyBuilding_14", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 150,510,SCRIPT_ALIGN_CENTER,1.2);
	CreateString(true,"BuilderFoodString",GetConvertStrWithReplace("Variable_ColonyBuilding_15", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 630,510,SCRIPT_ALIGN_CENTER,1.2);
...
{
	CreateString(true,"NameHeader",GetConvertStrWithReplace("Variable_ColonyBuilding_16", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 400,102,SCRIPT_ALIGN_CENTER,1.5);
	CreateString(true,"InName",GetConvertStrWithReplace("Variable_ColonyBuilding_17", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 410,160,SCRIPT_ALIGN_CENTER,1.0);

	CreateString(true,"CurName",GetConvertStrWithReplace("Variable_ColonyBuilding_18", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 405,225,SCRIPT_ALIGN_CENTER,1.0);
	...
	CreateString(true,"NationHeader",GetConvertStrWithReplace("Variable_ColonyBuilding_19", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 400,276,SCRIPT_ALIGN_CENTER,1.5);
	...
	CreateString(true,"InNation",GetConvertStrWithReplace("Variable_ColonyBuilding_20", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 400,370,SCRIPT_ALIGN_CENTER,1.2);
}
...
string GetCheckSoldiersType()
{
	...
	{
		case 1: return GetConvertStrWithReplace("Variable_ColonyBuilding_21", "Interface.txt", "#space#", " "); break;
		case 2: return GetConvertStrWithReplace("Variable_ColonyBuilding_22", "Interface.txt", "#space#", " "); break;
		case 3: return GetConvertStrWithReplace("Variable_ColonyBuilding_23", "Interface.txt", "#space#", " "); break;
	}

	return GetConvertStrWithReplace("Variable_ColonyBuilding_24", "Interface.txt", "#space#", " ");
}
...
{
	CreateString(true,"TownHeader",GetConvertStrWithReplace("Variable_ColonyBuilding_25", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 175,105,SCRIPT_ALIGN_CENTER,1.5);
	CreateString(true,"BuildingHeader",GetConvertStrWithReplace("Variable_ColonyBuilding_26", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 540,105,SCRIPT_ALIGN_CENTER,1.5);
	...
	CreateString(true,"TownCost",GetConvertStrWithReplace("Variable_ColonyBuilding_27", "Interface.txt", "#space#", " ") + iTownCost, FONT_CAPTION, argb(255,255,128,128), 135,305,SCRIPT_ALIGN_LEFT,0.9);

	CreateString(true,"StoreHeader",GetConvertStrWithReplace("Variable_ColonyBuilding_28", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 435,145,SCRIPT_ALIGN_CENTER,0.9);
	...
	CreateString(true,"StoreCost",GetConvertStrWithReplace("Variable_ColonyBuilding_29", "Interface.txt", "#space#", " ") + iStoreCost, FONT_CAPTION, argb(255,255,128,128), 400,280,SCRIPT_ALIGN_LEFT,0.9);

	CreateString(true,"ShipyardHeader",GetConvertStrWithReplace("Variable_ColonyBuilding_30", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 660,145,SCRIPT_ALIGN_CENTER,0.9);
	...
	CreateString(true,"ShipyardCost",GetConvertStrWithReplace("Variable_ColonyBuilding_31", "Interface.txt", "#space#", " ") + iShipyardCost, FONT_CAPTION, argb(255,255,128,128), 625,280,SCRIPT_ALIGN_LEFT,0.9);

	CreateString(true,"TavernHeader",GetConvertStrWithReplace("Variable_ColonyBuilding_32", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 435,325,SCRIPT_ALIGN_CENTER,0.9);
	...
	CreateString(true,"TavernCost",GetConvertStrWithReplace("Variable_ColonyBuilding_33", "Interface.txt", "#space#", " ") + iTavernCost, FONT_CAPTION, argb(255,255,128,128), 400,460,SCRIPT_ALIGN_LEFT,0.9);

	CreateString(true,"BankHeader",GetConvertStrWithReplace("Variable_ColonyBuilding_34", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 660,325,SCRIPT_ALIGN_CENTER,0.9);
	...
	CreateString(true,"BankCost",GetConvertStrWithReplace("Variable_ColonyBuilding_35", "Interface.txt", "#space#", " ") + iBankCost, FONT_CAPTION, argb(255,255,128,128), 625,460,SCRIPT_ALIGN_LEFT,0.9);

	CreateString(true,"TownhallHeader",GetConvertStrWithReplace("Variable_ColonyBuilding_36", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 180,335,SCRIPT_ALIGN_CENTER,0.9);
	...
	CreateString(true,"TownhallCost",GetConvertStrWithReplace("Variable_ColonyBuilding_37", "Interface.txt", "#space#", " ") + iTownhallCost, FONT_CAPTION, argb(255,255,128,128), 140,470,SCRIPT_ALIGN_LEFT,0.9);

	int TOTAL = iTownCost + iStoreCost + iShipyardCost + iTavernCost + iBankCost + iTownhallCost + 50000;
	CreateString(true,"ArchitectorCost",GetConvertStrWithReplace("Variable_ColonyBuilding_38", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 340,510,SCRIPT_ALIGN_LEFT,1.0);
	CreateString(true,"TotalCost",GetConvertStrWithReplace("Variable_ColonyBuilding_39", "Interface.txt", "#space#", " ") + TOTAL, FONT_CAPTION, COLOR_NORMAL, 340,530,SCRIPT_ALIGN_LEFT,1.0);
	CreateString(true,"CharMoney",GetConvertStrWithReplace("Variable_ColonyBuilding_40", "Interface.txt", "#space#", " ") + sti(PChar.money), FONT_CAPTION, argb(255,255,255,128), 340,550,SCRIPT_ALIGN_LEFT,1.0);
