...
void SetInformation()
{
	CreateString(true,"ShipHeaderOne",GetConvertStrWithReplace("Variable_ColonyGuardiang_1", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 190,35,SCRIPT_ALIGN_CENTER,1.5);
	CreateString(true,"ShipHeaderTwo",GetConvertStrWithReplace("Variable_ColonyGuardiang_2", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 190,317,SCRIPT_ALIGN_CENTER,1.5);
	CreateString(true,"ShipHeaderThree",GetConvertStrWithReplace("Variable_ColonyGuardiang_3", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 595,35,SCRIPT_ALIGN_CENTER,1.5);
	CreateString(true,"ShipHeaderFour",GetConvertStrWithReplace("Variable_ColonyGuardiang_4", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 595,317,SCRIPT_ALIGN_CENTER,1.5);
...
void SetShipInformationOne()
{
	...
	if(iShipType == -1)
	{
		...
		CreateString(true,"ShipOneNot",GetConvertStrWithReplace("Variable_ColonyGuardiang_5", "Interface.txt", "#space#", " "), FONT_NORMAL, argb(255,255,128,128), 195,240,SCRIPT_ALIGN_CENTER,1.0);
	...
	else
	{
		...
		CreateString(true,"ShipHp1", GetConvertStrWithReplace("Variable_ColonyGuardiang_6", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 220,84,SCRIPT_ALIGN_LEFT,1.0);
		...
		CreateString(true,"ShipSp1", GetConvertStrWithReplace("Variable_ColonyGuardiang_7", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 220,119,SCRIPT_ALIGN_LEFT,1.0);
		...
		CreateString(true,"ShipSr1", GetConvertStrWithReplace("Variable_ColonyGuardiang_8", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 220,151,SCRIPT_ALIGN_LEFT,1.0);
		...
		CreateString(true,"ShipTr1", GetConvertStrWithReplace("Variable_ColonyGuardiang_9", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 220,183,SCRIPT_ALIGN_LEFT,1.0);
		...
		CreateString(true,"ShipCrew1", GetConvertStrWithReplace("Variable_ColonyGuardiang_10", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 220,216,SCRIPT_ALIGN_LEFT,1.0);
...
void SetShipInformationTwo()
{
	...
	if(iShipType == -1)
	{
		...
		CreateString(true,"ShipTwoNot",GetConvertStrWithReplace("Variable_ColonyGuardiang_11", "Interface.txt", "#space#", " "), FONT_NORMAL, argb(255,255,128,128), 195,523,SCRIPT_ALIGN_CENTER,1.0);
	...
	else
	{
		...
		CreateString(true,"ShipHp2", GetConvertStrWithReplace("Variable_ColonyGuardiang_12", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 220,367,SCRIPT_ALIGN_LEFT,1.0);
		...
		CreateString(true,"ShipSp2", GetConvertStrWithReplace("Variable_ColonyGuardiang_13", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 220,402,SCRIPT_ALIGN_LEFT,1.0);
		...
		CreateString(true,"ShipSr2", GetConvertStrWithReplace("Variable_ColonyGuardiang_14", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 220,434,SCRIPT_ALIGN_LEFT,1.0);
		...
		CreateString(true,"ShipTr2", GetConvertStrWithReplace("Variable_ColonyGuardiang_15", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 220,466,SCRIPT_ALIGN_LEFT,1.0);
		...
		CreateString(true,"ShipCrew2", GetConvertStrWithReplace("Variable_ColonyGuardiang_16", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 220,499,SCRIPT_ALIGN_LEFT,1.0);
...
void SetShipInformationThree()
{
	...
	if(iShipType == -1)
	{
		...
		CreateString(true,"ShipThreeNot",GetConvertStrWithReplace("Variable_ColonyGuardiang_17", "Interface.txt", "#space#", " "), FONT_NORMAL, argb(255,255,128,128), 590,240,SCRIPT_ALIGN_CENTER,1.0);
	...
	else
	{
		...
		CreateString(true,"ShipHp3", GetConvertStrWithReplace("Variable_ColonyGuardiang_18", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 615,84,SCRIPT_ALIGN_LEFT,1.0);
		...
		CreateString(true,"ShipSp3", GetConvertStrWithReplace("Variable_ColonyGuardiang_19", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 615,119,SCRIPT_ALIGN_LEFT,1.0);
		...
		CreateString(true,"ShipSr3", GetConvertStrWithReplace("Variable_ColonyGuardiang_20", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 615,151,SCRIPT_ALIGN_LEFT,1.0);
		...
		CreateString(true,"ShipTr3", GetConvertStrWithReplace("Variable_ColonyGuardiang_21", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 615,183,SCRIPT_ALIGN_LEFT,1.0);
		...
		CreateString(true,"ShipCrew3", GetConvertStrWithReplace("Variable_ColonyGuardiang_22", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 615,216,SCRIPT_ALIGN_LEFT,1.0);
...
void SetShipInformationFour()
{
	...
	if(iShipType == -1)
	{
		...
		CreateString(true,"ShipFourNot",GetConvertStrWithReplace("Variable_ColonyGuardiang_23", "Interface.txt", "#space#", " "), FONT_NORMAL, argb(255,255,128,128), 590,523,SCRIPT_ALIGN_CENTER,1.0);
	...
	else
	{
		...
		CreateString(true,"ShipHp4", GetConvertStrWithReplace("Variable_ColonyGuardiang_24", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 615,367,SCRIPT_ALIGN_LEFT,1.0);
		...
		CreateString(true,"ShipSp4", GetConvertStrWithReplace("Variable_ColonyGuardiang_25", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 615,402,SCRIPT_ALIGN_LEFT,1.0);
		...
		CreateString(true,"ShipSr4", GetConvertStrWithReplace("Variable_ColonyGuardiang_26", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 615,434,SCRIPT_ALIGN_LEFT,1.0);
		...
		CreateString(true,"ShipTr4", GetConvertStrWithReplace("Variable_ColonyGuardiang_27", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 615,466,SCRIPT_ALIGN_LEFT,1.0);
		...
		CreateString(true,"ShipCrew4", GetConvertStrWithReplace("Variable_ColonyGuardiang_28", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 615,499,SCRIPT_ALIGN_LEFT,1.0);
...
void SetInstallFrame(bool bInstall, bool bContinue)
{
	...
	if(bContinue)
	{
		...
		CreateString(true,"ShipInstallFrameHeader",GetConvertStrWithReplace("Variable_ColonyGuardiang_29", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 395,78,SCRIPT_ALIGN_CENTER,1.5);
...
void SetInstallInformation(bool bBool)
{
	...
	int iCannon = sti(chr.Ship.Cannons.Type);
	string sCannon = XI_ConvertString(GetCannonType(iCannon) + "s");
	string sCaliber = GetCannonShip(iCannonsType) + " " + GetCannonCaliber(iCannon)+GetConvertStrWithReplace("Variable_ColonyGuardiang_30", "Interface.txt", "#space#", " ");//GetCannonTypeCaliber(iCannonsType);
	if (iCannonsReal == 0) sCaliber = GetConvertStrWithReplace("Variable_ColonyGuardiang_31", "Interface.txt", "#space#", " ");
	...
	CreateString(true,"ShipHpInstall", GetConvertStrWithReplace("Variable_ColonyGuardiang_32", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 390,264,SCRIPT_ALIGN_LEFT,1.0);
	...
	CreateString(true,"ShipSpInstall", GetConvertStrWithReplace("Variable_ColonyGuardiang_33", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 390,300,SCRIPT_ALIGN_LEFT,1.0);
	...
	CreateString(true,"ShipSrInstall", GetConvertStrWithReplace("Variable_ColonyGuardiang_34", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 390,335,SCRIPT_ALIGN_LEFT,1.0);
	...
	CreateString(true,"ShipTrInstall", GetConvertStrWithReplace("Variable_ColonyGuardiang_35", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 390,368,SCRIPT_ALIGN_LEFT,1.0);
	...
	CreateString(true,"ShipCrewInstall", GetConvertStrWithReplace("Variable_ColonyGuardiang_36", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 390,403,SCRIPT_ALIGN_LEFT,1.0);
	...
	CreateString(true,"ShipCannonsInstall", GetConvertStrWithReplace("Variable_ColonyGuardiang_37", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 390,438,SCRIPT_ALIGN_LEFT,1.0);
...
string GetCannonShip(int iCannonsType)
{
	...
	switch(iCannonsType)
	{
		case CANNON_TYPE_CANNON_LBS8: sCannon = GetConvertStrWithReplace("Variable_ColonyGuardiang_38", "Interface.txt", "#space#", " "); break;
		case CANNON_TYPE_CANNON_LBS10: sCannon = GetConvertStrWithReplace("Variable_ColonyGuardiang_39", "Interface.txt", "#space#", " "); break;
		case CANNON_TYPE_CANNON_LBS12: sCannon = GetConvertStrWithReplace("Variable_ColonyGuardiang_40", "Interface.txt", "#space#", " "); break;
		case CANNON_TYPE_CANNON_LBS16: sCannon = GetConvertStrWithReplace("Variable_ColonyGuardiang_41", "Interface.txt", "#space#", " "); break;
		case CANNON_TYPE_CANNON_LBS20: sCannon = GetConvertStrWithReplace("Variable_ColonyGuardiang_42", "Interface.txt", "#space#", " "); break;
		case CANNON_TYPE_CANNON_LBS24: sCannon = GetConvertStrWithReplace("Variable_ColonyGuardiang_43", "Interface.txt", "#space#", " "); break;
		case CANNON_TYPE_CANNON_LBS28: sCannon = GetConvertStrWithReplace("Variable_ColonyGuardiang_44", "Interface.txt", "#space#", " "); break;
		case CANNON_TYPE_CANNON_LBS32: sCannon = GetConvertStrWithReplace("Variable_ColonyGuardiang_45", "Interface.txt", "#space#", " "); break;
		case CANNON_TYPE_CANNON_LBS36: sCannon = GetConvertStrWithReplace("Variable_ColonyGuardiang_46", "Interface.txt", "#space#", " "); break;
		case CANNON_TYPE_CANNON_LBS42: sCannon = GetConvertStrWithReplace("Variable_ColonyGuardiang_47", "Interface.txt", "#space#", " "); break;
		case CANNON_TYPE_CANNON_LBS48: sCannon = GetConvertStrWithReplace("Variable_ColonyGuardiang_48", "Interface.txt", "#space#", " "); break;
		case CANNON_TYPE_CULVERINE_LBS8: sCannon = GetConvertStrWithReplace("Variable_ColonyGuardiang_49", "Interface.txt", "#space#", " "); break;
		case CANNON_TYPE_CULVERINE_LBS10: sCannon = GetConvertStrWithReplace("Variable_ColonyGuardiang_50", "Interface.txt", "#space#", " "); break;
		case CANNON_TYPE_CULVERINE_LBS12: sCannon = GetConvertStrWithReplace("Variable_ColonyGuardiang_51", "Interface.txt", "#space#", " "); break;
		case CANNON_TYPE_CULVERINE_LBS16: sCannon = GetConvertStrWithReplace("Variable_ColonyGuardiang_52", "Interface.txt", "#space#", " "); break;
		case CANNON_TYPE_CULVERINE_LBS20: sCannon = GetConvertStrWithReplace("Variable_ColonyGuardiang_53", "Interface.txt", "#space#", " "); break;
		case CANNON_TYPE_CULVERINE_LBS24: sCannon = GetConvertStrWithReplace("Variable_ColonyGuardiang_54", "Interface.txt", "#space#", " "); break;
		case CANNON_TYPE_CULVERINE_LBS28: sCannon = GetConvertStrWithReplace("Variable_ColonyGuardiang_55", "Interface.txt", "#space#", " "); break;
		case CANNON_TYPE_CULVERINE_LBS32: sCannon = GetConvertStrWithReplace("Variable_ColonyGuardiang_56", "Interface.txt", "#space#", " "); break;
		case CANNON_TYPE_CULVERINE_LBS36: sCannon = GetConvertStrWithReplace("Variable_ColonyGuardiang_57", "Interface.txt", "#space#", " "); break;
		case CANNON_TYPE_NONECANNON: sCannon = GetConvertStrWithReplace("Variable_ColonyGuardiang_58", "Interface.txt", "#space#", " "); break;
	}
	return sCannon;
}
...
void SetChangeFrame(bool bInstall, bool bContinue)
{
	...
	if(bContinue)
	{
		...
		CreateString(true,"ShipChangeFrameHeader",GetConvertStrWithReplace("Variable_ColonyGuardiang_59", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 395,129,SCRIPT_ALIGN_CENTER,1.5);
