...
void FillSkillTables()
{
    ...
    {
        GameInterface.TABLE_OTHER.tr8.td3.str = GetConvertStrWithReplace("Variable_character_20", "Interface.txt", "#space#", " ");
		GameInterface.TABLE_OTHER.tr8.td3.align = "right";
    }
...
string ShowStatValue(string type)
{
	switch (type)
	{
		...
		case "gundamage":
			...
			return makeint((min + (max - min)*(LAi_GetCharacterGunLevel(xi_refCharacter)*0.5))) + GetConvertStrWithReplace("Variable_character_21", "Interface.txt", "#space#", " ");
		break;
		case "breakchance":
			return CheckForSpecial(type);
		break;
		...
		case "recharge":
			...
			return rechargetime+"%/"+retime+GetConvertStrWithReplace("Variable_character_22", "Interface.txt", "#space#", " ");
		break;
...
void SetControlsTabMode()
{
	...
	switch (nMode)
	{
		case 1: //
			...
			SetFormatedText("STR_4", GetConvertStrWithReplace("Variable_character_31", "Interface.txt", "#space#", " "));
		...
		case 2:
			...
			SetNodeUsing("SUBSTRATE7",false);
			SetNodeUsing("SCROLL_PERKS",true);
			SetFormatedText("STR_4", GetConvertStrWithReplace("Variable_character_32", "Interface.txt", "#space#", " "));
			SetFormatedText("STR_5", "");
			SetFormatedText("STR_51", "");
			sPic2 = "TabDeSelected";
		...
		case 3:
			...
			SetFormatedText("STR_4", GetConvertStrWithReplace("Variable_character_33", "Interface.txt", "#space#", " "));
			SetFormatedText("STR_5", GetConvertStrWithReplace("Variable_character_34", "Interface.txt", "#space#", " "));
			SetFormatedText("STR_51", GetConvertStrWithReplace("Variable_character_35", "Interface.txt", "#space#", " "));
			sPic3 = "TabDeSelected";
...
void UpdateStatsValues()
{
	...
	GameInterface.TABLE_CHAR_OTHERS.tr1.td2.str = GetConvertStrWithReplace("Variable_character_36", "Interface.txt", "#space#", " ");
	GameInterface.TABLE_CHAR_OTHERS.tr1.td2.scale = 0.8;
	GameInterface.TABLE_CHAR_OTHERS.tr1.td2.align = "left";
	GameInterface.TABLE_CHAR_OTHERS.tr1.td3.str = ShowStatValue("regenhp")+GetConvertStrWithReplace("Variable_character_37", "Interface.txt", "#space#", " ");
	...
	GameInterface.TABLE_CHAR_OTHERS.tr2.td2.str = GetConvertStrWithReplace("Variable_character_38", "Interface.txt", "#space#", " ");
	GameInterface.TABLE_CHAR_OTHERS.tr2.td2.scale = 0.8;
	GameInterface.TABLE_CHAR_OTHERS.tr2.td2.align = "left";
	GameInterface.TABLE_CHAR_OTHERS.tr2.td3.str = ShowStatValue("energychar")+GetConvertStrWithReplace("Variable_character_39", "Interface.txt", "#space#", " ");
	...
	GameInterface.TABLE_CHAR_OTHERS.tr3.td2.str = GetConvertStrWithReplace("Variable_character_40", "Interface.txt", "#space#", " ");
	GameInterface.TABLE_CHAR_OTHERS.tr3.td2.scale = 0.8;
	GameInterface.TABLE_CHAR_OTHERS.tr3.td2.align = "left";
	GameInterface.TABLE_CHAR_OTHERS.tr3.td3.str = ShowStatValue("poison")+GetConvertStrWithReplace("Variable_character_41", "Interface.txt", "#space#", " ");
	...
	GameInterface.TABLE_CHAR_OTHERS.tr4.td2.str = GetConvertStrWithReplace("Variable_character_42", "Interface.txt", "#space#", " ");
	...
	GameInterface.TABLE_CHAR_OTHERS.tr5.td2.str = GetConvertStrWithReplace("Variable_character_43", "Interface.txt", "#space#", " ");
	...
	GameInterface.TABLE_CHAR_OTHERS.tr6.td2.str = GetConvertStrWithReplace("Variable_character_44", "Interface.txt", "#space#", " ");
	...
	GameInterface.TABLE_BLADES_OTHERS.tr1.td2.str = GetConvertStrWithReplace("Variable_character_45", "Interface.txt", "#space#", " ");
	...
	GameInterface.TABLE_BLADES_OTHERS.tr2.td2.str = GetConvertStrWithReplace("Variable_character_46", "Interface.txt", "#space#", " ");
	...
	GameInterface.TABLE_BLADES_OTHERS.tr5.td2.str = GetConvertStrWithReplace("Variable_character_47", "Interface.txt", "#space#", " ");
	...
	GameInterface.TABLE_BLADES_OTHERS.tr6.td2.str = GetConvertStrWithReplace("Variable_character_48", "Interface.txt", "#space#", " ");
	...
	GameInterface.TABLE_BLADES_OTHERS.tr7.td2.str = GetConvertStrWithReplace("Variable_character_49", "Interface.txt", "#space#", " ");
	...
	GameInterface.TABLE_SHIP_OTHERS.tr1.td2.str = GetConvertStrWithReplace("Variable_character_50", "Interface.txt", "#space#", " ");
	...
	if (CheckAttribute(xi_refCharacter,"Ship.Cannons"))
	{
		...
		if (sti(rCannon.type) == CANNON_NAME_CULVERINE) cannontype = GetConvertStrWithReplace("Variable_character_51", "Interface.txt", "#space#", " ")+rCannon.caliber+GetConvertStrWithReplace("Variable_character_52", "Interface.txt", "#space#", " ")+")";
		if (sti(rCannon.type) == CANNON_NAME_CANNON) cannontype = GetConvertStrWithReplace("Variable_character_53", "Interface.txt", "#space#", " ")+rCannon.caliber+GetConvertStrWithReplace("Variable_character_54", "Interface.txt", "#space#", " ")+")";
	}
	for (int n = 1; n<=5; n++)
	{
	sRow = "tr" + (n + 1);
	...
	if (n == 1) GameInterface.TABLE_SHIP_OTHERS.(sRow).td2.str = GetConvertStrWithReplace("Variable_character_55", "Interface.txt", "#space#", " ");
	...
	if(CheckAttribute(xi_refCharacter, "Ship.type") && sti(xi_refCharacter.ship.type) != SHIP_NOTUSED)
	{
		switch(n)
		{
			...
			case 2: GameInterface.TABLE_SHIP_OTHERS.(sRow).td3.str = GetShootDistance(xi_refCharacter,"ball")+GetConvertStrWithReplace("Variable_character_56", "Interface.txt", "#space#", " "); break;
			case 3: GameInterface.TABLE_SHIP_OTHERS.(sRow).td3.str = GetShootDistance(xi_refCharacter,"grape")+GetConvertStrWithReplace("Variable_character_57", "Interface.txt", "#space#", " "); break;
			case 4: GameInterface.TABLE_SHIP_OTHERS.(sRow).td3.str = GetShootDistance(xi_refCharacter,"knippel")+GetConvertStrWithReplace("Variable_character_58", "Interface.txt", "#space#", " "); break;
			case 5: GameInterface.TABLE_SHIP_OTHERS.(sRow).td3.str = GetShootDistance(xi_refCharacter,"bomb")+GetConvertStrWithReplace("Variable_character_59", "Interface.txt", "#space#", " "); break;
		}
	}
	else GameInterface.TABLE_SHIP_OTHERS.(sRow).td3.str = GetConvertStrWithReplace("Variable_character_60", "Interface.txt", "#space#", " ");
	...
	GameInterface.TABLE_SHIP_OTHERS.(sRow).td2.str = GetConvertStrWithReplace("Variable_character_61", "Interface.txt", "#space#", " ");
	GameInterface.TABLE_SHIP_OTHERS.(sRow).td1.icon.group = "ICONS_STATS_CHAR";
	...
	if (n==1) {GameInterface.TABLE_SHIP_OTHERS.(sRow).td2.textoffset = "0,0"; GameInterface.TABLE_SHIP_OTHERS.(sRow).td2.str = GetConvertStrWithReplace("Variable_character_62", "Interface.txt", "#space#", " ");}
	GameInterface.TABLE_SHIP_OTHERS.(sRow).td2.scale = 0.8;
	GameInterface.TABLE_SHIP_OTHERS.(sRow).td2.align = "left";
...
void ShowMsgMenu()
{
	SetFormatedText("MSG_WINDOW_CAPTION", GetConvertStrWithReplace("Variable_character_64", "Interface.txt", "#space#", " "));
	SetFormatedText("MSG_WINDOW_TEXT", GetConvertStr("Variable_character_64.1", "Interface.txt"));
...
{
	string rangeStr9 = GetConvertStrWithReplace("Variable_character_9", "Interface.txt", "#space#", " ");
	string rangeStr10 = GetConvertStrWithReplace("Variable_character_10", "Interface.txt", "#space#", " ");
	string rangeStr11 = GetConvertStrWithReplace("Variable_character_11", "Interface.txt", "#space#", " ");
	string rangeStr12 = GetConvertStrWithReplace("Variable_character_12", "Interface.txt", "#space#", " ");
...
{
	string speedStr1 = GetConvertStrWithReplace("Variable_character_1", "Interface.txt", "#space#", " ");
	string speedStr2 = GetConvertStrWithReplace("Variable_character_2", "Interface.txt", "#space#", " ");
	string speedStr3 = GetConvertStrWithReplace("Variable_character_3", "Interface.txt", "#space#", " ");
	string speedStr4 = GetConvertStrWithReplace("Variable_character_4", "Interface.txt", "#space#", " ");
	string speedStr5 = GetConvertStrWithReplace("Variable_character_5", "Interface.txt", "#space#", " ");
	string speedStr6 = GetConvertStrWithReplace("Variable_character_6", "Interface.txt", "#space#", " ");
	string speedStr7 = GetConvertStrWithReplace("Variable_character_7", "Interface.txt", "#space#", " ");
	string speedStr8 = GetConvertStrWithReplace("Variable_character_8", "Interface.txt", "#space#", " ");
