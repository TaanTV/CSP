...
void AskForRansom()
{
	...
	if(isRansom == true)
	{
		...
		sText = sText + CalculateSumm(rSpeakCharacter)*10 + GetConvertStrWithReplace("Variable_Speak_1", "Interface.txt", "#space#", " ");
...
void AskForTax()
{
	...
	sText = sText + iTax + GetConvertStrWithReplace("Variable_Speak_2", "Interface.txt", "#space#", " ");
