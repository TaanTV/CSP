...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    totalInfo = XI_ConvertString(GetNationNameByType(Nation1)) + GetConvertStrWithReplace("Variable_NationLegend_1", "Interface.txt", "#space#", " ") + XI_ConvertString(GetNationNameByType(Nation2));
    if(RelatNat == RELATION_FRIEND)
    {
        totalInfo = totalInfo + GetConvertStrWithReplace("Variable_NationLegend_2", "Interface.txt", "#space#", " ");
    }
    if(RelatNat == RELATION_ENEMY)
    {
        totalInfo = totalInfo + GetConvertStrWithReplace("Variable_NationLegend_3", "Interface.txt", "#space#", " ");
    }
    if(RelatNat == RELATION_NEUTRAL)
    {
        totalInfo = totalInfo + GetConvertStrWithReplace("Variable_NationLegend_4", "Interface.txt", "#space#", " ");
    }
