...
void MinesInfo()
{
	...
	if(PChar.Mines.GoldMine == false || PChar.ColonyBuilding.GoldMine.BuildingTime == true)
	{
		...
		CreateString(true,"GoldMineNot", GetConvertStrWithReplace("Variable_Mines_1", "Interface.txt", "#space#", " "), FONT_NORMAL, argb(255,255,128,128), 140,227,SCRIPT_ALIGN_CENTER,1.4);
	...
	if(PChar.Mines.SilverMine == false || PChar.ColonyBuilding.SilverMine.BuildingTime == true)
	{
		...
		CreateString(true,"SilverMineNot", GetConvertStrWithReplace("Variable_Mines_2", "Interface.txt", "#space#", " "), FONT_NORMAL, argb(255,255,128,128), 400,230,SCRIPT_ALIGN_CENTER,1.0);
	...
	{
		CreateImage("Silver", "GOODS", "Silver", 285,58,355,128);
		//CreateString(true,"SilverHeader", GetConvertStrWithReplace("Variable_Mines_3", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 400,145,SCRIPT_ALIGN_CENTER,1.0);
	...
	if(PChar.Mines.IronMine == false || PChar.ColonyBuilding.IronMine.BuildingTime == true)
	{
		...
		CreateString(true,"IronMineNot", GetConvertStrWithReplace("Variable_Mines_4", "Interface.txt", "#space#", " "), FONT_NORMAL, argb(255,255,128,128), 660,230,SCRIPT_ALIGN_CENTER,1.0);
	...
	CreateString(true,"GuardiansHeader", GetConvertStrWithReplace("Variable_Mines_5", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 200,281,SCRIPT_ALIGN_CENTER,1.5);
	CreateString(true,"SlavesHeader", GetConvertStrWithReplace("Variable_Mines_6", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 200,442,SCRIPT_ALIGN_CENTER,1.5);
	CreateString(true,"FoodHeader", GetConvertStrWithReplace("Variable_Mines_7", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 590,281,SCRIPT_ALIGN_CENTER,1.5);
	CreateString(true,"MedicamentHeader", GetConvertStrWithReplace("Variable_Mines_8", "Interface.txt", "#space#", " "), FONT_CAPTION, COLOR_NORMAL, 590,442,SCRIPT_ALIGN_CENTER,1.5);


	if(PChar.Mines.GoldMine == true || PChar.Mines.SilverMine == true || PChar.Mines.IronMine == true)
	{
		CreateString(true,"GuardiansQuantity", GetConvertStrWithReplace("Variable_Mines_9", "Interface.txt", "#space#", " "), FONT_NORMAL, COLOR_NORMAL, 30,320,SCRIPT_ALIGN_LEFT,1.0);
		CreateString(true,"GuardiansQuantityContinue", "" + iGuardiansQuantity, FONT_NORMAL, COLOR_NORMAL, 320,320,SCRIPT_ALIGN_LEFT,1.0);

		CreateString(true,"MaxGuardiansQuantity", GetConvertStrWithReplace("Variable_Mines_10", "Interface.txt", "#space#", " "), FONT_NORMAL, COLOR_NORMAL, 30,337,SCRIPT_ALIGN_LEFT,1.0);
		...
		CreateString(true,"HireGuardiansQuantity", GetConvertStrWithReplace("Variable_Mines_11", "Interface.txt", "#space#", " "), FONT_NORMAL, COLOR_NORMAL, 30,353,SCRIPT_ALIGN_LEFT,1.0);
		...
		CreateString(true,"SlavesQuantity", GetConvertStrWithReplace("Variable_Mines_12", "Interface.txt", "#space#", " "), FONT_NORMAL, COLOR_NORMAL, 30,475,SCRIPT_ALIGN_LEFT,1.0);
		CreateString(true,"SlavesQuantityContinue", "" + iSlavesQuantity, FONT_NORMAL, COLOR_NORMAL, 320,475,SCRIPT_ALIGN_LEFT,1.0);

		CreateString(true,"MaxSlavesQuantity", GetConvertStrWithReplace("Variable_Mines_13", "Interface.txt", "#space#", " "), FONT_NORMAL, COLOR_NORMAL, 30,493,SCRIPT_ALIGN_LEFT,1.0);
		CreateString(true,"MaxSlavesQuantityContinue", "" + iMaxSlavesQuantity, FONT_NORMAL, COLOR_NORMAL, 320,493,SCRIPT_ALIGN_LEFT,1.0);

		CreateString(true,"SlavesInHold", GetConvertStrWithReplace("Variable_Mines_14", "Interface.txt", "#space#", " "), FONT_NORMAL, COLOR_NORMAL, 30,509,SCRIPT_ALIGN_LEFT,1.0);
		...
		string sFoodDays = GetConvertStrWithReplace("Variable_Mines_15", "Interface.txt", "#space#", " ") + iFoodDays + GetConvertStrWithReplace("Variable_Mines_16", "Interface.txt", "#space#", " ");
		...
		CreateString(true,"FoodInHold", GetConvertStrWithReplace("Variable_Mines_17", "Interface.txt", "#space#", " "), FONT_NORMAL, COLOR_NORMAL, 420,336,SCRIPT_ALIGN_LEFT,1.0);
		...
		string sMedicamentDays = GetConvertStrWithReplace("Variable_Mines_18", "Interface.txt", "#space#", " ") + iMedicamentDays + GetConvertStrWithReplace("Variable_Mines_19", "Interface.txt", "#space#", " ");
		...
		CreateString(true,"MedicamentInHold", GetConvertStrWithReplace("Variable_Mines_20", "Interface.txt", "#space#", " "), FONT_NORMAL, COLOR_NORMAL, 420,493,SCRIPT_ALIGN_LEFT,1.0);
	...
	else
	{
		...
		CreateString(true,"AllMinesNot1", GetConvertStrWithReplace("Variable_Mines_21", "Interface.txt", "#space#", " "), FONT_NORMAL, argb(255,255,128,128), 210,380,SCRIPT_ALIGN_CENTER,1.0);
		CreateString(true,"AllMinesNot2", GetConvertStrWithReplace("Variable_Mines_22", "Interface.txt", "#space#", " "), FONT_NORMAL, argb(255,255,128,128), 600,380,SCRIPT_ALIGN_CENTER,1.0);
		CreateString(true,"AllMinesNot3", GetConvertStrWithReplace("Variable_Mines_23", "Interface.txt", "#space#", " "), FONT_NORMAL, argb(255,255,128,128), 600,525,SCRIPT_ALIGN_CENTER,1.0);
		CreateString(true,"AllMinesNot4", GetConvertStrWithReplace("Variable_Mines_24", "Interface.txt", "#space#", " "), FONT_NORMAL, argb(255,255,128,128), 210,525,SCRIPT_ALIGN_CENTER,1.0);
	}
