...
int LocationInitSantaCatalina(int n)
{
	...
	locations[n].image = "loading\jonny_load\city\Town_SantaCatalina.dds";
	...
	locations[n].image = "loading\jonny_load\jungle\TownExitT.dds";
	//Town sack
	Locations[n].townsack = "SantaCatalina";
	//Sound
	...
	locations[n].image = "loading\jonny_load\shores\grottoBig1.dds";
