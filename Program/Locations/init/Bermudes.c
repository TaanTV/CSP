...
int LocationInitBermudes(int n)
{
	...
	locations[n].image = "loading\jonny_load\city\Town_IslaMona.dds";
	...
	locations[n].image = "loading\jonny_load\inside\store05.dds";
	//Town sack
	locations[n].townsack = "Pirates";
	locations[n].lockWeather = "Inside";
	//Sound
	...
	locations[n].image = "loading\jonny_load\inside\shipyardpirates.dds";
	//Town sack
	locations[n].townsack = "Pirates";
	//locations[n].lockWeather = "Inside";
	//Sound
	...
	locations[n].image = "loading\jonny_load\inside\residence05_(JackmanHouse).dds";
	//Town sack
	locations[n].townsack = "Pirates";
	locations[n].lockWeather = "Inside";
	//Sound
	...
	locations[n].image = "loading\jonny_load\inside\cavernLow1.dds";
	//Sound
