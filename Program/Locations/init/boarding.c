...
int LocationInitBoarding(int n)
{
	...
	Locations[n].image = "loading\jonny_load\outside\FortV.dds";
	LAi_LocationFantomsGen(&locations[n], false);
	// тереть .reload
	Locations[n].boarding.locatorNum = 35;
	...
	Locations[n].image = "loading\jonny_load\inside\Fort_1.dds";
	LAi_LocationFantomsGen(&locations[n], false);
	Locations[n].boarding.locatorNum = 29;
	Locations[n].boarding = "false";
	...
	Locations[n].image = "loading\jonny_load\outside\Fort_2_(shturm).dds";
	LAi_LocationFantomsGen(&locations[n], false);
	Locations[n].boarding.locatorNum = 27;
	Locations[n].boarding = "false";
	...
	Locations[n].image = "loading\jonny_load\inside\Fort_3.dds";
	LAi_LocationFantomsGen(&locations[n], false);
	...
	Locations[n].image = "loading\jonny_load\inside\prison1.dds";
	locations[n].townsack = "SentJons";
	locations[n].fastreload = "SentJons";
    locations[n].parent_colony = "SentJons";
 	locations[n].islandId = "Antigua";
	...
	//Info
	Locations[n].image = "loading\jonny_load\outside\FortVRight.dds";
    ...
    Locations[n].image = "loading\jonny_load\inside\cabin01.dds";
	//Sound
    ...
    Locations[n].image = "loading\jonny_load\inside\cabinFDM.dds";
	//Sound
	locations[n].type = "boarding_cabine";
	//Models
	//Always
    ...
    Locations[n].image = "loading\jonny_load\inside\cabin02.dds";
	//Sound
	locations[n].type = "boarding_cabine";
	//Models
	//Always
    ...
    Locations[n].image = "loading\jonny_load\inside ship\capsm.dds";
	//Sound
	locations[n].type = "boarding_cabine";
	//Models
	//Always
	...
	Locations[n].id.label = "cabine";
	Locations[n].filespath.models = "locations\decks\capsm2";
    Locations[n].image = "loading\jonny_load\inside ship\capsm2.dds";
	//Sound
	locations[n].type = "boarding_cabine";
	//Models
	//Always
	Locations[n].models.always.locators = "capsm2_l";
	Locations[n].models.always.l1 = "capsm2";
	locations[n].models.always.l1.level = 65538;
	
	/*Locations[n].models.day.l2 = "capsm2_rays";
	Locations[n].models.day.l2.uvslide.v0 = -0.05;
	...
	//Day
	Locations[n].models.day.charactersPatch = "capsm2_p";
	Locations[n].models.day.fonar = "capsm2_fd";

	//Night
	Locations[n].models.night.charactersPatch = "capsm2_p";
	Locations[n].models.night.fonar = "capsm2_fn";
    ...
    Locations[n].image = "loading\jonny_load\inside ship\capmd.dds";
	//Sound
	locations[n].type = "boarding_cabine";
	//Models
	//Always
	...
	Locations[n].id = "Cabin_Medium1";
	Locations[n].id.label = "cabine";
	Locations[n].filespath.models = "locations\decks\capmd1";
    Locations[n].image = "loading\jonny_load\inside ship\capmd1.dds";
	//Sound
	locations[n].type = "boarding_cabine";
	//Models
	//Always
	//Locations[n].models.always.locators = "capmd_l";
	Locations[n].models.always.l1 = "capmd1";
	locations[n].models.always.l1.level = 65538;

	Locations[n].models.always.window = "capmd1_bdw";
	Locations[n].models.always.window.tech = "LocationWindows";
	locations[n].models.always.window.level = 65539;

	//Day
	Locations[n].models.day.l2 = "capmd1_bd"; //пушки с кормы, старые портреты и сундуки
	Locations[n].models.day.l2.level = 65538;
	Locations[n].models.day.locators = "capmd1_lbd"; //боевые локаторы, смещаем loc0 к центру
	Locations[n].models.day.charactersPatch = "capmd1_pbd"; //дерево, без стола и ковра
	Locations[n].models.day.fonar = "capmd1_fd"; //фонарь общий, днём дополнительное освещение не работает

	//Night
	Locations[n].models.night.l3 = "capmd1_bn"; //пушки по бортам, старые портреты и сундуки
    Locations[n].models.night.l3.level = 65538;
    Locations[n].models.night.locators = "capmd1_lbn";  //боевые локаторы, смещаем loc0 к торцу стола
    Locations[n].models.night.charactersPatch = "capmd1_pbn"; //дерево, без ковра
    Locations[n].models.night.fonar = "capmd1_fn"; //фонарь общий, добавляет локаторы каретной и настольной свечей
    ...
    Locations[n].image = "loading\jonny_load\inside ship\capmd_2.dds";
	//Sound
	locations[n].type = "boarding_cabine";
	//Models
	//Always
    ...
    Locations[n].image = "loading\jonny_load\inside ship\capquest.dds";
	//Sound
	locations[n].type = "boarding_cabine";
	//Models
	//Always
	...
	//Locations[n].models.always.window = "capsm2_w";
	//Locations[n].models.always.window.tech = "LocationWindows";
	//Locations[n].models.always.window.level = 65531;
	...
	Locations[n].id = "My_Cabin_Medium1";
	Locations[n].id.label = "cabine";
	Locations[n].filespath.models = "locations\decks\capmd1";
    Locations[n].image = "loading\jonny_load\inside ship\capmd1.dds";
	//Sound
	...
	Locations[n].models.always.window = "capmd1_w";
	Locations[n].models.always.window.tech = "LocationWindows";
	locations[n].models.always.window.level = 65539;

	//Day
	Locations[n].models.day.l2 = "capmd1_md"; //пушки по бортам, карты на столе
    Locations[n].models.day.l2.level = 65538;
    Locations[n].models.day.locators = "capmd1_lmd"; //протагонист в центре каюты, клевреты стоят вокруг, ближе к стенам
    Locations[n].models.day.charactersPatch = "capmd1_pmd"; //дерево + ковёр - стул
    Locations[n].models.day.fonar = "capmd1_fd";

	//Night
	Locations[n].models.night.l3 = "capmd1_mn"; //пушки по бортам, новые портреты
    Locations[n].models.night.l3.level = 65538;
    Locations[n].models.night.locators = "capmd1_lmn"; //протагонист так же в центре каюты, клевреты располагаются вокруг
    Locations[n].models.night.charactersPatch = "capmd1_pmn"; //дерево + ковёр
    Locations[n].models.night.fonar = "capmd1_fn";
    ...
    Locations[n].image = "loading\jonny_load\inside ship\camp_deck.dds";
	//Sound
	locations[n].type = "cap_cabine";
	//Models
	//Always
	...
	Locations[n].image = "loading\jonny_load\inside ship\Deck2.dds";
	//Sound
	Locations[n].type = "cap_cabine";
	...
	Locations[n].image = "loading\jonny_load\inside ship\Hold.dds";
	//Sound
	Locations[n].type = "cap_cabine";
	...
	//Info
	Locations[n].image = "loading\jonny_load\inside ship\deckMedium.dds";
	//Sound
	Locations[n].type = "cap_cabine";
	Locations[n].boarding = "true";
	...
	Locations[n].id.label = "Boarding deck";
	//Info
	Locations[n].image = "loading\jonny_load\inside ship\deckBig.dds";
	//Sound
	Locations[n].type = "cap_cabine";
	Locations[n].boarding = "true";
	Locations[n].lockCamAngle = 0.4;
	...
	Locations[n].id.label = "Boarding deck";
	//Info
	Locations[n].image = "loading\jonny_load\inside ship\deckLow.dds";
	//Sound
	Locations[n].type = "cap_cabine";
	Locations[n].boarding = "true";
	Locations[n].lockCamAngle = 0.4;
	...
	Locations[n].id.label = "Boarding deck";
	//Info
	Locations[n].image = "loading\jonny_load\inside ship\deckFrigate.dds";
	//Sound
	Locations[n].type = "cap_cabine";
	Locations[n].boarding = "true";
	//Locations[n].lockCamAngle = 0.4;
	...
	Locations[n].id.label = "Boarding deck";
	//Info
	Locations[n].image = "loading\jonny_load\inside ship\deckLineship.dds";
	//Sound
	Locations[n].type = "cap_cabine";
	Locations[n].boarding = "true";
	//Locations[n].lockCamAngle = 0.4;
	...
	Locations[n].image = "loading\jonny_load\abordage\abord_" + rand(2) + ".dds";
	...
	Locations[n].models.always.l1 = "deckLowVSMedium_Part1";
	...
	Locations[n].models.always.l1 = "deckLowVSBig_Part1";
	...
	Locations[n].models.always.l1 = "deckMediumVSBig_Part1";
	...
	Locations[n].models.always.l1 = "deckCorvetteVSFrigate_Part1";
	...
	Locations[n].image = "loading\jonny_load\inside ship\Holdb.dds";
	//Sound
	Locations[n].type = "deck_fight";
    ...
    Locations[n].image = "loading\jonny_load\inside ship\oldeck.dds";
	//Sound
	locations[n].type = "deck_fight";
	//Models
	//Always
	...
	Locations[n].image = "loading\jonny_load\inside ship\Gdeck.dds";
	//Sound
	Locations[n].type = "deck_fight";
	Locations[n].CheckBoardMode = true;
	//Models
	...
	Locations[n].models.always.l1 = "GDeck_Part1";
	Locations[n].models.always.locators = "Gdeck_locators_lugger";
	//Day
