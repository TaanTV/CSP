...
int LocationInitTenotchitlan(int n)
{
	...
	Locations[n].image = "loading\jonny_load\outside\pyramid1.dds";
	//Sound
	...
	Locations[n].image = "loading\jonny_load\inside\Pyramid1Inside.dds";
	//Sound
	...
	locations[n].image = "loading\jonny_load\quest\Tenochtitlan.dds";
	//Sound
	locations[n].type = "teno";
	locations[n].islandId = "Mein";
	locations[n].islandIdAreal = "Tenotchitlan";
	...
	locations[n].image = "loading\jonny_load\quest\TemplePointInside.dds";
	//Sound
	locations[n].type = "teno_inside";
	...
	locations[n].image = "loading\jonny_load\quest\TempleGreatInside.dds";
	//Sound
	locations[n].type = "teno_inside";
	locations[n].changeAnimation = MainChAnim; //сменить анимацию на обычную
	...
	locations[n].image = "loading\jonny_load\quest\TempleRoundInside.dds";
	//Sound
	locations[n].type = "teno_inside";
	//Models
	//Always
	...
	Locations[n].image = "loading\jonny_load\quest\TempleSecondInside.dds";
	//Sound
	locations[n].type = "teno_inside";
	//Models
	//Always
	...
	Locations[n].image = "loading\jonny_load\quest\TempleUnderwater.dds";
	//Sound
