...
int LocationInitBeliz(int n)
{
	...
	locations[n].image = "loading\jonny_load\city\Town_Beliz.dds";
	...
	locations[n].image = "loading\jonny_load\inside\Tavern02.dds";
	...
	locations[n].id.label = "Cave";
    locations[n].image = "loading\jonny_load\inside\DungeonDuffer2.dds";
	//Sound
	locations[n].type = "cave";
	locations[n].islandId = "Mein";
	locations[n].islandIdAreal = "Beliz";
	...
	locations[n].image = "loading\jonny_load\shores\ShoreShip1.dds";
	...
	locations[n].image = "loading\jonny_load\shores\grottoBig2.dds";
