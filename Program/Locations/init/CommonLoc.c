...
int LocationInitCommonLoc(int n)
{
	...
	locations[n].image = "loading\jonny_load\inside\mediumhouse03_(mediumhouse03_2).dds";
	locations[n].MustSetReloadBack = true;
	//Town sack
	locations[n].townsack = "";
	locations[n].lockWeather = "Inside";
	...
	locations[n].id.label = "Room";
	locations[n].image = "loading\jonny_load\inside\mediumhouse04.dds";
	locations[n].MustSetReloadBack = true;
	//Town sack
	locations[n].townsack = "";
	locations[n].lockWeather = "Inside";
	...
	locations[n].id.label = "House";
	locations[n].image = "loading\jonny_load\inside\mediumhouse07.dds";
	locations[n].MustSetReloadBack = true;
	//Town sack
	locations[n].townsack = "";
	locations[n].lockWeather = "Inside";
	...
	locations[n].id.label = "House";
	locations[n].image = "loading\jonny_load\inside\mediumhouse10.dds";
	locations[n].MustSetReloadBack = true;
	//Town sack
	locations[n].townsack = "";
	locations[n].lockWeather = "Inside";
	...
	locations[n].id.label = "Room";
	locations[n].image = "loading\jonny_load\inside\largehouse02.dds";
	locations[n].MustSetReloadBack = true;
	//Town sack
	locations[n].townsack = "";
	locations[n].lockWeather = "Inside";
	...
	locations[n].id.label = "Room";
	locations[n].image = "loading\jonny_load\inside\BigHouseBack.dds";
	locations[n].MustSetReloadBack = true;
	//Town sack
	locations[n].townsack = "";
	locations[n].lockWeather = "Inside";
