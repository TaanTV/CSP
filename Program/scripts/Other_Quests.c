...
{
	Log_TestInfo(GetConvertStrWithReplace("Variable_Other_Quests_1", "Logs.txt", "#space#", " "));
	ref rChar;
	int cn;
	int ShipCompanionClass;
	int iShipClass = sti(RealShips[sti(pchar.Ship.Type)].Class);
	...
	for (int comp=1; comp<COMPANION_MAX; comp++)//фикс жульничества с эскадрой и пересадкой в бою
	{
	...
	for(int i=1; i<=3; i++)
	{
		...
		{
			case 1:
				sName = GetConvertStrWithReplace("Variable_Other_Quests_1", "Names.txt", "#space#", " ");
				sLastName = GetConvertStrWithReplace("Variable_Other_Quests_2", "Names.txt", "#space#", " ");
				sModel = "pirate_5";
				sShipName = GetConvertStrWithReplace("Variable_Other_Quests_3", "Names.txt", "#space#", " ");
				break;

			case 2:
				sName = GetConvertStrWithReplace("Variable_Other_Quests_4", "Names.txt", "#space#", " ");
				sLastName = GetConvertStrWithReplace("Variable_Other_Quests_5", "Names.txt", "#space#", " ");
				sModel = "pirate_9";
				sShipName = GetConvertStrWithReplace("Variable_Other_Quests_6", "Names.txt", "#space#", " ");
				break;

			case 3:
				sName = GetConvertStrWithReplace("Variable_Other_Quests_7", "Names.txt", "#space#", " ");
				sLastName = GetConvertStrWithReplace("Variable_Other_Quests_8", "Names.txt", "#space#", " ");
				sModel = "pirate_10";
				sShipName = GetConvertStrWithReplace("Variable_Other_Quests_9", "Names.txt", "#space#", " ");
				break;
		}
...
void Andre_Abel_Quest_In_Prison()	// В тюрьме...
{
	...
	rChar.name = GetConvertStrWithReplace("Variable_Other_Quests_10", "Names.txt", "#space#", " ");
	rChar.Lastname = GetConvertStrWithReplace("Variable_Other_Quests_11", "Names.txt", "#space#", " ");
...
{
	Log_TestInfo(GetConvertStrWithReplace("Variable_Other_Quests_2", "Logs.txt", "#space#", " "));
