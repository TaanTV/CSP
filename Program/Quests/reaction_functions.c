...
//==> Дело жизни и смерти
void Birglars_Spawn(string qName)
{
	...
	ref sld;
	pchar.questTemp.tugs.berglarState = 1; //счётчик
	...
	sld.name 	= GetConvertStr("Variable_reaction_functions_0.1", "Names.txt");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_1", "Names.txt", "#space#", " ");
	sld.rank = 25;
	sld.city = "SentJons";
	...
	sld.name 	= GetConvertStr("Variable_reaction_functions_0.2", "Names.txt");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_2", "Names.txt", "#space#", " ");
	sld.rank = 25;
	sld.city = "FortFrance";
	...
	sld.name 	= GetConvertStr("Variable_reaction_functions_0.3", "Names.txt");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_3", "Names.txt", "#space#", " ");
	sld.rank = 25;
	sld.city = "Marigo";
...
/* 	GiveItem2Character(sld, "pistol2");
	...
	sld.name 	= GetConvertStr("Variable_reaction_functions_0.4", "Names.txt");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_4", "Names.txt", "#space#", " ");
	sld.rank = 27;
	sld.city = "Panama";
	...
	sld.name 	= GetConvertStr("Variable_reaction_functions_0.5", "Names.txt");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_5", "Names.txt", "#space#", " ");
	sld.rank = 22;
	sld.city = "Cartahena";
	...
	sld.name 	= GetConvertStr("Variable_reaction_functions_0.6", "Names.txt");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_6", "Names.txt", "#space#", " ");
	sld.rank = 25;
...
void Birglars_Time(string qName) // удаление квеста Остина и всех остинцев в случае неявки на встречу или отказа в диалоге
{
	...
	else
	{
		...
		AddQuestUserData("BerglarsGang", "sSex", GetSexPhrase("ся","ась"));
		CloseQuestHeader("BerglarsGang"); // квест в архив
		pchar.questdata.Ostin = 1;
	}
}
...
void BlueBird_seaBattle(string qName)
{
	...
	sld.name 	= GetConvertStr("Variable_reaction_functions_0.7", "Names.txt");
    sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_7", "Names.txt", "#space#", " ");
	...
	// Прописка всех моделей для кирас. <--
	FantomMakeCoolFighter(sld, 30, 70, 70, "blade37", "pistol6", 100);
	FantomMakeCoolSailor(sld, SHIP_XebekVML, GetConvertStr("Variable_reaction_functions_1", "ShipNames.txt"), CANNON_TYPE_CANNON_LBS20, 70, 70, 70);
	...
	GiveItem2Character(sld, "talisman12");
...
void BlueBird_over(string qName)
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_8", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_9", "Names.txt", "#space#", " ");
	sld.model = "trader_2";
	LAi_SetOwnerType(sld);
	// дадим слух
	AddSimpleRumourCity(GetConvertStrWithReplace("Variable_reaction_functions_1", "AddRumours.txt", "#space#", " ")+ GetSexPhrase(GetConvertStrWithReplace("Variable_reaction_functions_2", "AddRumours.txt", "#space#", " "),GetConvertStrWithReplace("Variable_reaction_functions_3", "AddRumours.txt", "#space#", " ")) +GetConvertStrWithReplace("Variable_reaction_functions_4", "AddRumours.txt", "#space#", " ")+
		GetConvertStrWithReplace("Variable_reaction_functions_5", "AddRumours.txt", "#space#", " "),"Pirates", 30, 3, "");
	// --> ugeen
}
...
void BlueBirdFleut_board(string qName)
{
	...
	pchar.Quest.BlueBirdFleut_over2.over = "yes";
	pchar.Quest.BlueBirdFleut_over3.over = "yes";
	int iFleits = sti(pchar.questTemp.BlueBird.count) + 1; //счётчик потопленных флейтов
	pchar.questTemp.BlueBird.count = iFleits;
	if (iFleits > 4) 
	{
		Log_Info(GetConvertStrWithReplace("Variable_reaction_functions_1", "Logs.txt", "#space#", " ") + iFleits + GetConvertStrWithReplace("Variable_reaction_functions_2", "Logs.txt", "#space#", " "));
...
void SharpSeekSpy_loginSpy(string qName)
{
	if (!IsDay())
	{
		...
		sld.name = GetConvertStrWithReplace("Variable_reaction_functions_10", "Names.txt", "#space#", " ");
		sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_11", "Names.txt", "#space#", " ");
		sld.Dialog.Filename = "Quest\ForAll_dialog.c";
		...
		sld.mapEnc.Name = GetConvertStrWithReplace("Variable_reaction_functions_12", "Names.txt", "#space#", " ");
		sld.AlwaysEnemy = true;
		sld.DontRansackCaptain = true;
		sld.mapEnc.type = "war";
		sld.hunter = "pirate";
...
{
	chrDisableReloadToLocation = true;
	sld = GetCharacter(NPC_GenerateCharacter("CapGoodly", "reservist_7", "man", "man", 20, PIRATE, -1, true));
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_13", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_14", "Names.txt", "#space#", " ");
	sld.city = "PortRoyal";
	sld.dialog.filename   = "Quest\PiratesLine_dialog.c";
...
void PQ5_inOrryHouse(string qName)
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_15", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_16", "Names.txt", "#space#", " ");
	sld.city = "Pirates";
	sld.dialog.filename   = "Quest\PiratesLine_dialog.c";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_17", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_18", "Names.txt", "#space#", " ");
	sld.city = "Pirates";
	sld.money = 51600;
...
void PQ6_ShoreBattle(string qName)
{
    ...
    {
        iTemp = 15 + rand(10);
		sld = GetCharacter(NPC_GenerateCharacter("QuestPirate_"+i, "officer_"+(rand(42)+1), "man", "man", iTemp, PIRATE, -1, true));
...
void PQ6_JungleBattle()
{
    ...
    {
        iTemp = 17 + rand(10);
		sld = GetCharacter(NPC_GenerateCharacter("QuestPirate2_"+i, "officer_"+(rand(42)+1), "man", "man", iTemp, PIRATE, -1, true));
...
void PQ7_LoginLeon()
{
	...
	FantomMakeCoolSailor(sld, SHIP_FRIGATE, GetConvertStr("Variable_reaction_functions_2", "ShipNames.txt"), CANNON_TYPE_CULVERINE_LBS24, 80, 80, 80);
	DeleteAttribute(sld, "SinkTenPercent");
	DeleteAttribute(sld, "SaveItemsForDead");
	DeleteAttribute(sld, "DontClearDead");
	DeleteAttribute(sld, "AboardToFinalDeck");
	...
	sld.mapEnc.worldMapShip = "quest_ship";
	sld.mapEnc.Name = GetConvertStrWithReplace("Variable_reaction_functions_19", "Names.txt", "#space#", " ");
	...
	Log_TestInfo(GetConvertStrWithReplace("Variable_reaction_functions_3", "Logs.txt", "#space#", " "));
}
...
void PQ7_setBattleShip(string qName)
{
	...
	{
		Log_TestInfo(GetConvertStrWithReplace("Variable_reaction_functions_4", "Logs.txt", "#space#", " "));
	...
	else
	{
		...
		FantomMakeCoolSailor(sld, SHIP_REDOUTABLE, GetConvertStr("Variable_reaction_functions_3", "ShipNames.txt"), CANNON_TYPE_CULVERINE_LBS32, 90, 90, 90);
		DeleteAttribute(sld, "SinkTenPercent");
		DeleteAttribute(sld, "SaveItemsForDead");
		DeleteAttribute(sld, "DontClearDead");
		DeleteAttribute(sld, "AboardToFinalDeck");
		...
		sld.mapEnc.worldMapShip = "quest_ship";
		sld.mapEnc.Name = GetConvertStrWithReplace("Variable_reaction_functions_20", "Names.txt", "#space#", " ");
		Map_CreateTraderXZ(1009.22, -992.708, 988.514, 515.407, "QuestCap_PL7", 15);
		Log_TestInfo(GetConvertStrWithReplace("Variable_reaction_functions_5", "Logs.txt", "#space#", " "));
	}
}
...
void PQ8_controlShore48(string qName)
{
	...
	{	//ГГ вовремя и на месте -->
        ...
        for (i=1; i<=3; i++)
        {
            sld = GetCharacter(NPC_GenerateCharacter("RSofficer_"+i, "officer_"+(rand(42)+1), "man", "man", 30, PIRATE, -1, true));
...
void WaitressFack_Enter(string qName)
{
	...
	{	//подстава
		...
		sld = GetCharacter(NPC_GenerateCharacter("BerglarWairessQuest", "officer_"+(rand(42)+1), "man", "man", iTemp, PIRATE, -1, true));
...
void CheckShipLetters(string qName)
{
	...
	{
		Log_QuestInfo(GetConvertStrWithReplace("Variable_reaction_functions_6", "Logs.txt", "#space#", " "));
...
void SetCapitainFromCityToSea(string qName) //помещаем в море кэпа, который сейчас ошивается в городе
{
	...
	if (capIndex != -1)
	{
		...
		Log_TestInfo(GetConvertStrWithReplace("Variable_reaction_functions_7", "Logs.txt", "#space#", " ") + sld.id + GetConvertStrWithReplace("Variable_reaction_functions_8", "Logs.txt", "#space#", " ") + sld.city + GetConvertStrWithReplace("Variable_reaction_functions_9", "Logs.txt", "#space#", " ") + sld.quest.targetCity);
		...
		AddSimpleRumourEx(LinkRandPhrase(GetConvertStrWithReplace("Variable_reaction_functions_6", "AddRumours.txt", "#space#", " ") + GetStrSmallRegister(XI_ConvertString(RealShips[sti(sld.Ship.Type)].BaseName + "Acc")) + " '" + sld.Ship.name + GetConvertStrWithReplace("Variable_reaction_functions_7", "AddRumours.txt", "#space#", " ") + GetFullName(sld) + GetConvertStrWithReplace("Variable_reaction_functions_8", "AddRumours.txt", "#space#", " ") + XI_ConvertString("Colony"+sld.quest.targetCity+"Acc") + ".",
			GetConvertStrWithReplace("Variable_reaction_functions_9", "AddRumours.txt", "#space#", " ") + GetStrSmallRegister(XI_ConvertString(RealShips[sti(sld.Ship.Type)].BaseName + "Acc")) + " '" + sld.Ship.name + GetConvertStrWithReplace("Variable_reaction_functions_10", "AddRumours.txt", "#space#", " ") + XI_ConvertString("Colony"+sld.quest.targetCity+"Acc") + ".",
			GetConvertStrWithReplace("Variable_reaction_functions_11", "AddRumours.txt", "#space#", " ") + GetStrSmallRegister(XI_ConvertString(RealShips[sti(sld.Ship.Type)].BaseName + "Acc")) + " '" + sld.Ship.name + GetConvertStrWithReplace("Variable_reaction_functions_12", "AddRumours.txt", "#space#", " ") + XI_ConvertString("Colony"+sld.quest.targetCity+"Acc") + ". " + GetFullName(sld) + GetConvertStrWithReplace("Variable_reaction_functions_13", "AddRumours.txt", "#space#", " ")),
...
void SetRobberFromSeaToMap(string qName) //помещаем в море кэпа-вора, который счас стоит на рейде в порту
{
	...
	if (capIndex != -1)
	{
		...
		Log_TestInfo(GetConvertStrWithReplace("Variable_reaction_functions_10", "Logs.txt", "#space#", " ") + sld.id + GetConvertStrWithReplace("Variable_reaction_functions_11", "Logs.txt", "#space#", " ") + sld.city + GetConvertStrWithReplace("Variable_reaction_functions_12", "Logs.txt", "#space#", " ") + sld.quest.targetCity);
		//на карту
		...
		//даем общий слух, что кэп ушёл в другой город
		AddSimpleRumourEx(LinkRandPhrase(GetConvertStrWithReplace("Variable_reaction_functions_14", "AddRumours.txt", "#space#", " ") + GetStrSmallRegister(XI_ConvertString(RealShips[sti(sld.Ship.Type)].BaseName + "Acc")) + " '" + sld.Ship.name + GetConvertStrWithReplace("Variable_reaction_functions_15", "AddRumours.txt", "#space#", " ") + GetFullName(sld) + GetConvertStrWithReplace("Variable_reaction_functions_16", "AddRumours.txt", "#space#", " ") + XI_ConvertString("Colony"+sld.quest.targetCity+"Acc") + ".",
			GetConvertStrWithReplace("Variable_reaction_functions_17", "AddRumours.txt", "#space#", " ") + GetStrSmallRegister(XI_ConvertString(RealShips[sti(sld.Ship.Type)].BaseName + "Acc")) + " '" + sld.Ship.name + GetConvertStrWithReplace("Variable_reaction_functions_18", "AddRumours.txt", "#space#", " ") + XI_ConvertString("Colony"+sld.quest.targetCity+"Acc") + ".",
			GetConvertStrWithReplace("Variable_reaction_functions_19", "AddRumours.txt", "#space#", " ") + GetStrSmallRegister(XI_ConvertString(RealShips[sti(sld.Ship.Type)].BaseName + "Acc")) + " '" + sld.Ship.name + GetConvertStrWithReplace("Variable_reaction_functions_20", "AddRumours.txt", "#space#", " ") + XI_ConvertString("Colony"+sld.quest.targetCity+"Acc") + ". " + GetFullName(sld) + GetConvertStrWithReplace("Variable_reaction_functions_21", "AddRumours.txt", "#space#", " ")),
...
void ChurchNightGuard_exitFromLoc(string qName)
{
	...
	Log_TestInfo(GetConvertStrWithReplace("Variable_reaction_functions_13", "Logs.txt", "#space#", " ") + pchar.questTemp.different.Church_NightGuard.NightQty);
...
void ChurchNightGuard_timerInChurch(string qName)
{
	...
	{	//нету никого
        SetLaunchFrameFormParam(GetConvertStr("Variable_reaction_functions_1", "Frames.txt"), "ChurchNightGuard_timerInChurch_2", 0, 3);
        LaunchFrameForm();
...
void CitizCapFromSeaToMap(string qName) //помещаем на карту кэпа, разыскиваемого горожанами
{
	...
	if (capIndex != -1)
	{
		...
		sld.quest.targetCity = SelectAnyColony2(sld.city, sld.quest.cribCity); //определим колонию, куда отправится кэп
		Log_TestInfo(GetConvertStrWithReplace("Variable_reaction_functions_14", "Logs.txt", "#space#", " ") + sld.id + GetConvertStrWithReplace("Variable_reaction_functions_15", "Logs.txt", "#space#", " ") + sld.city + GetConvertStrWithReplace("Variable_reaction_functions_16", "Logs.txt", "#space#", " ") + sld.quest.targetCity);
		//на карту
		iTemp = GetMaxDaysFromIsland2Island(GetArealByCityName(sld.quest.targetCity), GetArealByCityName(sld.city)) + 1; //дней доехать даем с запасом
		Map_CreateTrader(sld.city, sld.quest.targetCity, sld.id, iTemp);
		//даем общий слух, что кэп ушёл в другой город
		AddSimpleRumourEx(LinkRandPhrase(GetConvertStrWithReplace("Variable_reaction_functions_22", "AddRumours.txt", "#space#", " ") + GetStrSmallRegister(XI_ConvertString(RealShips[sti(sld.Ship.Type)].BaseName + "Acc")) + " '" + sld.Ship.name + GetConvertStrWithReplace("Variable_reaction_functions_23", "AddRumours.txt", "#space#", " ") + GetFullName(sld) + GetConvertStrWithReplace("Variable_reaction_functions_24", "AddRumours.txt", "#space#", " ") + XI_ConvertString("Colony"+sld.quest.targetCity+"Acc") + ".",
			GetConvertStrWithReplace("Variable_reaction_functions_25", "AddRumours.txt", "#space#", " ") + GetStrSmallRegister(XI_ConvertString(RealShips[sti(sld.Ship.Type)].BaseName + "Acc")) + " '" + sld.Ship.name + GetConvertStrWithReplace("Variable_reaction_functions_26", "AddRumours.txt", "#space#", " ") + XI_ConvertString("Colony"+sld.quest.targetCity+"Acc") + ".",
			GetConvertStrWithReplace("Variable_reaction_functions_27", "AddRumours.txt", "#space#", " ") + GetStrSmallRegister(XI_ConvertString(RealShips[sti(sld.Ship.Type)].BaseName + "Acc")) + " '" + sld.Ship.name + GetConvertStrWithReplace("Variable_reaction_functions_28", "AddRumours.txt", "#space#", " ") + XI_ConvertString("Colony"+sld.quest.targetCity+"Acc") + ". " + GetFullName(sld) + GetConvertStrWithReplace("Variable_reaction_functions_29", "AddRumours.txt", "#space#", " ")),
...
void SetMushketFromSeaToMap(string qName)
{
	...
	Log_TestInfo(GetConvertStrWithReplace("Variable_reaction_functions_17", "Logs.txt", "#space#", " ") + sld.city + GetConvertStrWithReplace("Variable_reaction_functions_18", "Logs.txt", "#space#", " ") + sld.quest.targetShore);
	//==> на карту
	sld.mapEnc.type = "trade";
	//выбор типа кораблика на карте
	sld.mapEnc.worldMapShip = "quest_ship";
	sld.mapEnc.Name = GetConvertStrWithReplace("Variable_reaction_functions_21", "Names.txt", "#space#", " ");
...
void SetDanielleFromSeaToMap(string qName)
{
	...
	sld.quest.targetCity = SelectAnyColony(sld.city); //определим колонию, в бухту которой он придет
	sld.quest.targetShore = GetIslandRandomShoreId(GetArealByCityName(sld.quest.targetCity));
	Log_TestInfo("Кэп фрегата Queen вышел из: " + sld.city + GetConvertStrWithReplace("Variable_reaction_functions_19", "Logs.txt", "#space#", " ") + sld.quest.targetShore);
	//==> на карту
	sld.mapEnc.type = "trade";
	//выбор типа кораблика на карте
	sld.mapEnc.worldMapShip = "quest_ship";
	sld.mapEnc.Name = GetConvertStrWithReplace("Variable_reaction_functions_22", "Names.txt", "#space#", " ");
	int daysQty = GetMaxDaysFromIsland2Island(GetArealByCityName(sld.quest.targetCity), GetArealByCityName(sld.city)) + 1; //дней доехать даем с запасом
	Map_CreateTrader(sld.cityShore, sld.quest.targetShore, sld.id, daysQty);
	//меняем сроки проверки по Id кэпа в базе нпс-кэпов
	sTemp = sld.id;
...
void SetBlackBeardFromSeaToMap(string qName)
{
	...
	sld.quest.targetShore = GetIslandRandomShoreId(GetArealByCityName(sld.quest.targetCity));
	Log_TestInfo(GetConvertStrWithReplace("Variable_reaction_functions_20", "Logs.txt", "#space#", " ") + sld.city + GetConvertStrWithReplace("Variable_reaction_functions_21", "Logs.txt", "#space#", " ") + sld.quest.targetShore);
	//==> на карту
	sld.mapEnc.type = "trade";
	//выбор типа кораблика на карте
	sld.mapEnc.worldMapShip = "Tich_MKA";
	sld.mapEnc.Name = GetConvertStrWithReplace("Variable_reaction_functions_23", "Names.txt", "#space#", " ");
...
////  Линейка ГПК           начало
/////////////////////////////////////////////////////////////////////////////////////////////////////////
void ISS_SpawnTrust(string qName)
{
	...
	sld.name = GetConvertStr("Variable_LSC_Q2Utilite_5", "Names.txt");
	sld.lastname = GetConvertStr("Variable_LSC_Q2Utilite_6", "Names.txt");;
	sld.talker = 8; //начать диалог
	...
	sld.greeting = "Gr_OliverTrast";
	if (bHardBoss) sld.AlwaysReload = true;//перезарядка независимо от Дозарядки
	ChangeCharacterAddressGroup(sld, "PortRoyal_town", "goto", "goto2");
}
...
void LSC_enterStuvesantBox(string qName)
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_24", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_25", "Names.txt", "#space#", " ");
	sld.city = "Villemstad";
...
void FirstLoginLostShipsCity(string qName) //первоначальная генерация нпс в ГПК
{
	...
	//Начальные слухи
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_30", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_31", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_26", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_27", "Names.txt", "#space#", " ");
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_28", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_29", "Names.txt", "#space#", " ");
	sld.rank = 30;
	sld.city = "LostShipsCity";
	sld.location	= "SanAugustineResidence";
	sld.location.group = "goto";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_30", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_31", "Names.txt", "#space#", " ");
	sld.rank = 30;
	sld.city = "LostShipsCity";
	sld.location	= "SanAugustineResidence";
	sld.location.group = "goto";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_32", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_33", "Names.txt", "#space#", " ");
	sld.rank = 30;
	sld.city = "LostShipsCity";
	sld.location	= "SanAugustineResidence";
	sld.location.group = "goto";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_34", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_35", "Names.txt", "#space#", " ");
	sld.rank = 30;
	sld.city = "LostShipsCity";
	sld.location	= "SanAugustineResidence";
	sld.location.group = "goto";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_36", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_37", "Names.txt", "#space#", " ");
	sld.rank = 30;
	sld.city = "LostShipsCity";
	sld.location	= "SanAugustineResidence";
	sld.location.group = "goto";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_38", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_39", "Names.txt", "#space#", " ");
	sld.rank = 30;
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_40", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_41", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_42", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_43", "Names.txt", "#space#", " ");
	sld.rank = 5;
	sld.city = "LostShipsCity";
	sld.location	= "FleuronTavern";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_44", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_45", "Names.txt", "#space#", " ");
	sld.rank = 10;
	sld.city = "LostShipsCity";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_46", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_47", "Names.txt", "#space#", " ");
	sld.rank = 10;
	sld.city = "LostShipsCity";
	sld.location	= "LostShipsCity_town";
	sld.location.group = "goto";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_48", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_49", "Names.txt", "#space#", " ");
	sld.rank = 10;
	sld.city = "LostShipsCity";
	sld.location	= "LostShipsCity_town";
	sld.location.group = "goto";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_50", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_51", "Names.txt", "#space#", " ");
	sld.rank = 10;
	sld.city = "LostShipsCity";
	sld.location	= "LostShipsCity_town";
	sld.location.group = "goto";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_52", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_53", "Names.txt", "#space#", " ");
	sld.rank = 10;
	sld.city = "LostShipsCity";
	sld.location	= "LostShipsCity_town";
	sld.location.group = "goto";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_54", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_55", "Names.txt", "#space#", " ");
	sld.rank = 10;
	sld.city = "LostShipsCity";
	sld.location	= "LostShipsCity_town";
	sld.location.group = "goto";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_56", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_57", "Names.txt", "#space#", " ");
	sld.rank = 10;
	sld.city = "LostShipsCity";
	sld.location	= "FleuronTavern";
	sld.location.group = "sit";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_58", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_59", "Names.txt", "#space#", " ");
	sld.rank = 10;
	sld.city = "LostShipsCity";
	sld.location	= "FleuronTavern";
	sld.location.group = "sit";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_60", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_61", "Names.txt", "#space#", " ");
	sld.rank = 10;
	sld.city = "LostShipsCity";
	sld.location	= "FleuronTavern";
	sld.location.group = "sit";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_62", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_63", "Names.txt", "#space#", " ");
	sld.rank = 10;
	sld.city = "LostShipsCity";
	sld.location	= "FleuronTavern";
	sld.location.group = "sit";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_64", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_65", "Names.txt", "#space#", " ");
	sld.rank = 10;
	sld.city = "LostShipsCity";
	sld.location	= "FleuronTavern";
	sld.location.group = "sit";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_66", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_67", "Names.txt", "#space#", " ");
	sld.rank = 10;
	sld.city = "LostShipsCity";
	sld.location	= "FleuronTavern";
	sld.location.group = "sit";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_68", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_69", "Names.txt", "#space#", " ");
	sld.rank = 10;
	sld.city = "LostShipsCity";
	sld.location	= "FleuronTavern";
	sld.location.group = "sit";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_70", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_71", "Names.txt", "#space#", " ");
	sld.rank = 5;
	sld.city = "LostShipsCity";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_72", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_73", "Names.txt", "#space#", " ");
	sld.rank = 5;
	sld.city = "LostShipsCity";
	sld.location	= "GloriaChurch";
	sld.location.group = "goto";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_74", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_75", "Names.txt", "#space#", " ");
	sld.rank = 5;
	sld.city = "LostShipsCity";
	sld.location	= "GloriaChurch";
	sld.location.group = "goto";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_76", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_77", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_78", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_79", "Names.txt", "#space#", " ");
	sld.rank = 40;
	sld.city = "LostShipsCity";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_80", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_81", "Names.txt", "#space#", " ");
	sld.rank = 30;
	sld.city = "LostShipsCity";
	sld.location	= "TartarusPrison";
	sld.location.group = "goto";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_82", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_83", "Names.txt", "#space#", " ");
	sld.rank = 30;
	sld.city = "LostShipsCity";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_84", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_85", "Names.txt", "#space#", " ");
	sld.rank = 5;
	// Прописка всех моделей для кирас. -->
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_86", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_87", "Names.txt", "#space#", " ");
	sld.rank = 5;
	sld.city = "LostShipsCity";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_88", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_89", "Names.txt", "#space#", " ");
	sld.rank = 5;
	sld.city = "LostShipsCity";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_90", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_91", "Names.txt", "#space#", " ");
	sld.rank = 5;
	sld.city = "LostShipsCity";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_92", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_93", "Names.txt", "#space#", " ");
	sld.rank = 5;
	sld.city = "LostShipsCity";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_94", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_95", "Names.txt", "#space#", " ");
	sld.rank = 5;
	sld.city = "LostShipsCity";
	...
	FantomMakeCoolFighter(sld, 35, 100, 100, "blade28", "pistol11", 200);
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_96", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_97", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	...
	FantomMakeCoolFighter(sld, 25, 60, 60, "blade21", "pistol11", 10);
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_98", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_99", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	sld.location	= "VelascoShipInside1";
	sld.location.group = "goto";
	sld.location.locator = "goto2";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_100", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_101", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	sld.location	= "VelascoShipInside1";
	sld.location.group = "goto";
	sld.location.locator = "goto3";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_102", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_103", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	sld.location	= "VelascoShipInside1";
	sld.location.group = "goto";
	sld.location.locator = "goto4";
	...
	FantomMakeCoolFighter(sld, 25, 85, 85, "blade33", "pistol11", 150);
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_104", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_105", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	sld.location	= "VelascoShipInside1";
	sld.location.group = "goto";
	sld.location.locator = "goto5";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_106", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_107", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	sld.location	= "VelascoShipInside1";
	sld.location.group = "goto";
	...
	FantomMakeCoolFighter(sld, 22, 65, 65, "blade22", "pistol11", 10);
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_108", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_109", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	sld.location	= "VelascoShipInside1";
	sld.location.group = "goto";
	...
	LAi_group_MoveCharacter(sld, "PearlGroup_1");
	// нарвал №7
	sld = GetCharacter(NPC_GenerateCharacter("Narval_7", "officer_6", "man", "man", 25, PIRATE, -1, true));
	FantomMakeCoolFighter(sld, 25, 85, 85, "blade23", "pistol4", 150);
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_110", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_111", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	sld.location	= "VelascoShipInside1";
	sld.location.group = "goto";
	sld.location.locator = "goto8";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_112", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_113", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	sld.location	= "SanGabrielMechanic";
	sld.location.group = "goto";
	sld.location.locator = "goto8"; //
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_114", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_115", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	sld.location	= "SanGabrielMechanic";
	sld.location.group = "goto";
	sld.location.locator = "goto4"; //
	...
	FantomMakeCoolFighter(sld, 21, 80, 80, "blade26", "pistol11", 120);
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_116", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_117", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	sld.location	= "SanGabrielMechanic";
	sld.location.group = "goto";
	sld.location.locator = "goto6"; //
	...
	FantomMakeCoolFighter(sld, 27, 80, 80, "blade34", "pistol11", 150);
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_118", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_119", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	sld.location	= "SanGabrielMechanic";
	sld.location.group = "goto";
	sld.location.locator = "goto5"; //
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_120", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_121", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	sld.location	= "SanGabrielMechanic";
	sld.location.group = "goto";
	sld.location.locator = "goto7"; //
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_122", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_123", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	sld.location	= "SanGabrielMechanic";
	sld.location.group = "goto";
	...
	FantomMakeCoolFighter(sld, 29, 80, 80, "blade25", "pistol11", 100);
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_124", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_125", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	sld.location	= "SanGabrielMechanic";
	sld.location.group = "goto";
	sld.location.locator = "goto1" //;
	...
	FantomMakeCoolFighter(sld, 25, 80, 80, "blade34", "pistol11", 150);
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_126", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_127", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	sld.location	= "SanGabrielMechanic";
	sld.location.group = "goto";
	sld.location.locator = "goto2"; //
	...
	FantomMakeCoolFighter(sld, 30, 80, 80, "blade26", "pistol11", 150);
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_128", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_129", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	sld.location	= "SanGabrielMechanic";
	sld.location.group = "goto";
	sld.location.locator = "goto3"; //
	...
	FantomMakeCoolFighter(sld, 30, 80, 80, "blade28", "pistol11", 150);
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_130", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_131", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	sld.location	= "SanGabrielMechanic";
	sld.location.group = "goto";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_132", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_133", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	sld.location	= "SanGabrielMechanic";
	sld.location.group = "goto";
	sld.location.locator = "goto11"; //
	...
	FantomMakeCoolFighter(sld, 27, 80, 80, "blade28", "pistol11", 250);
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_134", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_135", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	sld.location	= "SanGabrielMechanic";
	sld.location.group = "goto";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_136", "Names.txt", "#space#", " ");
	sld.lastname = "";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_137", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_138", "Names.txt", "#space#", " ");
	sld.city = "LostShipsCity";
	sld.location	= "LostShipsCity_town";
	sld.location.group = "goto";
	sld.location.locator = "goto08_1";
...
void LSC_admiralTakeAll()
{
	...
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_32", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "LSC_rumourElisHusband");
	//квест со скелетом Лейтона Декстера
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_33", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "LSC_rumourLostDecster");
	//наводка на Доминика Легро с вином
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_34", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
}
...
void NavalExitVelasco(string qName)
{
	...
	//распространим слухи
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_35", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_36", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_37", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_38", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_39", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_40", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_41", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_42", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_43", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_44", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
}
...
void LSC_changeBarmen(string qName)
{
	if (pchar.location != "FleuronTavern")
	{
		...
		sld = characterFromId("LSCBarmen");
        sld.name = GetConvertStrWithReplace("Variable_reaction_functions_139", "Names.txt", "#space#", " ");
        sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_140", "Names.txt", "#space#", " ");
		sld.model = "barmen_2";
        SendMessage(sld, "lss", MSG_CHARACTER_SETMODEL, sld.model, sld.model.animation);
		AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_45", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "LSC_HillBrunnerDead");
		AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_46", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "LSC_HillBrunnerDead");
		AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_47", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "LSC_HillBrunnerDead");
		AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_48", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "LSC_HillBrunnerDead");
		AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_49", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "LSC_HillBrunnerDead");
		AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_50", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "LSC_HillBrunnerDead");
		AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_51", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "LSC_HillBrunnerDead");
	}
	else
	{
...
void LSC_changeBarmen_2(string qName)
{
	pchar.questTemp.LSC = "barmenIsDead";
	sld = characterFromId("LSCBarmen");
    sld.name = GetConvertStrWithReplace("Variable_reaction_functions_141", "Names.txt", "#space#", " ");
    sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_142", "Names.txt", "#space#", " ");
	sld.model = "barmen_2";
    SendMessage(sld, "lss", MSG_CHARACTER_SETMODEL, sld.model, sld.model.animation);
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_52", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "LSC_HillBrunnerDead");
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_53", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "LSC_HillBrunnerDead");
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_54", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "LSC_HillBrunnerDead");
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_55", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "LSC_HillBrunnerDead");
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_56", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "LSC_HillBrunnerDead");
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_57", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "LSC_HillBrunnerDead");
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_58", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "LSC_HillBrunnerDead");
}
...
void LSC_enterCasper(string qName)
{
	...
	if (iTemp != -1 && characters[iTemp].location == "SanGabrielMechanic")
	{
		...
		AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_59", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
		AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_60", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
		AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_61", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
		AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_62", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
		AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_63", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
	}
...
void LSC_KillOneCasper(string qName)
{
	...
	if (sti(pchar.questTemp.LSC.Armo) < 5)
	{
		...
		AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_64", "AddRumours.txt", "#space#", " "), "LostShipsCity", 2, 1, "LSC", "");
		AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_65", "AddRumours.txt", "#space#", " "), "LostShipsCity", 2, 1, "LSC", "");
	}
	else
...
void LSC_3CarperAttackArmo()
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_143", "Names.txt", "#space#", " ");
    sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_144", "Names.txt", "#space#", " ");
	sld.model = "Girl_2";
    SendMessage(sld, "lss", MSG_CHARACTER_SETMODEL, sld.model, sld.model.animation);
    AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_66", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
    AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_67", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
    AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_68", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
	//первый каспер
	sld = characterFromId("Casper_6");
...
void LSC_SmallStormIsBegin()
{
	...
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_69", "AddRumours.txt", "#space#", " "), "LostShipsCity", 5, 1, "LSC", "");
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_70", "AddRumours.txt", "#space#", " "), "LostShipsCity", 5, 1, "LSC", "");
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_71", "AddRumours.txt", "#space#", " "), "LostShipsCity", 5, 1, "LSC", "");
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_72", "AddRumours.txt", "#space#", " "), "LostShipsCity", 5, 1, "LSC", "");
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_73", "AddRumours.txt", "#space#", " "), "LostShipsCity", 5, 1, "LSC", "");
...
void LCS_HeroOutFromStory(string qName)
{
	...
	LAi_SetActorTypeNoGroup(sld);
	LAi_ActorDialog(sld, pchar, "", 1.0, 0);
	AddSimpleRumourCityTip(GetConvertStrWithReplace("Variable_reaction_functions_74", "AddRumours.txt", "#space#", " "), "LostShipsCity", 10, 1, "LSC", "");
}
//<<<<<<-------- посетить жилые помещения магазина ----------------
...
void LSC_climeUsurer_4(string qName)
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_145", "Names.txt", "#space#", " ");
	sld.lastname = "";
...
void LSC_climeUsurer_Azzy(string qName)
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_146", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_147", "Names.txt", "#space#", " ");
...
void Teno_startInShore(string qName)
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_148", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_149", "Names.txt", "#space#", " ");
...
void Teno_startInShore_2()
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_150", "Names.txt", "#space#", " ");
	sld.lastname = "";
...
void Teno_createAztecTwin(string qName)
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_151", "Names.txt", "#space#", " ");
	sld.lastname = "";
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_152", "Names.txt", "#space#", " ");
	sld.lastname = "";
	sld.dialog.filename   = "Quest\Tenochtitlan\AztecCitizens.c";
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
void MC_startInCaracasRang(string qName)
{
...
void MC_endCaracas()
{
	...
	pchar.quest.MC_DesMoinesInShore.win_condition.l1.location = "DesMoines_port";
	pchar.quest.MC_DesMoinesInShore.function = "MC_DesMoinesInShore";
	pchar.quest.MC_DesMoinesInJungle.win_condition.l1 = "location";
	pchar.quest.MC_DesMoinesInJungle.win_condition.l1.location = "DesMoines_ExitTown";
	pchar.quest.MC_DesMoinesInJungle.function = "MC_DesMoinesInShore";
	LocatorReloadEnterDisable("DesMoines_port", "gate_back", true);
	SetLocationCapturedState("DesMoines_town", true);
	locations[FindLocation("DesMoines_ExitTown")].DisableEncounters = true;
	sld = CharacterFromID("DesMoines_tavernkeeper");
	LAi_LoginInCaptureTown(sld, true);
	sld = CharacterFromID("DesMoines_trader");
	LAi_SetLoginTime(sld, 6.0, 21.99);
	LAi_LoginInCaptureTown(sld, true);
	sld = CharacterFromID("DesMoines_usurer");
	LAi_SetLoginTime(sld, 6.0, 21.99);
	LAi_LoginInCaptureTown(sld, true);
	sld = CharacterFromID("DesMoines_Priest");
	LAi_LoginInCaptureTown(sld, true);
	sld = CharacterFromID("Fernando Torres");
	sld.greeting = "pirat_common";
	LAi_LoginInCaptureTown(sld, true);
	pchar.questTemp.MCzagadka = true;
}
...
void MC_DesMoinesInShore(string qName)
{
    ...
    //#20181002-02
    int nNumE = round((MOD_SKILL_ENEMY_RATE*3 + 0.2) / 2);
	...
	PChar.quest.MC_DesMoinesInShore.over = "yes";
	PChar.quest.MC_DesMoinesInJungle.over = "yes";
}

void MC_DesMoinesVozrojdenie(string qName)
{
	//Вовзращаем город к нормальной жизни	==>
	DeleteAttribute(pchar, "questTemp.MCzagadka");
	SetLocationCapturedState("DesMoines_town", false);		
	DeleteAttribute(&locations[FindLocation("DesMoines_ExitTown")], "DisableEncounters");	
	sld = CharacterFromID("DesMoines_tavernkeeper");
	sld.model	= "skel2";				//небольшой бонус-пасхалка
	sld.model.animation = "skeleton";
	LAi_LoginInCaptureTown(sld, false);
	sld = CharacterFromID("DesMoines_trader");
	LAi_RemoveLoginTime(sld);
	LAi_LoginInCaptureTown(sld, false);
...
//    DeleteAttribute(Pchar, "equip");
    ...
    sld.name = GetConvertStrWithReplace("Variable_reaction_functions_153", "Names.txt", "#space#", " ");
    sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_154", "Names.txt", "#space#", " ");
    ...
    sld.name 	= GetConvertStr("Variable_reaction_functions_0.8", "Names.txt");
    sld.lastname 	= GetConvertStr("Variable_reaction_functions_0.8.1", "Names.txt");
    sld.Dialog.CurrentNode = "First time";
    sld.dialog.filename = "Quest\CapBloodLine\Bishop.c";
...
{
    LAi_Fade("", "");
	DoQuestCheckDelay("CureLordMovie_Con3", 0.5);
}
...
void DragunInvansion3(string qName)
{
    ...
    ch.name 	= GetConvertStr("Variable_reaction_functions_0.9", "Names.txt");
    ch.lastname 	= GetConvertStr("Variable_reaction_functions_0.9.1", "Names.txt");
...
void CapBloodLineInit(string qName)
{
    ...
    sld.dialog.filename = "Quest\CapBloodLine\Bishop.c";
    sld.name = GetConvertStr("Variable_reaction_functions_155", "Names.txt");
    sld.lastname = GetConvertStr("Variable_reaction_functions_155.1", "Names.txt");
    // Первый квест
...
void CapBloodLine_q1(string qName)
{
    ...
    sld.name 	= GetConvertStr("Variable_reaction_functions_0.10", "Names.txt");
    sld.lastname 	= GetConvertStr("Variable_reaction_functions_0.10.1", "Names.txt");
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_156", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_157", "Names.txt", "#space#", " ");
    sld.dialog.filename = "Quest\CapBloodLine\Bishop.c";
    sld.greeting = "Gr_Master";
	sTemp = GetNationNameByType(ENGLAND) + "_citizens";
    LAi_SetOwnerType(sld);
    ...
    sld.dialog.filename = "Quest\CapBloodLine\Bishop.c";
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_158", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_159", "Names.txt", "#space#", " ");
    sld.SaveItemsForDead = true; // сохранять на трупе вещи
    sld.DontClearDead = true;
    ...
    sld.name 	= GetConvertStr("Variable_reaction_functions_0.11", "Names.txt");
    sld.lastname 	= "";
    sld.Dialog.CurrentNode = "First time";
    sld.dialog.filename = "Quest\CapBloodLine\Bishop.c";
...
//    SetSPECIAL(sld, 5,9,7,5,10,7,4);
    ...
    sld.name 	= GetConvertStr("Variable_reaction_functions_0.12", "Names.txt");
    sld.lastname 	= GetConvertStr("Variable_reaction_functions_0.12.1", "Names.txt");
    sld.Dialog.CurrentNode = "First time";
    sld.dialog.filename = "Quest\CapBloodLine\Bishop.c";
...
//                    P  I  E  A  T  R  S
    ...
    sld.name 	= GetConvertStr("Variable_reaction_functions_0.13", "Names.txt");
    sld.lastname 	= GetConvertStr("Variable_reaction_functions_0.13.1", "Names.txt");
    sld.Dialog.CurrentNode = "First time";
    sld.dialog.filename = "Quest\CapBloodLine\Bishop.c";
    sld.greeting = "Gr_Officer";
   	sTemp = GetNationNameByType(ENGLAND) + "_citizens";
...
//                    P  I  E  A  T  R  S
    ...
    sld.name 	= GetConvertStr("Variable_reaction_functions_0.14", "Names.txt");
    sld.lastname 	= GetConvertStr("Variable_reaction_functions_0.14.1", "Names.txt");
    sld.Dialog.CurrentNode = "First time";
    sld.dialog.filename = "Quest\CapBloodLine\Bishop.c";
    sld.greeting = "Gr_Ogl";
   	sTemp = GetNationNameByType(ENGLAND) + "_citizens";
...
void DetectBlades()
{
    if (CheckAttribute(Pchar, "questTemp.CapBloodLine") && Pchar.questTemp.CapBloodLine == true && Pchar.questTemp.CapBUnarmed == true)
    {
        string sweapon = FindCharacterItemByGroup(pchar, BLADE_ITEM_TYPE);
        //Log_Info(GetConvertStrWithReplace("Variable_reaction_functions_22", "Logs.txt", "#space#", " ")+sweapon);
...
void TakeBlades(string qName)
{
	...
	//Log_Info(GetConvertStrWithReplace("Variable_reaction_functions_23", "Logs.txt", "#space#", " "));
...
void LoginNettl(string qName)
{
        ...
        sld.name = GetConvertStrWithReplace("Variable_reaction_functions_160", "Names.txt", "#space#", " ");
        sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_161", "Names.txt", "#space#", " ");
		sld.dialog.filename = "Quest\CapBloodLine\Bishop.c";
		sld.dialog.currentnode = "First time";
		sld.city = "Bridgetown_town";
		sld.greeting = "Gr_Tavern_Mate";
...
{
    InterfaceStates.Buttons.Save.enable = false;
  //  SetLaunchFrameFormParam(GetConvertStr("Variable_reaction_functions_2", "Frames.txt")+ NewStr() +
...
//    sld.lifeDay = 0;
    ...
    SetLaunchFrameFormParam(GetConvertStr("Variable_reaction_functions_3", "Frames.txt"), "Reload_To_Location", 0.1, 2.0);
...
void CapBloodLine_q2()
{
    ...
    PChar.quest.CapBloodLineTimer_2.win_condition.l1.date.hour  = 23;
...
void LoginSpain_spy(string qName)
{
    ...
    sld.dialog.filename = "Quest\CapBloodLine\Bishop.c";
    sld.name = GetConvertStrWithReplace("Variable_reaction_functions_162", "Names.txt", "#space#", " ");
    sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_163", "Names.txt", "#space#", " ");
	sld.dialog.currentnode = "First time";
	sld.city = "Bridgetown_town";
...
void LoginWinterwood()
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_164", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_165", "Names.txt", "#space#", " ");
    sld.dialog.filename = "Quest\CapBloodLine\questNPC.c";
    sld.greeting = "pirat_common";
	if (bHardBoss) sld.AlwaysReload = true;//перезарядка независимо от Дозарядки
...
void CapBloodLine_q2_Complited()
{
    ...
    sld.dialog.filename = "Quest\CapBloodLine\questNPC.c";
    sld.name = GetConvertStrWithReplace("Variable_reaction_functions_166", "Names.txt", "#space#", " ");
    sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_167", "Names.txt", "#space#", " ");
	sld.greeting = "Gr_Fisher";
    sld.Default           = "Bridgetown_tavern";
    sld.Default.group     = "sit";
    ...
    sld.name = GetConvertStrWithReplace("Variable_reaction_functions_168", "Names.txt", "#space#", " ");
    sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_169", "Names.txt", "#space#", " ");
    ...
    SetLaunchFrameFormParam(GetConvertStr("Variable_reaction_functions_4", "Frames.txt"), "Reload_To_Location", 0.1, 2.0);
...
void LoginMainer()
{
        ...
        sld.name = GetConvertStrWithReplace("Variable_reaction_functions_170", "Names.txt", "#space#", " ");
        sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_171", "Names.txt", "#space#", " ");
		sld.dialog.filename = "Quest\CapBloodLine\questNPC.c";
...
void ReturnToPlantation4(string qName)
{
    ref sld;
    string sTemp = "TmpEnemy";
   	LAi_group_SetHearRadius(sTemp, 5); // послабление
   	LAi_group_SetSayRadius(sTemp, 6);
   	LAi_group_SetLookRadius(sTemp, 7);
    for (i = 0 ; i < 2; i++)
    {
...
void Slavetrader_GetRandomShore()//выбор бухты
{
	switch (rand(4))
	{
		...
		case 1:
			...
			break;
		case 2:
			pchar.questTemp.Slavetrader.Island = "StLucia";
			break;
		case 3:
...
void Slavetrader_CreateSlaveShips(string qName)//создание кораблей в бухте
{
	...
	for (i=1; i<=2; i++)//постоянно такая структура
	{
		...
		sld = GetCharacter(NPC_GenerateCharacter("CaptainSlaveAttack_"+i, "officer_"+(rand(42)+1), "man", "man", Rank, PIRATE, 3, true));//создание кэпа
		if (i == 1)
		{
...
void Slavetrader_Bonanza(string qName)//cоздание индейцев
{
    ...
    sld.name 	= GetConvertStr("Variable_reaction_functions_0.15", "Names.txt");
    sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_172", "Names.txt", "#space#", " ");
...
void Slavetrader_GetHispanShore()//определение бухты, из которой галеон выйдет
{
	...
	{
		pchar.questTemp.SlavetraderAreal.add = "from Caracas";
		while(pchar.questTemp.Slavetrader.Island == Islands[GetCharacterCurrentIsland(pchar)].id)
		{
			...
			pchar.questTemp.SlavetraderAreal.add = "from Cumana";
		}
	}
	else
	{
...
void Slavetrader_RatCorvette(string qName)//создание корвета крысы
{
	...
	Group_SetType("Rat_Attack", "war");//тип группы
		...
		sld.name = GetConvertStr("Variable_reaction_functions_173", "Names.txt");
		sld.lastname = GetConvertStr("Variable_reaction_functions_174", "Names.txt");
...
void Slavetrader_EscapeSlaveInShore(string qName)
{
	...
	for (i=21; i<=27; i++)
    {
        ...
        ChangeCharacterAddressGroup(sld, sShore, "goto", "goto"+i);
			...
			sld.name 	= GetConvertStr("Variable_reaction_functions_0.16", "Names.txt");
			sld.lastname = "";
...
void Slavetrader_UsurerEscape(string qName)//меняем модель ростовщика
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_175", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_176", "Names.txt", "#space#", " ");
	sld.model = "trader_8";
...
void zpq_seaBattle(string qName)
{
	...
	FantomMakeCoolSailor(sld, SHIP_LUGGERQUEST, GetConvertStr("Variable_reaction_functions_4", "ShipNames.txt"), CANNON_TYPE_CANNON_LBS16, 105, 105, 105);
    sld.name 	= GetConvertStr("Variable_reaction_functions_0.17", "Names.txt");
    sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_177", "Names.txt", "#space#", " ");
	sld.id		= "zpqCaptain";
	sld.AlwaysSandbankManeuver = true;
	sld.DontRansackCaptain = true;
...
void pirateStartQuest_Bahus_seaBattle(string qName)
{
	...
	FantomMakeCoolSailor(sld, SHIP_FLEUT, GetConvertStr("Variable_reaction_functions_5", "ShipNames.txt"), CANNON_TYPE_CANNON_LBS16, 50, 30, 30);
        sld.name 	= GetConvertStr("Variable_reaction_functions_0.18", "Names.txt");
        sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_178", "Names.txt", "#space#", " ");
...
void pirateStartQuest_seaBattle(string qName)
{
	...
	FantomMakeCoolSailor(sld, SHIP_LUGGER, GetConvertStr("Variable_reaction_functions_6", "ShipNames.txt"), CANNON_TYPE_CANNON_LBS12, 40, 40, 40);
        sld.name 	= GetConvertStr("Variable_reaction_functions_0.19", "Names.txt");
        sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_179", "Names.txt", "#space#", " ");
	sld.AlwaysSandbankManeuver = true;
	sld.DontRansackCaptain = true;
	sld.AnalizeShips = true;
	//SetCharacterPerk(sld, "MusketsShoot");
...
void SelectCarlosCity() //выбираем город
{
	switch (rand(6))
	{
		case 0:
			...
			pchar.questTemp.Headhunter.Cityname = GetConvertStrWithReplace("Variable_reaction_functions_180", "Names.txt", "#space#", " ");
			break;
		case 1:
			pchar.questTemp.Headhunter.City = "Charles";
			pchar.questTemp.Headhunter.Cityname = GetConvertStrWithReplace("Variable_reaction_functions_181", "Names.txt", "#space#", " ");
			break;
		case 2:
			pchar.questTemp.Headhunter.City = "Tortuga";
			pchar.questTemp.Headhunter.Cityname = GetConvertStrWithReplace("Variable_reaction_functions_182", "Names.txt", "#space#", " ");
			break;
		case 3:
			pchar.questTemp.Headhunter.City = "Santodomingo";
			pchar.questTemp.Headhunter.Cityname = GetConvertStrWithReplace("Variable_reaction_functions_183", "Names.txt", "#space#", " ");
			break;
		case 4:
			pchar.questTemp.Headhunter.City = "Panama";
			pchar.questTemp.Headhunter.Cityname = GetConvertStrWithReplace("Variable_reaction_functions_184", "Names.txt", "#space#", " ");
			break;
		case 5:
			pchar.questTemp.Headhunter.City = "Portroyal";
			pchar.questTemp.Headhunter.Cityname = GetConvertStrWithReplace("Variable_reaction_functions_185", "Names.txt", "#space#", " ");
			break;
		case 6:
			pchar.questTemp.Headhunter.City = "Marigo";
			pchar.questTemp.Headhunter.Cityname = GetConvertStrWithReplace("Variable_reaction_functions_186", "Names.txt", "#space#", " ");
			break;
	}
}
...
void CreateCarlos()//создаем Карлоса
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_187", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_188", "Names.txt", "#space#", " ");
...
void SelectHoumCity()//выберем колонию для Холма
{
	switch (sti(pchar.questTemp.Headhunter.Chance))
	{
		case 0:
			pchar.questTemp.Headhunter.City = "Bridgetown";
			pchar.questTemp.Headhunter.Cityname = GetConvertStrWithReplace("Variable_reaction_functions_189", "Names.txt", "#space#", " ");
			pchar.questTemp.Headhunter.Island = "Barbados";
		break;
		case 1:
			pchar.questTemp.Headhunter.City = "Charles";
			pchar.questTemp.Headhunter.Cityname = GetConvertStrWithReplace("Variable_reaction_functions_190", "Names.txt", "#space#", " ");
			pchar.questTemp.Headhunter.Island = "Nevis";
		break;
		case 2:
			pchar.questTemp.Headhunter.City = "Sentjons";
			pchar.questTemp.Headhunter.Cityname = GetConvertStrWithReplace("Variable_reaction_functions_191", "Names.txt", "#space#", " ");
			pchar.questTemp.Headhunter.Island = "Antigua";
		break;
		case 3:
			pchar.questTemp.Headhunter.City = "Portspein";
			pchar.questTemp.Headhunter.Cityname = GetConvertStrWithReplace("Variable_reaction_functions_192", "Names.txt", "#space#", " ");
			pchar.questTemp.Headhunter.Island = "Trinidad";
		break;
		case 4:
			pchar.questTemp.Headhunter.City = "Portroyal";
			pchar.questTemp.Headhunter.Cityname = GetConvertStrWithReplace("Variable_reaction_functions_193", "Names.txt", "#space#", " ");
...
void CreateHoum()//создадим Холма
{
	...
	FantomMakeCoolSailor(sld, SHIP_GALEON_H, GetConvertStr("Variable_reaction_functions_7", "ShipNames.txt"), CANNON_TYPE_CANNON_LBS32, 70, 70, 70);
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_194", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_195", "Names.txt", "#space#", " ");
    sld.dialog.filename = "Quest\Other_quests_NPC.c";
...
void Headhunter_CreateHoumShips(string qName)//cоздание кораблей Хоума
{
	...
	Group_SetType("Houm_Attack", "war");//тип группы
		...
		sld.name = GetConvertStrWithReplace("Variable_reaction_functions_196", "Names.txt", "#space#", " ");
		sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_197", "Names.txt", "#space#", " ");
...
void Headhunter_CreateRatpinasse(string qName)//создание пинаса Аделаида с перпомом
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_198", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_199", "Names.txt", "#space#", " ");
	FantomMakeCoolSailor(sld, SHIP_EASTINDIAMAN, GetConvertStr("Variable_reaction_functions_8", "ShipNames.txt"), CANNON_TYPE_CANNON_LBS16, 100, 100, 100);//создание кораблей
...
void CreateRatOfficer()//посадим в таверну самого Крысу - не будем модель прятать
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_200", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_201", "Names.txt", "#space#", " ");
    sld.dialog.filename = "Quest\Other_quests_NPC.c";
...
void Headhunter_CreateRatTruepinasse(string qName)//создание пинаса Аделаида с Крысой
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_202", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_203", "Names.txt", "#space#", " ");
	sld.DontRansackCaptain = true;
	sld.HeroModel = "ozg_piRat,ozg_piRat_1,ozg_piRat_2,ozg_piRat_3,ozg_piRat_4,ozg_piRat_5";
	FantomMakeCoolSailor(sld, SHIP_EASTINDIAMAN, GetConvertStr("Variable_reaction_functions_9", "ShipNames.txt"), CANNON_TYPE_CANNON_LBS16, 80, 80, 80);//создание кораблей
...
{
	SetLaunchFrameFormParam(GetConvertStr("Variable_reaction_functions_5", "Frames.txt"), "", 0, 6);
    LaunchFrameForm();
...
void CreateHalen()//создаем Халена и ближайшее окружение
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_204", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_205", "Names.txt", "#space#", " ");
    sld.dialog.filename = "Quest\Other_quests_NPC.c";
	...
	for (i=1; i<=10; i++)
	{
        ...
        LAi_SetPatrolType(sld);
		int iLocatorNum = i + 10;
		ChangeCharacterAddressGroup(sld, "Villemstad_town", "patrol", "patrol"+iLocatorNum);
		LAi_group_MoveCharacter(sld, "HOLLAND_CITIZENS");
	}
...
void Headhunter_SeabattleInPort(string qName)//создание корвета Халена
{
	...
	else
	{
		...
		sld.name = GetConvertStrWithReplace("Variable_reaction_functions_206", "Names.txt", "#space#", " ");
		sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_207", "Names.txt", "#space#", " ");
		sld.HeroModel = "ozg_martin,ozg_martin_1,ozg_martin_2,ozg_martin_3,ozg_martin_4,ozg_martin_5";
		if (bHardBoss) sld.AlwaysReload = true;//перезарядка независимо от Дозарядки
	}
	sld.DontRansackCaptain = true;
	FantomMakeCoolSailor(sld, SHIP_CORVETTE, GetConvertStr("Variable_reaction_functions_10", "ShipNames.txt"), CANNON_TYPE_CANNON_LBS32, 70, 70, 70);//создание кораблей
...
void CreateMiko()//создадим Мико Пистольеро
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_208", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_209", "Names.txt", "#space#", " ");
    sld.dialog.filename = "Quest\Other_quests_NPC.c";
...
void Create_Ja(string qName)//cоздаем Фрегат "Ахерон" с Джа
{
	...
	sld.name 	= GetConvertStr("Variable_reaction_functions_0.20", "Names.txt");
    sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_210", "Names.txt", "#space#", " ");
	sld.dialog.filename = "Quest\Other_quests_NPC.c";
...
void Ja_over(string qName)//уничтожили Джа
{
	...
	/*sld = characterFromId("Pirates_trader");
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_211", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_212", "Names.txt", "#space#", " ");
	sld.model = "trader_2";
	LAi_SetOwnerType(sld);
	*/
}
...
{
	/*sld = characterFromId("Pirates_trader");
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_213", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_214", "Names.txt", "#space#", " ");
	sld.model = "trader_2";
	LAi_SetOwnerType(sld);
	*/
}
...
void LSC_RingEnter(string qName) // входим
{
	...
	SetLaunchFrameFormParam(GetConvertStr("Variable_reaction_functions_6", "Frames.txt")+ NewStr() +GetConvertStr("Variable_reaction_functions_7", "Frames.txt"), "", 0, 6);//табличка
	LaunchFrameForm();
...
void SpawnMaks(string spawn_max)
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_215", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_216", "Names.txt", "#space#", " ");
...
{
	chrDisableReloadToLocation = true;
	sld = GetCharacter(NPC_GenerateCharacter("Anri", "officer_12", "man", "man", 30, PIRATE, -1, false));
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_217", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_218", "Names.txt", "#space#", " ");
...
void IDD_Pochta_1(string qName)
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_219", "Names.txt", "#space#", " ");
	sld.lastname = "";
...
void IDD_SI_Zovet_Boss(string qName)
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_220", "Names.txt", "#space#", " ");
	sld.lastname = "";
	sld.Dialog.filename = "Quest\SilencePrice\Shpionskie_Igry.c";
...
{
	Log_Info(GetConvertStrWithReplace("Variable_reaction_functions_32", "Logs.txt", "#space#", " "));
...
void PDM_Callow_RodjerProdolg(string qName)
{
	chrDisableReloadToLocation = true;
	ClearAllLogStrings();
	Log_info(GetConvertStrWithReplace("Variable_reaction_functions_33", "Logs.txt", "#space#", " "));
...
void PDM_PI_Vernut_Gorod(string qName)
{
	...
	AddSimpleRumourToAllNations(GetConvertStrWithReplace("Variable_reaction_functions_75", "AddRumours.txt", "#space#", " "), 7, 1);
}
//Sinistra Проклятый идол <--
...
{
	LAi_SetPlayerType(pchar);
	StartInstantDialogNoType("Beliz_Mayor", "RazgovorSGuberom_7", "Quest\PDM\Ohota_na_vedmu.c");
}
...
void PDM_CL_Ubrat_Lodku(string qName)
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_221", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_222", "Names.txt", "#space#", " ");
	sld.greeting = "GR_Spainguard";
...
{	
	...
	SetSPECIAL(sld, 10, 6, 8, 10, 8, 7, 6);
	SetSelfSkill(sld, 18, 21, 70, 3, 40);
	SetShipSkill(sld, 60, 12, 18, 17, 32, 41, 60, 31, 26);
	SetCharacterPerk(sld, "Energaiser");
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_223", "Names.txt", "#space#", " ");
	sld.lastname = GetConvertStrWithReplace("Variable_reaction_functions_224", "Names.txt", "#space#", " ");
	sld.loyality = 20;
	LAi_SetWarriorType(sld);
	LAi_group_MoveCharacter(sld, LAI_GROUP_PLAYER);
	ChangeCharacterAddressGroup(sld, pchar.location, "reload",  "reload1_back");
	
	Log_info(GetConvertStrWithReplace("Variable_reaction_functions_34", "Logs.txt", "#space#", " "));
...
void SetTichingituJail()//ставим Тичингиту
{
	...
	sld.name = GetConvertStrWithReplace("Variable_reaction_functions_225", "Names.txt", "#space#", " "); // 270912
	sld.lastname = "";
...
void UnexpectedInheritance(string qName)
{
...
{
	Log_Info(GetConvertStrWithReplace("Variable_reaction_functions_35", "Logs.txt", "#space#", " "));
...
{
	Log_Info(GetConvertStrWithReplace("Variable_reaction_functions_36", "Logs.txt", "#space#", " "));
	PlaySound("interface\important_item.wav");
...
{
	chrDisableReloadToLocation = false;
	Log_Info(GetConvertStrWithReplace("Variable_reaction_functions_37", "Logs.txt", "#space#", " "));
	PlaySound("interface\important_item.wav");
...
{
	Log_Info(GetConvertStrWithReplace("Variable_reaction_functions_38", "Logs.txt", "#space#", " "));
	//PlaySound("interface\important_item.wav");
...
void UnexpectedInheritanceEnd(string qName)
{
	...
	pchar.questdata.Nasledstvo = 1;
	UnlockAchievement("AchNasledstvo", 3);
}
void UnexpectedInheritanceSeaBattle()
{
	sld = GetCharacter(NPC_GenerateCharacter("UICap", "officer_17", "man", "man", 55, PIRATE, -1, true));
	sld.Ship.Type = GenerateShipExt(SHIP_POSTILLIONEN, true, sld);
	SetRandomNameToShip(sld);
		...
		if (sld.location == pchar.location )
		{
			if(!CheckAttribute(sld, "HasNoFear"))
			{
				if(minSkill + drand(30+i) > sti(GetSummonSkillFromName(sld, SKILL_LEADERSHIP)))
				{
					...
					Log_Info(GetConvertStrWithReplace("Variable_reaction_functions_39", "Logs.txt", "#space#", " ")+GetFullName(sld)+GetConvertStrWithReplace("Variable_reaction_functions_40", "Logs.txt", "#space#", " ")+NPCharSexPhrase(sld,"",GetConvertStrWithReplace("Variable_reaction_functions_41", "Logs.txt", "#space#", " "))+ GetConvertStrWithReplace("Variable_reaction_functions_42", "Logs.txt", "#space#", " "));
				}
				else
				{
					Log_Info(GetConvertStrWithReplace("Variable_reaction_functions_43", "Logs.txt", "#space#", " ")+GetFullName(sld)+GetConvertStrWithReplace("Variable_reaction_functions_44", "Logs.txt", "#space#", " ")+NPCharSexPhrase(sld,"",GetConvertStrWithReplace("Variable_reaction_functions_45", "Logs.txt", "#space#", " "))+ GetConvertStrWithReplace("Variable_reaction_functions_46", "Logs.txt", "#space#", " "));
				}
			}
			else
			{
				Log_Info(GetFullName(sld)+GetConvertStrWithReplace("Variable_reaction_functions_47", "Logs.txt", "#space#", " ")+NPCharSexPhrase(sld,GetConvertStrWithReplace("Variable_reaction_functions_48", "Logs.txt", "#space#", " "),GetConvertStrWithReplace("Variable_reaction_functions_49", "Logs.txt", "#space#", " "))+ GetConvertStrWithReplace("Variable_reaction_functions_50", "Logs.txt", "#space#", " "));
			}
		}
	}
}
...
void LooserGenerator_sart_Magazin(string s)		//Украл владелец магазина
{
	...
	ReOpenQuestHeader("KIP_Looser");
	AddQuestRecord("KIP_Looser", "1.1");
	AddQuestUserData("KIP_Looser", "sSex", GetSexPhrase("ся","ась"));
	AddQuestUserData("KIP_Looser", "sName", GetFullName(chr));
...
void LooserGenerator_InStore(string s)		// Заходим в магазин
{
	...
	if(CheckAttribute(pchar, "HOTP_CasinoQuest.store") && locations[n].reload.l1.go == pchar.HOTP_CasinoQuest.store)
	{
		...
		Log_Info(GetConvertStrWithReplace("Variable_reaction_functions_51", "Logs.txt", "#space#", " "));
...
void LooserGenerator_InShipyard(string s)		// Заходим на верфь
{
	...
	if(CheckAttribute(pchar, "HOTP_CasinoQuest.shipyard") && locations[n].reload.l1.go == pchar.HOTP_CasinoQuest.shipyard)
	{
		...
		Log_Info(GetConvertStrWithReplace("Variable_reaction_functions_52", "Logs.txt", "#space#", " "));
		pchar.KIP_PI_SleditZaNami = "KIP_PI_SleditZaNami";
		chrDisableReloadTolocation = true;
		InterfaceStates.Buttons.Save.enable = false;
...
void LooserGenerator_Complette()		// Успешное завершение квеста
{
	...
	ref chr = CharacterFromID(pchar.HOTP_CasinoQuest.npcharID);
	chr.lifeday = 0;
	CloseQuestHeader("KIP_Looser");
	pchar.questdata.Looser = 1;
...
void LooserGenerator_TimeFailed(string s)		// Провал квеста по времени
{
	...
	Log_Info(GetConvertStrWithReplace("Variable_reaction_functions_53", "Logs.txt", "#space#", " "));
	AddQuestRecord("KIP_Looser", "2");
	CloseQuestHeader("KIP_Looser");
	pchar.questdata.Looser = 1;
...
void LooserGenerator_FailedByEnc(string s)		// Поймали с поличным
{
	...
	Log_Info(GetConvertStrWithReplace("Variable_reaction_functions_54", "Logs.txt", "#space#", " "));
	AddQuestRecord("KIP_Looser", "2");
	CloseQuestHeader("KIP_Looser");
	pchar.questdata.Looser = 1;
}
...
void LooserGenerator_DopProverka(string s)		// Дополнительная проверка на наличие 7+ кошельков
{
	...
	{
		AddQuestRecord("KIP_Looser", "3");
		AddQuestUserData("KIP_Looser", "sSex", GetSexPhrase("ёл","ла"));
...
void KSM_Snr_Nashli_Ship(string qName)
{
	...
	FantomMakeCoolFighter(sld, sti(pchar.rank) + 5, 15 + MOD_SKILL_ENEMY_RATE * 4, 15 + MOD_SKILL_ENEMY_RATE * 4, "blade46", "pistol11", 50 + MOD_SKILL_ENEMY_RATE * 4);
	sld.SaveItemsForDead = true;
	sld.DontChangeGun = true;
...
//Квест. Кот в мешке. -->
void CSP_KvM_KusayuTebya_1(string qName)
{
	DoQuestFunctionDelay("CSP_KvM_KusayuTebya_2", 2.0);
	if (MOD_SKILL_ENEMY_RATE == 1) LAi_ApplyCharacterDamage(pchar, 8);
	if (MOD_SKILL_ENEMY_RATE == 2) LAi_ApplyCharacterDamage(pchar, 10);
	if (MOD_SKILL_ENEMY_RATE == 3) LAi_ApplyCharacterDamage(pchar, 11);
	LAi_CheckKillCharacter(pchar);
}
void CSP_KvM_KusayuTebya_2(string qName)
{
	DoQuestFunctionDelay("CSP_KvM_KusayuTebya_1", 2.0);
	if (MOD_SKILL_ENEMY_RATE == 1) LAi_ApplyCharacterDamage(pchar, 8);
	if (MOD_SKILL_ENEMY_RATE == 2) LAi_ApplyCharacterDamage(pchar, 10);
	if (MOD_SKILL_ENEMY_RATE == 3) LAi_ApplyCharacterDamage(pchar, 11);
	LAi_CheckKillCharacter(pchar);
...
void FishHDS(string s)
{
	...
	Log_info(GetConvertStr("Variable_reaction_functions_55", "Logs.txt"));
...
void UbratTrebovanieRangov(string qName)
{
	pchar.quest.DozorPrepare.win_condition.l1 = "Rank";
	pchar.quest.DozorPrepare.win_condition.l1.value = 1;
	...
	pchar.quest.MC_startInCaracasRang.win_condition.l1.value = 1;
	...
	pchar.quest.Ostin_SpawnBanditov.win_condition.l1.value = 1;
	...
	pchar.quest.Romantic_Pirat_Spawn.win_condition.l1.value = 1;
	...
	PChar.quest.PDM_ONV_Nachalo.win_condition = "PDM_ONV_Nachalo";

	pchar.quest.PKM_SvtvA_SpawnQuest.win_condition.l1 = "Rank";
	pchar.quest.PKM_SvtvA_SpawnQuest.win_condition.l1.value = 1;
	...
	pchar.quest.KSM_Snr_Alloka_Spawn.win_condition.l1.value = 1;
	...
	pchar.quest.KPS_ZO_JimSmit_Spawn.win_condition.l1 = "Rank";
	pchar.quest.KPS_ZO_JimSmit_Spawn.win_condition.l1.value = 1;
	pchar.quest.KPS_ZO_JimSmit_Spawn.win_condition.l1.operation = ">=";
	PChar.quest.KPS_ZO_JimSmit_Spawn.win_condition = "KPS_ZO_JimSmit_Spawn";

	pchar.quest.CSP_NN_SpawnGirl.win_condition.l1 = "Rank";
	pchar.quest.CSP_NN_SpawnGirl.win_condition.l1.value = 1;
	pchar.quest.CSP_NN_SpawnGirl.win_condition.l1.operation = ">=";
	PChar.quest.CSP_NN_SpawnGirl.function = "UnexpectedInheritance";

	pchar.quest.CSP_KvM_SpawnRibak.win_condition.l1 = "Rank";
	pchar.quest.CSP_KvM_SpawnRibak.win_condition.l1.value = 1;
	pchar.quest.CSP_KvM_SpawnRibak.win_condition.l1.operation = ">=";
	PChar.quest.CSP_KvM_SpawnRibak.win_condition = "CSP_KvM_SpawnRibak";

	pchar.quest.Kuali_Spawn.win_condition.l1 = "Rank";
	pchar.quest.Kuali_Spawn.win_condition.l1.value = 1;
