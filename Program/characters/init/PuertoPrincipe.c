...
int CreatePuertoPrincipeCharacters(int n)
{
	...
	ch.sex = "man";
	ch.model = "head_pir";
	ch.name = GetConvertStrWithReplace("Variable_PuertoPrincipe_1", "Names.txt", "#space#", " ");
	ch.lastname = GetConvertStrWithReplace("Variable_PuertoPrincipe_2", "Names.txt", "#space#", " ");
	...
	ch.lastname = GetConvertStr("Variable_PuertoPrincipe_3", "Names.txt");
	ch.model	= "trader_7";
