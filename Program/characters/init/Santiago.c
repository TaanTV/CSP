...
int CreateSantiagoCharacters(int n)
{
	...
	ch.model	= "huber_spa";
	ch.name 	= GetConvertStr("Variable_Santiago_0.1", "Names.txt");
	ch.lastname = GetConvertStrWithReplace("Variable_Santiago_1", "Names.txt", "#space#", " ");
	ch.sex = "man";
	ch.City = "Santiago";
	...
	ch.name 	= GetConvertStr("Variable_Santiago_0.2", "Names.txt");
	ch.lastname = "";
