...
int CreateSentMartinCharacters(int n)
{
	...
	ch.name		= GetConvertStr("Variable_SentMartin_0.3", "Names.txt");
	ch.lastname = "";
	ch.model	= "lady06";
	ch.sex = "woman";
	ch.City = "Marigo";
	...
	ch.name 	= GetConvertStr("Variable_SentMartin_0.1", "Names.txt");
	ch.lastname = "";
	...
	makeref(ch,Characters[n]);
	ch.name 	= GetConvertStr("Variable_SentMartin_0.2", "Names.txt");
	ch.lastname = GetConvertStrWithReplace("Variable_SentMartin_1", "Names.txt", "#space#", " ");
	ch.id		= "GVIK_char";
	ch.model    = "trader_4";
	ch.sex      = "man";
	ch.model.animation = "man";
