...
int CreateJamaicaCharacters(int n)
{
	...
	ch.name		= GetConvertStr("Variable_Jamaica_1", "Names.txt");
	ch.lastname = "";
	ch.model	= "Priest_2";
	...
	ch.name		= GetConvertStr("Variable_Jamaica_2", "Names.txt");
	ch.lastname = "";
	ch.model	= "lady03";
	ch.sex = "woman";
	ch.City = "PortRoyal";
	...
	ch.name 	= GetConvertStr("Variable_Jamaica_0.1", "Names.txt");
	ch.lastname = "";
   ...
   //=============== форт Оранж ===============
    ...
    makeref(ch,Characters[n]);
	ch.name 	= GetConvertStr("Variable_Jamaica_0.2", "Names.txt");
	ch.lastname = "";
	...
	ch.id		= "Builder";
	ch.name	= GetConvertStr("Variable_QuestsUtilite_3.1", "Names.txt");
	ch.lastname	= GetConvertStr("Variable_QuestsUtilite_3.2", "Names.txt");
	ch.model	= "Mechanic";
	ch.sex = "man";
	ch.City = "PortRoyal";
	...
	//смотритель кладбища
	makeref(ch,Characters[n]);
	ch.name 	= GetConvertStr("Variable_Jamaica_0.3", "Names.txt");
	ch.lastname = GetConvertStrWithReplace("Variable_Jamaica_1", "Names.txt", "#space#", " ");
