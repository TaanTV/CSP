...
int CreateGuadeloupeCharacters(int n)
{
	...
	ch.name 	= GetConvertStr("Variable_Guadeloupe_0.1", "Names.txt");
	ch.lastname = "";
	...
	//смотритель кладбища
	makeref(ch,Characters[n]);
	ch.name 	= GetConvertStr("Variable_Guadeloupe_0.2", "Names.txt");
	ch.lastname = GetConvertStrWithReplace("Variable_Guadeloupe_1", "Names.txt", "#space#", " ");
