...
int CreateHavanaCharacters(int n)
{
	...
	ch.name 	= GetConvertStr("Variable_Havana_0.1", "Names.txt");
	ch.lastname = "";
	...
	//смотритель кладбища
	makeref(ch,Characters[n]);
	ch.name 	= GetConvertStr("Variable_Havana_0.2", "Names.txt");
	ch.lastname = GetConvertStrWithReplace("Variable_Havana_1", "Names.txt", "#space#", " ");
