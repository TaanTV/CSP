...
int CreatePortoBelloCharacters(int n)
{
	...
	ch.name 	= GetConvertStr("Variable_PortoBello_0.1", "Names.txt");
	ch.lastname = GetConvertStrWithReplace("Variable_PortoBello_1", "Names.txt", "#space#", " ");
	...
	ch.name 	= GetConvertStr("Variable_PortoBello_0.2", "Names.txt");
	ch.lastname = "";
