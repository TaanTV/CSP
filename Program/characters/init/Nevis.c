...
int CreateNevisCharacters(int n)
{
	...
	ch.model	= "cyclop";
	ch.name 	= GetConvertStr("Variable_Nevis_0.1", "Names.txt");
	ch.lastname = GetConvertStr("Variable_Nevis_1", "Names.txt");
	...
	ch.name		= GetConvertStr("Variable_Nevis_2", "Names.txt");
	ch.lastname = "";
	ch.model	= "lady02";
	ch.sex = "woman";
	ch.City = "Charles";
	...
	ch.name 	= GetConvertStr("Variable_Nevis_0.2", "Names.txt");
	ch.lastname = "";
