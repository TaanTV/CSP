...
int CreateMartiniqueCharacters(int n)
{
	...
	ch.name		= GetConvertStr("Variable_Martinique_3", "Names.txt");
	ch.lastname = "";
	ch.model	= "priest_4";
	...
	ch.name		= GetConvertStr("Variable_Martinique_4", "Names.txt");
	ch.lastname = "";
	ch.model	= "Fatman2_1";
	...
	ch.name		= GetConvertStr("Variable_Martinique_5", "Names.txt");
	ch.lastname = "";
	ch.model	= "lady04";
	ch.sex = "woman";
	ch.City = "FortFrance";
	...
	ch.name 	= GetConvertStr("Variable_Martinique_0.1", "Names.txt");
	ch.lastname = "";
	...
	ch.model	= "huber_fra";
	ch.name 	= GetConvertStr("Variable_Martinique_0.2", "Names.txt");
	ch.lastname = GetConvertStr("Variable_Martinique_1", "Names.txt");
	ch.sex = "man";
	ch.City = "LeFransua";
	...
	ch.model	= "Q_Barmen";
	ch.name 	= GetConvertStr("Variable_Martinique_0.3", "Names.txt");
	ch.lastname = GetConvertStr("Variable_Martinique_2", "Names.txt");
	ch.greeting = "Gr_Barmen";
	ch.sex = "man";
	ch.City = "LeFransua";
