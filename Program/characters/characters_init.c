...
void CreateCharacters()
{
	...
	ch.name 	= GetConvertStr("Variable_characters_init_0", "Names.txt");
	ch.lastname = GetConvertStr("Variable_characters_init_1", "Names.txt");
	ch.id		= "Blaze";
	ch.nation	= ENGLAND;
	ch.model	= "devlin";
	ch.sex = "man";
	...
	ch.Ship.Name = GetConvertStrWithReplace("Variable_characters_init_2", "Names.txt", "#space#", " ");
    ...
    NullCharacter.GenQuestFort.FortOrange.how        = 4;
    NullCharacter.GenQuestFort.FortOrange.howSolder  = 4;
	...
	NullCharacter.GenQuestFort.FortOrange.next3  = "FortOrange_port";
