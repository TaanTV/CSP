...
void InitColonies()
{
	...
	//////////////////////////////
		...
		colonies[n].Default.BoardLocation2 = "FortOrange_port";
	...
	/////////////////////////////////////////////////////////////////////
		...
		Colonies[n].islandLable = "Mein";
		colonies[n].num = 1;
		colonies[n].map.x = 1260;
		colonies[n].map.y = 2020;
		colonies[n].StoreNum   = DesMoines_STORE;
		colonies[n].from_sea   = "DesMoines_port";
		colonies[n].HasNoFort = true;
...
/*		n = n + 1;
		Colonies[n].id = "StLucia";
		Colonies[n].visible = false;
		Colonies[n].smuggling_nation = "none";
		Colonies[n].nation = "none";
		Colonies[n].island = "StLucia";
		Colonies[n].islandLable = "StLucia";
		Colonies[n].num = "1";
		colonies[n].map.x = 1698;	//подобрать координаты нужно
		colonies[n].map.y = 1598;
		colonies[n].colonylevel = 0;
		colonies[n].StoreNum   = Pirates_STORE; // заглушка
		colonies[n].from_sea   = "";
