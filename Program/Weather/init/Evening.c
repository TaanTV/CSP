...
// Вечер 19 часов
	...
	Weathers[n].Sun.Color = argb(0,255,235,220);//argb(0,150,140,132);//argb(0,120,122,122);
	Weathers[n].Sun.Ambient = argb(0,80,80,85);
	...
	Weathers[n].Sun.Reflection.Dist = 4000.0;//3500.0;
	...
	Weathers[n].Sea2.WaterColor = argb(0,1,62,94);	
...
// Вечер 20 часов
	...
	Weathers[n].Sun.Color = argb(0,190,127,105);//argb(0,135,120,115);
	Weathers[n].Sun.Ambient = argb(0,50,45,55);
	Weathers[n].Sun.AzimuthAngle = Degree2Radian(337.0);
	...
	Weathers[n].Sea2.WaterColor = argb(0,3,45,80);
	Weathers[n].Sea2.SkyColor = argb(0,255,255,255);

	Weathers[n].Sea2.Reflection = 0.5;
	Weathers[n].Sea2.Transparency = 0.1;//0.2;
	Weathers[n].Sea2.Frenel = 0.3;
	Weathers[n].Sea2.Attenuation = 0.1;
...
// Вечер 21 час
	...
	Weathers[n].Sun.Color = argb(0,150,66,55);//argb(0,60,30,30);
	Weathers[n].Sun.Ambient = argb(0,35,30,35);
	Weathers[n].Sun.AzimuthAngle = Degree2Radian(337.0);
	...
	Weathers[n].Sea2.WaterColor = argb(0,10,30,45);	
	Weathers[n].Sea2.SkyColor = argb(0,255,240,220);
...
// Вечер 22 часа
	...
	Weathers[n].Sun.Color = argb(0,47,34,43);//argb(0,255,255,255);//argb(0,60,45,45);
	Weathers[n].Sun.Ambient = argb(0,31,24,37);//argb(0,60,40,40);
	Weathers[n].Sun.AzimuthAngle = Degree2Radian(337.0);
	...
	Weathers[n].Sea2.WaterColor = argb(0,10,20,37);
	Weathers[n].Sea2.SkyColor = argb(0,220,210,190);
...
// Вечер 23 часа
	...
	Weathers[n].Sun.Color = argb(0,1,1,1);
	Weathers[n].Sun.Ambient = argb(0,22,22,36);//argb(0,14,14,23);//argb(0,40,40,40);
	Weathers[n].Sun.AzimuthAngle = Degree2Radian(337.0);
	Weathers[n].Sun.HeightAngle = 0.1;
	...
	Weathers[n].Sun.Glow.Enable = true;
	Weathers[n].Sun.Glow.Dist = 15750.0;
	Weathers[n].Sun.Glow.Size = 1150.0;
	Weathers[n].Sun.Glow.RotateSpeed = 1.0;
	Weathers[n].Sun.Glow.Texture = "weather\sun\glow\sunglow.tga";
	Weathers[n].Sun.Glow.DecayTime = 8.0;
	Weathers[n].Sun.Glow.TechniqueNoZ = "sunglow_noz";
	...
	Weathers[n].Sun.Overflow.Texture = "weather\lightning\flash.tga";
	Weathers[n].Sun.Overflow.Color = argb(0, 100, 100, 100);
	Weathers[n].Sun.Overflow.Size = 1500.0;
	Weathers[n].Sun.Overflow.Technique = "sunoverflow";
	Weathers[n].Sun.Overflow.Start = 0.75;
	...
	Weathers[n].Sea2.WaterColor = argb(0,4,13,22);
	Weathers[n].Sea2.SkyColor = argb(0,30,80,130);//солнца больше нет, рефлектить начинает будто бы от корабля - уменьшаем
