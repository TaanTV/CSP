...
// День 11 часов
	...
	Weathers[n].Sun.Ambient = argb(0,92,92,105);
	Weathers[n].Sun.AzimuthAngle = Degree2Radian(150.0);
	Weathers[n].Sun.HeightAngle = 0.70;

	Weathers[n].Sun.Glow.Enable = true;
	Weathers[n].Sun.Glow.Dist = 15750.0;
	Weathers[n].Sun.Glow.Size = 5000.0;//1250.0;
	...
	Weathers[n].Sun.Overflow.Size = 25000.0;
	...
	Weathers[n].Sun.Flare.Scale = 8.0;
	...
	Weathers[n].Sea2.WaterColor = argb(0,15,75,120);//argb(0,23,84,128);			  
	Weathers[n].Sea2.SkyColor = argb(0,255,255,255);

	Weathers[n].Sea2.Reflection = 0.6;
	Weathers[n].Sea2.Transparency = 0.1;//0.3;
	Weathers[n].Sea2.Frenel = 0.45;
	Weathers[n].Sea2.Attenuation = 0.23;
...
// День 12 часов
	...
	Weathers[n].Sun.Color = argb(0,255,255,250);
	Weathers[n].Sun.Ambient = argb(0,92,92,103);//argb(0,105,100,90);
	Weathers[n].Sun.AzimuthAngle = Degree2Radian(150.0);
	Weathers[n].Sun.HeightAngle = 0.70;
	...
	Weathers[n].Sea2.WaterColor = argb(0,15,73,115);//argb(0,23,84,128);
	Weathers[n].Sea2.SkyColor = argb(0,255,255,255);
...
// День 13 часов
	...
	Weathers[n].Sun.Color = argb(0,255,255,250);//argb(0,214,214,208);
	Weathers[n].Sun.Ambient = argb(0,92,92,103);//argb(0,100,100,90);
	...
	Weathers[n].Sea2.WaterColor = argb(0,15,73,115);	
	Weathers[n].Sea2.SkyColor = argb(0,255,255,255);
...
// День 14 часов
	...
	Weathers[n].Sun.Color = argb(0,255,255,250);//argb(0,234,234,218);
	Weathers[n].Sun.Ambient = argb(0,92,92,105);//argb(0,100,100,80);
	//Weathers[n].Sun.AzimuthAngle = Degree2Radian(88.0);
	//Weathers[n].Sun.HeightAngle = 0.85;
	Weathers[n].Sun.AzimuthAngle = Degree2Radian(150.0);
	Weathers[n].Sun.HeightAngle = 1.2;
...
// День 15 часов
	...
	Weathers[n].Sun.Color = argb(0,255,255,250);//argb(0,226,224,204);
	Weathers[n].Sun.Ambient = argb(0,92,92,103);//argb(0,105,105,100);
...
// День 16 часов
	...
	Weathers[n].Sun.Color = argb(0,255,255,255);//argb(0,166,154,144);
	Weathers[n].Sun.Ambient = argb(0,92,92,105);//argb(0,95,95,85);
	//Weathers[n].Sun.AzimuthAngle = Degree2Radian(5.0);
	//Weathers[n].Sun.HeightAngle = 1.07;
	Weathers[n].Sun.AzimuthAngle = Degree2Radian(300.0);
	Weathers[n].Sun.HeightAngle = 1.2;
...
// День 17 часов
	...
	Weathers[n].Sun.Color = argb(0,200,180,170);//argb(0,136,134,124);
	Weathers[n].Sun.Ambient = argb(0,85,85,97);//argb(0,100,100,96);
	...
	Weathers[n].Sun.Glow.Enable = true;
	Weathers[n].Sun.Glow.Dist = 15750.0;
	Weathers[n].Sun.Glow.Size = 5000.0;//500.0;
	Weathers[n].Sun.Glow.RotateSpeed = 1.0;
	Weathers[n].Sun.Glow.Texture = "weather\sun\glow\sunglow.tga";
	Weathers[n].Sun.Glow.DecayTime = 8.0;
	Weathers[n].Sun.Glow.TechniqueNoZ = "sunglow_noz";
...
// День 18 часов
	...
	Weathers[n].Sun.Color = argb(0,190,170,160);//argb(0,126,124,114);
	Weathers[n].Sun.Ambient = argb(0,85,85,97);//argb(0,100,100,95);
	//Weathers[n].Sun.AzimuthAngle = Degree2Radian(-25.0);
	//Weathers[n].Sun.HeightAngle = 0.60;
	Weathers[n].Sun.AzimuthAngle = Degree2Radian(300.0);
	Weathers[n].Sun.HeightAngle = 0.70;
