...
// ���� 0 �����
	...
	Weathers[n].Sky.Color = argb(0,255,255,255);//argb(0,64,64,64);
	...
	Weathers[n].Sun.Color = argb(0,27,24,37);
	Weathers[n].Sun.Ambient = argb(0,14,14,23);
	...
	Weathers[n].Sea2.WaterColor = argb(0,2,9,15);
	Weathers[n].Sea2.SkyColor = argb(0,30,80,130);
...
// ���� 5 �����
	...
	Weathers[n].Sun.Color = argb(0,45,30,45);
	Weathers[n].Sun.Ambient = argb(0,25,25,33);
	Weathers[n].Sun.AzimuthAngle = Degree2Radian(320.0);
	Weathers[n].Sun.HeightAngle = 0.28;

	Weathers[n].Sun.Moon = false;

	Weathers[n].Sun.Glow.Enable = true;
	Weathers[n].Sun.Glow.Dist = 15750.0;
	Weathers[n].Sun.Glow.Size = 1110.0;
	Weathers[n].Sun.Glow.RotateSpeed = 0.0;
	Weathers[n].Sun.Glow.Texture = "weather\sun\glow\sunglow.tga";
	Weathers[n].Sun.Glow.DecayTime = 8.0;
	Weathers[n].Sun.Glow.TechniqueNoZ = "sunglow_noz";
	...
	Weathers[n].Sun.Overflow.Enable = true;
	Weathers[n].Sun.Overflow.Texture = "weather\lightning\flash.tga";
	Weathers[n].Sun.Overflow.Color = argb(0,127,88,55);
	Weathers[n].Sun.Overflow.Size = 1.0;
	Weathers[n].Sun.Overflow.Technique = "sunoverflow";
	Weathers[n].Sun.Overflow.Start = 0.7;

	Weathers[n].Sun.Reflection.Enable = true;
	Weathers[n].Sun.Reflection.Texture = "weather\sun\reflection\refl_day.tga";//"weather\sun\reflection\refl_night.tga";
	Weathers[n].Sun.Reflection.Technique = "sunglow_z";//оверрайдит туман
	Weathers[n].Sun.Reflection.Dist = 4000.0;
	Weathers[n].Sun.Reflection.Size = 350.0;
	Weathers[n].Sun.Reflection.Color = argb(0,255,166,100);

	Weathers[n].Sun.Flare.Enable = true;
	Weathers[n].Sun.Flare.Texture = "weather\sun\flare\allflares.tga";
	Weathers[n].Sun.Flare.Dist = 5500.0;
	Weathers[n].Sun.Flare.TexSizeX = 2;
	Weathers[n].Sun.Flare.TexSizeY = 2;
	Weathers[n].Sun.Flare.Technique = "sunflare";
	Weathers[n].Sun.Flare.Scale = 0.0;
	Weathers[n].Sun.Flares.f1 = "1.0,200.0,0,0x0F0F0F";
	Weathers[n].Sun.Flares.f2 = "0.9,20.0,1,0x0F0F0F";
	Weathers[n].Sun.Flares.f3 = "0.8,30.0,2,0x0F0F0F";
	Weathers[n].Sun.Flares.f4 = "0.6,150.0,0,0x0F0F0F";
	...
	Weathers[n].Sea2.WaterColor = argb(0,3,9,17);
	Weathers[n].Sea2.SkyColor = argb(0,222,211,180);
