...
// Утро 6 часов
	...
	Weathers[n].Sun.Color = argb(0,220,104,33);
	Weathers[n].Sun.Ambient = argb(0,35,35,38);
	...
	Weathers[n].Sun.Overflow.Color = argb(0,127,88,55);//argb(0,100,100,100);
	...
	Weathers[n].Sun.Reflection.Color = argb(0,255,166,100);//argb(0,200,200,200);
	...
	Weathers[n].Sea2.WaterColor = argb(0,8,23,40);
	Weathers[n].Sea2.SkyColor = argb(0,220,210,190);//симуляция восхода солнца

	Weathers[n].Sea2.Reflection = 0.8;
	Weathers[n].Sea2.Transparency = 0.1;//0.6;
...
// Утро 7 часов						 
	...
	Weathers[n].Sun.Color = argb(0,220,180,180);//argb(0,110,90,90);
	Weathers[n].Sun.Ambient = argb(0,50,45,45);
	Weathers[n].Sun.AzimuthAngle = Degree2Radian(160.0);
	Weathers[n].Sun.HeightAngle = 0.21;
	...
	Weathers[n].Sea2.WaterColor = argb(0,8,29,53);
...
// Утро 8 часов						
	...
	Weathers[n].Sun.Color = argb(0,180,140,150);//argb(0,120,90,100);
	Weathers[n].Sun.Ambient = argb(0,87,77,77);	 
	Weathers[n].Sun.AzimuthAngle = Degree2Radian(160.0);
	...
	Weathers[n].Sea2.WaterColor = argb(0,10,40,70);
	Weathers[n].Sea2.SkyColor = argb(0,255,255,255);
...
// Утро 9 часов						
	...
	Weathers[n].Sun.Color = argb(0,210,160,155);//argb(0,160,120,80);
	Weathers[n].Sun.Ambient = argb(0,90,81,89);
	Weathers[n].Sun.AzimuthAngle = Degree2Radian(160.0);
	...
	Weathers[n].Sea2.WaterColor = argb(0,5,37,65);//argb(0,2,60,95);
	Weathers[n].Sea2.SkyColor = argb(0,255,255,255);
...
// Утро 10 часов						 
	...
	Weathers[n].Fog.IslandDensity = 0.0002;
	Weathers[n].Fog.SeaDensity = 0.00006;
	Weathers[n].Fog.Color = argb(0,120,150,180);//argb(0,156,195,232);
	...
	Weathers[n].Sun.Color =  argb(0,255,235,220);
	Weathers[n].Sun.Ambient = argb(0,92,92,103);
	Weathers[n].Sun.AzimuthAngle = Degree2Radian(160.0);
	Weathers[n].Sun.HeightAngle = 0.45;
	...
	Weathers[n].Sea2.WaterColor = argb(0,5,47,77);	
	Weathers[n].Sea2.SkyColor = argb(0,255,255,255);
