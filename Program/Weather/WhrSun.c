...
void WhrFillSunGlowData(int nw1, int nw2)
{
	...
	if( stf(Environment.Time) < 4.5 || stf(Environment.Time) > 23.0 ) {
		SunGlow.Moon = true;
	...
	if( nw2 >= 0)
	{
		...
		if (GetTime() >= 5.6 && GetTime() < 5.7) {
			SunGlow.Flare.Scale = 2.7;
			SunGlow.Overflow.Size = 2700.0;
			SunGlow.Glow.SunSize = 1000;
			SunGlow.Glow.Size = 3850;
			SunGlow.Glow.SunTexture = "weather\sun\glow\sun.tga.tx";
			SunGlow.Reflection.Size = 600;
			SunGlow.Reflection.Texture = "weather\sun\reflection\refl_morning_2.tga.tx";
		} else {
		if (GetTime() >= 5.7 && GetTime() < 5.8) {
			SunGlow.Flare.Scale = 4.5;
			SunGlow.Overflow.Size = 5200.0;
			SunGlow.Glow.SunSize = 1000;
			SunGlow.Glow.Size = 3850;
			SunGlow.Glow.SunTexture = "weather\sun\glow\sun.tga.tx";
			SunGlow.Reflection.Size = 600;
		...
		if( GetTime() >= 5.8 && GetTime() < 5.9 ) {
			SunGlow.Flare.Scale = 4.6;
			SunGlow.Overflow.Size = 12000.0;
			SunGlow.Glow.SunSize = 1050;
			SunGlow.Glow.Size = 3850;
			SunGlow.Glow.SunTexture = "weather\sun\glow\sun.tga.tx";
			SunGlow.Reflection.Size = 650;
			SunGlow.Reflection.Texture = "weather\sun\reflection\refl_morning_2.tga.tx";
		} else {
		if( GetTime() >= 5.9 && GetTime() < 6.45 ) {
			SunGlow.Flare.Scale = 7.0;
			SunGlow.Overflow.Size = 23000.0;
			SunGlow.Glow.SunSize = 1050;
			SunGlow.Glow.Size = 3850;
			SunGlow.Glow.SunTexture = "weather\sun\glow\sun.tga.tx";
			SunGlow.Reflection.Size = 700;
			SunGlow.Reflection.Texture = "weather\sun\reflection\refl_morning_2.tga.tx";
		} else {
		if( GetTime() >= 6.45 && GetTime() < 7.0 ) {
			SunGlow.Glow.SunSize = 1050;
			SunGlow.Glow.Size = 3850;
			SunGlow.Glow.SunTexture = "weather\sun\glow\sun.tga.tx";
		...
		if( GetTime() >= 21.0 && GetTime() < 21.5 ) {
			...
			SunGlow.Reflection.Size = 500;
			SunGlow.Reflection.Texture = "weather\sun\reflection\refl_evening.tga.tx";
		} else {
		if( GetTime() >= 21.5 && GetTime() < 22.0 ) {
			SunGlow.Glow.SunSize = 1050;
			SunGlow.Glow.Size = 3850;
			SunGlow.Glow.SunTexture = "weather\sun\glow\sun1.tga.tx";
			SunGlow.Reflection.Size = 400;
			SunGlow.Reflection.Texture = "weather\sun\reflection\refl_evening.tga.tx";
		}}}}}}}}}}
		if (GetTime() >= 22.0 && GetTime() < 23.0) 
		{
			SunGlow.Glow.Size = 0;	
		...
		if (FindLocation(sLocation) != -1) SunGlow.Glow.SunSize = 1150;
