void InitGoods()
{
	...
	Goods[GOOD_BALLS].Cost			= 20;
	Goods[GOOD_BALLS].Weight		= 1;
	Goods[GOOD_BALLS].Units			= 20;
	Goods[GOOD_BALLS].SpeedV0		= 1.0;
	Goods[GOOD_BALLS].DamageHull	= 2.0;		//ВНИМАНИЕ. в AIShip добавил множители, чтоб без НИ исправить. 		ядра 1.5/1.4=1.07		бомбы 2.5/1.4*1.1=1.965
	...
	Goods[GOOD_KNIPPELS].DamageHull = 0.4;
