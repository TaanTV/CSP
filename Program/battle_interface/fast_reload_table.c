...
#define FRP_FERNANDO		21
#define FRT_FERNANDO		0
...
void initFastReloadTable()
{
	...
	makearef(curTable,objFastReloadTable.table.DesMoines);
	// store
	curTable.l1.pic = FRP_STORE;
	curTable.l1.tex = FRT_STORE;
	curTable.l1.location = "DesMoines_store";
	// tavern
	curTable.l3.pic = FRP_TAVERN;
	curTable.l3.tex = FRT_TAVERN;
	curTable.l3.location = "DesMoines_tavern";
	// residence
	curTable.l4.pic = FRP_RESIDENCE;
	curTable.l4.tex = FRT_RESIDENCE;
	curTable.l4.location = "DesMoines_townhall";
	// usurer
	curTable.l5.pic = FRP_USURER;
	curTable.l5.tex = FRT_USURER;
	curTable.l5.location = "DesMoines_bank";
	// church
	curTable.l6.pic = FRP_CHURCH;
	curTable.l6.tex = FRT_CHURCH;
	curTable.l6.location = "DesMoines_church";

	curTable.l8.pic = FRP_TOWN_EXIT;
	curTable.l8.tex = FRT_TOWN_EXIT;
	curTable.l8.location = "DesMoines_ExitTown";
...
void InitTownTable()
{
	...
	objTownStateTable.towns.t31.name = "DesMoines";
	objTownStateTable.towns.t31.captured = false;
	objTownStateTable.towns.t31.crew.quantity = 100 + Rand(100);
