...
void Set_inDialog_Attributes()
{
	...
	if (LanguageGetLanguage() != "russian")
	{
		...
		Address_Form.Fra.woman = "madam";
		Address_Form.Eng.woman = "missis";
		Address_Form.Hol.woman = "frau";
...
string RandSwear()
{
	if (LanguageGetLanguage() != "russian")
	{
		switch (rand(14))
		{
			...
			case 4:
				return "Anchor me in the the... ";
			break;

			case 5:
				return "A thousand sharks! ";
			break;
			...
			case 7:
				return "A thousand devils! ";
			break;

			case 8:
				return "Alle Hagel! "; // the campдартное пиратское "твою мать"
			break;
			case 9:
				return "Thunder blast me! ";
			break;

			case 10:
				return "Ar-g, your mizzen! ";
			break;
			...
			case 12:
				return "A dozen sharks! ";
			break;

			case 13:
				return "Bite me herring! ";
			break;

			case 14:
				return "Three thousand devils! ";
			break;
		}
	}
	else
...
string NationKingsCrown(ref Character)
{
	if (LanguageGetLanguage() != "russian")
	{
		...
		{
			case ENGLAND:
        	    return "the English Throne";
			break;
			case FRANCE:
        	    return "the French Crown";
			break;
			case SPAIN:
        	    return "the Spanish Crown";
			break;
			case HOLLAND:
				return "the Kingdom of the Netherlands";
			break;
			case PIRATE:
				return "the Brethren";
			break;
...
string NationKingsName(ref NPChar)
{
	if (LanguageGetLanguage() != "russian")
	{
		...
		{
			case ENGLAND:
    	        return "His Majesty Charles II Stuart";
			break;
			case FRANCE:
    	        return "His Majesty Louis XIV";
			break;
			case SPAIN:
    	        return "His Catholic Majesty Charles II of Habsburg";
			break;
			case HOLLAND:
				return "His Majesty William III of Orange";
			break;
			case PIRATE:
				return "Brethren";
			break;
...
string GetIslandByArealName(string areal)
{
	...
	if(areal == "PortoBello" || areal == "Panama" || areal == "Cartahena" ||
		...
		areal == "Beliz" || areal == "DesMoines" || areal == "Tenotchitlan")
	{
		sAreal = "Mein";
	}
	return sAreal;
