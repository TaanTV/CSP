...
void GenerateQuestDuel()
{
	...
	Log_TestInfo(GetConvertStrWithReplace("Variable_GenerateQuests_1", "Logs.txt", "#space#", " ") + sti(PChar.GenerateQuestDuel.Money));
	Log_TestInfo(GetConvertStrWithReplace("Variable_GenerateQuests_2", "Logs.txt", "#space#", " ") + sti(PChar.GenerateQuestDuel.Variant));
	Log_TestInfo(GetConvertStrWithReplace("Variable_GenerateQuests_3", "Logs.txt", "#space#", " ") + sti(PChar.GenerateQuestDuel.Mercenary));
	Log_TestInfo(GetConvertStrWithReplace("Variable_GenerateQuests_4", "Logs.txt", "#space#", " ") + sti(PChar.GenerateQuestDuel.Relative));
	Log_TestInfo(GetConvertStrWithReplace("Variable_GenerateQuests_5", "Logs.txt", "#space#", " "));
...
void QuestDuelBattleWithMercenaryWinner(string qName)
{
	...
	AddSimpleRumourToAllNations(LinkRandPhrase(GetConvertStrWithReplace("Variable_GenerateQuests_1", "AddRumours.txt", "#space#", " "), GetConvertStrWithReplace("Variable_GenerateQuests_2", "AddRumours.txt", "#space#", " "), GetConvertStrWithReplace("Variable_GenerateQuests_3", "AddRumours.txt", "#space#", " ")) + GetConvertStrWithReplace("Variable_GenerateQuests_4", "AddRumours.txt", "#space#", " ") + GetFullName(PChar) + " "+ GetSexPhrase(GetConvertStrWithReplace("Variable_GenerateQuests_5", "AddRumours.txt", "#space#", " "),GetConvertStrWithReplace("Variable_GenerateQuests_6", "AddRumours.txt", "#space#", " ")) +GetConvertStrWithReplace("Variable_GenerateQuests_7", "AddRumours.txt", "#space#", " ")+ GetSexPhrase(GetConvertStrWithReplace("Variable_GenerateQuests_8", "AddRumours.txt", "#space#", " "),GetConvertStrWithReplace("Variable_GenerateQuests_9", "AddRumours.txt", "#space#", " ")), 5, 1);
}
...
void QuestDuelBattleWithMercenaryHappyEnd()
{
	...
	AddSimpleRumourToAllNations(LinkRandPhrase(GetConvertStrWithReplace("Variable_GenerateQuests_10", "AddRumours.txt", "#space#", " "), GetConvertStrWithReplace("Variable_GenerateQuests_11", "AddRumours.txt", "#space#", " "), GetConvertStrWithReplace("Variable_GenerateQuests_12", "AddRumours.txt", "#space#", " ")) + GetConvertStrWithReplace("Variable_GenerateQuests_13", "AddRumours.txt", "#space#", " ") + GetFullName(PChar) + " "+ GetSexPhrase(GetConvertStrWithReplace("Variable_GenerateQuests_14", "AddRumours.txt", "#space#", " "),GetConvertStrWithReplace("Variable_GenerateQuests_15", "AddRumours.txt", "#space#", " ")) +GetConvertStrWithReplace("Variable_GenerateQuests_16", "AddRumours.txt", "#space#", " ")+ GetSexPhrase(GetConvertStrWithReplace("Variable_GenerateQuests_17", "AddRumours.txt", "#space#", " "),GetConvertStrWithReplace("Variable_GenerateQuests_18", "AddRumours.txt", "#space#", " ")), 5, 1);
...
void QuestDuelBattleWithDuelistHappyEnd()
{
	...
	AddSimpleRumourToAllNations(LinkRandPhrase(GetConvertStrWithReplace("Variable_GenerateQuests_19", "AddRumours.txt", "#space#", " "), GetConvertStrWithReplace("Variable_GenerateQuests_20", "AddRumours.txt", "#space#", " "), GetConvertStrWithReplace("Variable_GenerateQuests_21", "AddRumours.txt", "#space#", " ")) + GetConvertStrWithReplace("Variable_GenerateQuests_22", "AddRumours.txt", "#space#", " ") + GetFullName(PChar) + " "+ GetSexPhrase(GetConvertStrWithReplace("Variable_GenerateQuests_23", "AddRumours.txt", "#space#", " "),GetConvertStrWithReplace("Variable_GenerateQuests_24", "AddRumours.txt", "#space#", " ")) +GetConvertStrWithReplace("Variable_GenerateQuests_25", "AddRumours.txt", "#space#", " ")+ GetSexPhrase(GetConvertStrWithReplace("Variable_GenerateQuests_26", "AddRumours.txt", "#space#", " "),GetConvertStrWithReplace("Variable_GenerateQuests_27", "AddRumours.txt", "#space#", " ")), 5, 1);
}
...
void ClearGenerateQuestDuel(string qName)
{
	...
	Log_TestInfo(GetConvertStrWithReplace("Variable_GenerateQuests_6", "Logs.txt", "#space#", " "));
}

void GenerateQuestDuelBlockReset(string qName)
{
	PChar.GenerateQuestDuel.Block = false;
	Log_TestInfo(GetConvertStrWithReplace("Variable_GenerateQuests_7", "Logs.txt", "#space#", " "));
}
...
{
	if(!GetCanShipWreck(loc)) { return; }
	PChar.GenerateShipWreck.Block = true;

	Log_TestInfo(GetConvertStrWithReplace("Variable_GenerateQuests_8", "Logs.txt", "#space#", " "));

	SetTimerFunction("ShipWreckTimeActionEnd", 0, 0, 10);
	...
	if(iRank < 10) {
		iClass = 5; iMaxGoods = 500;
	}
	else if(iRank < 15) {
		iClass = 4; iMaxGoods = 500;
	}
	else if(iRank < 20) {
		iClass = 3; iMaxGoods = 750;
	}
	else {
		iClass = 2; iMaxGoods = 1000;
	}
	...
	switch(rand(2))
	{
		case 0: sModel = "officer_" + (rand(42)+1); break;
	...
	/*string sMast = "";
	for(int m=1; m < 4; m++) {//4 мачты по дефолту, бизань не ломаем
			sMast = "mast" + m;
			chr.ship.masts.(sMast) = 0 + (rand(10) >= 3);
	}
	sMast = "mast" + (rand(1)+2);
	chr.ship.masts.(sMast) = true;//ломаем одну из средних мачт принудительно*/
	int iGoods = rand(4) + 2;
	int iGood = 0;
	int iDel = 0;
	int qty = 0;
...
void ShipWreckLoginToWorldMap(string qName)
{
	...
	chr.mapEnc.Name = GetConvertStrWithReplace("Variable_GenerateQuests_1", "Names.txt", "#space#", " ");
...
{
	Log_TestInfo(GetConvertStrWithReplace("Variable_GenerateQuests_9", "Logs.txt", "#space#", " "));

	ChangeCharacterReputation(PChar, -15);
	AddSimpleRumourToAllNations(LinkRandPhrase(GetConvertStrWithReplace("Variable_GenerateQuests_28", "AddRumours.txt", "#space#", " "), GetConvertStrWithReplace("Variable_GenerateQuests_29", "AddRumours.txt", "#space#", " "), GetConvertStrWithReplace("Variable_GenerateQuests_30", "AddRumours.txt", "#space#", " ")) + GetConvertStrWithReplace("Variable_GenerateQuests_31", "AddRumours.txt", "#space#", " ") + GetFullName(PChar) + " "+ GetSexPhrase(GetConvertStrWithReplace("Variable_GenerateQuests_32", "AddRumours.txt", "#space#", " "),GetConvertStrWithReplace("Variable_GenerateQuests_33", "AddRumours.txt", "#space#", " ")) +GetConvertStrWithReplace("Variable_GenerateQuests_34", "AddRumours.txt", "#space#", " ")+ GetSexPhrase(GetConvertStrWithReplace("Variable_GenerateQuests_35", "AddRumours.txt", "#space#", " "),GetConvertStrWithReplace("Variable_GenerateQuests_36", "AddRumours.txt", "#space#", " ")) +"!", 5, 1);
...
void ShipWreckInTownSuccess()
{
	...
	if(PChar.location == "FortOrange_port" || PChar.location == "DesMoines_port")
	{
		sLocator = "gate_back";
	}
...
void ShipWreckBandInit()
{
	...
	string sModel = "officer_" + (rand(42)+1);
	chr.model = sModel;
	FaceMaker(chr);
	...
	switch(rand(2))
	{
		...
		case 2: sCapModel = "officer_" + (rand(42)+1); break;
	}
...
void ShipWreckBanditsNewCapAdd()
{
	...
	ref chr = CharacterFromID(PChar.GenerateShipWreck.NewCapID);
	AddPassenger(PChar, chr, 0);
	sld = CharacterFromID(PChar.GenerateShipWreck.CharacterID);

	sld.Ship.crew.morale = MORALE_MAX;
	SetCrewQuantity(sld, PChar.GenerateShipWreck.PrisonedCrew);
...
void ShipWreckResetBlock(string qName)
{
	...
	Log_TestInfo(GetConvertStrWithReplace("Variable_GenerateQuests_10", "Logs.txt", "#space#", " "));
}

void ClearShipWreckQuest()
{
	Log_TestInfo(GetConvertStrWithReplace("Variable_GenerateQuests_11", "Logs.txt", "#space#", " "));
	...
	if(!CheckAttribute(PChar,"VolodyaDebil.Convoy"))
	{
		if(CheckAttribute(PChar, "GenerateShipWreck.CharacterID"))
		{
			if(GetCharacterIndex(PChar.GenerateShipWreck.CharacterID) != -1)
			{
				...
				chr.LifeDay = 0;
				chr.mapEnc.Name = GetConvertStrWithReplace("Variable_GenerateQuests_2", "Names.txt", "#space#", " ");
				Map_ReleaseQuestEncounter(chr.id);
			}
		}
