...
void wdmInitWorldMap()
{
	...
	worldMap.labels.Cuba1.text = CheckingTranslate(idLngFile,"Cuba");

	worldMap.labels.Cuba2.type = "Island";
	worldMap.labels.Cuba2.id = "Cuba2";
	worldMap.labels.Cuba2.locator = "Cuba2";
	//worldMap.labels.Cuba2.text = CheckingTranslate(idLngFile,"Cuba");
	...
	worldMap.labels.MariaGalante.type = "Island";
	worldMap.labels.MariaGalante.id = "MariaGalante";
	worldMap.labels.MariaGalante.locator = "MariaGalante";
	worldMap.labels.MariaGalante.text = CheckingTranslate(idLngFile,"MariaGalante");

	worldMap.labels.Hispaniola.type = "Island";
	worldMap.labels.Hispaniola.id = "Hispaniola";
	worldMap.labels.Hispaniola.locator = "Hispaniola1";
	worldMap.labels.Hispaniola.text = CheckingTranslate(idLngFile,"Hispaniola");
	...
	worldMap.labels.DesMoines_town.type = "Town";
	worldMap.labels.DesMoines_town.id = "DesMoines_town";
	worldMap.labels.DesMoines_town.locator = "DesMoines_town";
	worldMap.labels.DesMoines_town.text = CheckingTranslate(idLngFile,"DesMoines_town");
	worldMap.labels.DesMoines_town.icon = SPAIN;
	...
	worldMap.islands.Maracaibo.DesMoines_town.position.x = 218.162;
	worldMap.islands.Maracaibo.DesMoines_town.position.z = -994.035;
	...
	worldMap.islands.Jamaica.FortOrange_town.position.x = -405;
	worldMap.islands.Jamaica.FortOrange_town.position.z = -100;
	...
	worldMap.islands.Hispaniola1.LaVega_town.position.x = 147;
	worldMap.islands.Hispaniola1.LaVega_town.position.z = 650;
	...
	worldMap.islands.Bahames.Nassau_town.position.x = -375;
