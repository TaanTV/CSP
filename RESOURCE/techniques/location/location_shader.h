...
m3x3	NORMAL.xyz, v1, c[GC_MTX_WORLD] \
...
mad VS_LDIFRESULT.xyz, VS_LTMP, VS_LKa, VS_LDIFRESULT.xyz \
\
sub VS_LDL.xyz, c[GC_LIGHT0+29], POS \
dp3 VS_LTMP.w, VS_LDL, VS_LDL \
rsq VS_LTMP.x, VS_LTMP.w \
mul VS_LTMP.w, VS_LTMP.w, VS_LTMP.x \
mad VS_LKa.w, c[GC_LIGHT0+31].z, VS_LTMP.w, c[GC_LIGHT0+31].y \
mad VS_LKa.w, VS_LKa.w, VS_LTMP.w, c[GC_LIGHT0+31].x \
rcp VS_LKa.w, VS_LKa.w \
mul VS_LDL.xyz, VS_LDL, VS_LTMP.x \
dp3 VS_LTMP.xyz, VS_LDL, NORMAL \
max VS_LTMP.xyz, VS_LTMP.xyz, c[GC_LIGHT0+30].w \
mul VS_LKa.xyz, VS_LKa.www, c[GC_LIGHT0+30].xyz \
mad VS_LDIFRESULT.xyz, VS_LTMP, VS_LKa, VS_LDIFRESULT.xyz \
\
sub VS_LDL.xyz, c[GC_LIGHT0+32], POS \
dp3 VS_LTMP.w, VS_LDL, VS_LDL \
rsq VS_LTMP.x, VS_LTMP.w \
mul VS_LTMP.w, VS_LTMP.w, VS_LTMP.x \
mad VS_LKa.w, c[GC_LIGHT0+34].z, VS_LTMP.w, c[GC_LIGHT0+34].y \
mad VS_LKa.w, VS_LKa.w, VS_LTMP.w, c[GC_LIGHT0+34].x \
rcp VS_LKa.w, VS_LKa.w \
mul VS_LDL.xyz, VS_LDL, VS_LTMP.x \
dp3 VS_LTMP.xyz, VS_LDL, NORMAL \
max VS_LTMP.xyz, VS_LTMP.xyz, c[GC_LIGHT0+33].w \
mul VS_LKa.xyz, VS_LKa.www, c[GC_LIGHT0+33].xyz \
mad VS_LDIFRESULT.xyz, VS_LTMP, VS_LKa, VS_LDIFRESULT.xyz \
\
sub VS_LDL.xyz, c[GC_LIGHT0+35], POS \
dp3 VS_LTMP.w, VS_LDL, VS_LDL \
rsq VS_LTMP.x, VS_LTMP.w \
mul VS_LTMP.w, VS_LTMP.w, VS_LTMP.x \
mad VS_LKa.w, c[GC_LIGHT0+37].z, VS_LTMP.w, c[GC_LIGHT0+37].y \
mad VS_LKa.w, VS_LKa.w, VS_LTMP.w, c[GC_LIGHT0+37].x \
rcp VS_LKa.w, VS_LKa.w \
mul VS_LDL.xyz, VS_LDL, VS_LTMP.x \
dp3 VS_LTMP.xyz, VS_LDL, NORMAL \
max VS_LTMP.xyz, VS_LTMP.xyz, c[GC_LIGHT0+36].w \
mul VS_LKa.xyz, VS_LKa.www, c[GC_LIGHT0+36].xyz \
mad VS_LDIFRESULT.xyz, VS_LTMP, VS_LKa, VS_LDIFRESULT.xyz \
\
sub VS_LDL.xyz, c[GC_LIGHT0+38], POS \
dp3 VS_LTMP.w, VS_LDL, VS_LDL \
rsq VS_LTMP.x, VS_LTMP.w \
mul VS_LTMP.w, VS_LTMP.w, VS_LTMP.x \
mad VS_LKa.w, c[GC_LIGHT0+40].z, VS_LTMP.w, c[GC_LIGHT0+40].y \
mad VS_LKa.w, VS_LKa.w, VS_LTMP.w, c[GC_LIGHT0+40].x \
rcp VS_LKa.w, VS_LKa.w \
mul VS_LDL.xyz, VS_LDL, VS_LTMP.x \
dp3 VS_LTMP.xyz, VS_LDL, NORMAL \
max VS_LTMP.xyz, VS_LTMP.xyz, c[GC_LIGHT0+39].w \
mul VS_LKa.xyz, VS_LKa.www, c[GC_LIGHT0+39].xyz \
mad VS_LDIFRESULT.xyz, VS_LTMP, VS_LKa, VS_LDIFRESULT.xyz \
\
sub VS_LDL.xyz, c[GC_LIGHT0+41], POS \
dp3 VS_LTMP.w, VS_LDL, VS_LDL \
rsq VS_LTMP.x, VS_LTMP.w \
mul VS_LTMP.w, VS_LTMP.w, VS_LTMP.x \
mad VS_LKa.w, c[GC_LIGHT0+43].z, VS_LTMP.w, c[GC_LIGHT0+43].y \
mad VS_LKa.w, VS_LKa.w, VS_LTMP.w, c[GC_LIGHT0+43].x \
rcp VS_LKa.w, VS_LKa.w \
mul VS_LDL.xyz, VS_LDL, VS_LTMP.x \
dp3 VS_LTMP.xyz, VS_LDL, NORMAL \
max VS_LTMP.xyz, VS_LTMP.xyz, c[GC_LIGHT0+42].w \
mul VS_LKa.xyz, VS_LKa.www, c[GC_LIGHT0+42].xyz \
mad VS_LDIFRESULT.xyz, VS_LTMP, VS_LKa, VS_LDIFRESULT.xyz \
\
sub VS_LDL.xyz, c[GC_LIGHT0+44], POS \
dp3 VS_LTMP.w, VS_LDL, VS_LDL \
rsq VS_LTMP.x, VS_LTMP.w \
mul VS_LTMP.w, VS_LTMP.w, VS_LTMP.x \
mad VS_LKa.w, c[GC_LIGHT0+46].z, VS_LTMP.w, c[GC_LIGHT0+46].y \
mad VS_LKa.w, VS_LKa.w, VS_LTMP.w, c[GC_LIGHT0+46].x \
rcp VS_LKa.w, VS_LKa.w \
mul VS_LDL.xyz, VS_LDL, VS_LTMP.x \
dp3 VS_LTMP.xyz, VS_LDL, NORMAL \
max VS_LTMP.xyz, VS_LTMP.xyz, c[GC_LIGHT0+45].w \
mul VS_LKa.xyz, VS_LKa.www, c[GC_LIGHT0+45].xyz \
mad VS_LDIFRESULT.xyz, VS_LTMP, VS_LKa, VS_LDIFRESULT.xyz \
\
